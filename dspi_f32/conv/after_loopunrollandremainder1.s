...
# %bb.0:                                # %entry
	...
	slli	s4, s4, 2
	sw	s11, 100(sp)                    # 4-byte Folded Spill
...
# %bb.1:                                # %for.cond11.preheader.lr.ph
	...
	lw	s9, 44(sp)                      # 4-byte Folded Reload
	slli	s9, s9, 2
	fmv.w.x	fa5, zero
	li	s5, 1
	li	s6, 2
...
.LBB0_2:                                # %for.cond.cleanup113
	...
	lw	a7, 40(sp)                      # 4-byte Folded Reload
	add	a7, a7, a0
	...
	add	a0, a0, s9
	sw	a0, 64(sp)                      # 4-byte Folded Spill
	lw	s11, 100(sp)                    # 4-byte Folded Reload
...
# %bb.19:                               # %for.body57.lr.ph
	...
	add	s3, s3, a0
	mv	a6, s11
	lw	t2, 68(sp)                      # 4-byte Folded Reload
	li	s11, 7
	j	.LBB0_21
...
# %bb.34:                               # %for.body114.lr.ph
	...
	add	s11, s11, a7
	lw	t2, 28(sp)                      # 4-byte Folded Reload
	j	.LBB0_36
...
# %bb.37:                               # %for.cond127.preheader.lr.ph
	...
	lw	a6, 96(sp)                      # 4-byte Folded Reload
	fmv.s	fa4, fa5
	j	.LBB0_39
...
.LBB0_52:                               # %for.cond186.preheader
	...
	mul	a0, a0, a1
	slli	a0, a0, 2
	lw	s3, 56(sp)                      # 4-byte Folded Reload
	add	s3, s3, a0
	mv	s9, a7
	blez	s11, .LBB0_67
# %bb.53:                               # %for.body189.lr.ph
                                        #   in Loop: Header=BB0_52 Depth=1
	li	t4, 0
	lw	s9, 32(sp)                      # 4-byte Folded Reload
	add	s9, s9, a7
	mv	s5, a6
	j	.LBB0_55
...
# %bb.71:                               # %for.cond258.preheader.lr.ph
	...
	add	a3, a3, t3
	mv	t4, s5
	lw	s9, 88(sp)                      # 4-byte Folded Reload
	fmv.s	fa4, fa5
	j	.LBB0_73
...
# %bb.84:                               # %for.cond318.preheader.lr.ph
	...
	neg	a0, s10
	sw	a0, 92(sp)                      # 4-byte Folded Spill
	lw	s11, 8(sp)                      # 4-byte Folded Reload
	slli	s11, s11, 2
	lw	a0, 32(sp)                      # 4-byte Folded Reload
	slli	a0, a0, 2
	lw	a1, 60(sp)                      # 4-byte Folded Reload
...
.LBB0_102:                              # %for.cond376.preheader
                                        #   in Loop: Header=BB0_86 Depth=1
	lw	t4, 100(sp)                     # 4-byte Folded Reload
	lw	a0, 84(sp)                      # 4-byte Folded Reload
	bge	t4, a0, .LBB0_117
...
# %bb.118:                              # %for.body445.lr.ph
	...
	lw	a0, 60(sp)                      # 4-byte Folded Reload
	add	a7, a7, a0
	lw	t0, 84(sp)                      # 4-byte Folded Reload
	j	.LBB0_120
...
# %bb.121:                              # %for.cond464.preheader.lr.ph
	...
	add	a3, a3, t3
	mv	t4, a7
	lw	s5, 88(sp)                      # 4-byte Folded Reload
	fmv.s	fa4, fa5
	j	.LBB0_123
...
# %bb.134:                              # %for.cond523.preheader.lr.ph
	...
	slli	a6, a6, 2
	lw	a7, 44(sp)                      # 4-byte Folded Reload
	slli	a7, a7, 2
	fmv.w.x	fa5, zero
	li	s8, 1
	li	s7, 2
...
# %bb.137:                              #   in Loop: Header=BB0_136 Depth=1
	...
	mul	a0, a0, a1
	slli	a0, a0, 2
	lw	s9, 56(sp)                      # 4-byte Folded Reload
	add	s9, s9, a0
