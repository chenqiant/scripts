; ModuleID = 'dspi_dotprod_off_f32_ansi.ll'
...
define dso_local noundef i32 @dspi_dotprod_off_f32_ansi(ptr nocapture noundef readonly %in_image, ptr nocapture noundef readonly %filter, ptr nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, float noundef %offset) local_unnamed_addr #0 {
entry:
