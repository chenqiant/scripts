...
clang   -O2 -march=rv32imafc_zicsr_zifencei_xesppie -mabi=ilp32f -emit-llvm -S -o dspi_dotprod_off_f32_ansi.ll \
...
opt -mtriple=riscv32-esp-unknown-elf -passes=riscv-custom-licm -riscv-custom-licm=true dspi_dotprod_off_f32_ansi.ll  -S -o after_customlicm.ll
...
cp after_loopunrollandremainder.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/dotprod/float/dspi_dotprod_off_f32_arp4.S 
