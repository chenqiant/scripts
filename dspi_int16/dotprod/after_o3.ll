...
for.cond128.preheader:                            ; preds = %for.body28.7, %for.cond25.preheader
  ...
  %acc0.0.lcssa = phi i64 [ 0, %for.cond25.preheader ], [ %add, %for.body28.7 ]
  %acc0.0.lcssa3 = phi i64 [ 0, %for.cond25.preheader ], [ %add.1, %for.body28.7 ]
  %acc0.0.lcssa5 = phi i64 [ 0, %for.cond25.preheader ], [ %add.2, %for.body28.7 ]
  %acc0.0.lcssa7 = phi i64 [ 0, %for.cond25.preheader ], [ %add.3, %for.body28.7 ]
  %acc0.0.lcssa9 = phi i64 [ 0, %for.cond25.preheader ], [ %add.4, %for.body28.7 ]
  %acc0.0.lcssa11 = phi i64 [ 0, %for.cond25.preheader ], [ %add.5, %for.body28.7 ]
  %acc0.0.lcssa13 = phi i64 [ 0, %for.cond25.preheader ], [ %add.6, %for.body28.7 ]
  %acc0.0.lcssa15 = phi i64 [ 0, %for.cond25.preheader ], [ %add.7, %for.body28.7 ]
...
for.body28.7:                                     ; preds = %for.cond25.preheader, %for.body28.7
  ...
  %acc = phi i64 [ %add, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc2 = phi i64 [ %add.1, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc4 = phi i64 [ %add.2, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc6 = phi i64 [ %add.3, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc8 = phi i64 [ %add.4, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc10 = phi i64 [ %add.5, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc12 = phi i64 [ %add.6, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc14 = phi i64 [ %add.7, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  ...
  %add.1 = add nsw i64 %acc2, %conv36.1
  ...
  %add.2 = add nsw i64 %acc4, %conv36.2
  ...
  %add.3 = add nsw i64 %acc6, %conv36.3
  ...
  %add.4 = add nsw i64 %acc8, %conv36.4
  ...
  %add.5 = add nsw i64 %acc10, %conv36.5
  ...
  %add.6 = add nsw i64 %acc12, %conv36.6
  ...
  %add.7 = add nsw i64 %acc14, %conv36.7
...
for.cond.cleanup27:                               ; preds = %for.body28.clone, %for.cond128.preheader
  %29 = phi i64 [ %acc.079, %for.cond128.preheader ], [ %add.clone, %for.body28.clone ]
  %pairwise.sum18 = add i64 %acc0.0.lcssa3, %acc0.0.lcssa
  %pairwise.sum17 = add i64 %pairwise.sum18, %acc0.0.lcssa5
  %pairwise.sum20 = add i64 %pairwise.sum17, %acc0.0.lcssa7
  %pairwise.sum16 = add i64 %pairwise.sum20, %acc0.0.lcssa9
  %pairwise.sum = add i64 %pairwise.sum16, %acc0.0.lcssa11
  %pairwise.sum19 = add i64 %pairwise.sum, %acc0.0.lcssa13
  %pairwise.sum21 = add i64 %pairwise.sum19, %acc0.0.lcssa15
  %final.sum = add nsw i64 %pairwise.sum21, %29
