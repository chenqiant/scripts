	...
	.file	"dspi_dotprod_s16_ansi_licm.c"
	.option	push
...
# %bb.5:                                # %if.end16
	blez	a3, .LBB0_10
# %bb.6:                                # %for.cond21.preheader.us.preheader
	li	t2, 0
	li	a6, 0
	li	a7, 0
	lw	t4, 0(a0)
	...
	slli	t1, t1, 1
	slli	t0, t0, 1
.LBB0_7:                                # %for.cond21.preheader.us
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB0_8 Depth 2
	mv	s0, t4
	mv	a1, s2
	mv	s1, a3
.LBB0_8:                                # %for.body24.us
	...
	add	s0, s0, t0
	bnez	s1, .LBB0_8
# %bb.9:                                # %for.cond21.for.cond.cleanup23_crit_edge.us
