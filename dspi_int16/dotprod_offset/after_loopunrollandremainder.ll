; ModuleID = '/home/chenqian/Workspace/scripts/dspi_int16/dotprod_offset/after_customlicm.ll'
...
for.body28.clone:                                 ; preds = %for.cond128.preheader, %for.body28.clone
  ...
  %conv34.clone = sext i16 %29 to i32
