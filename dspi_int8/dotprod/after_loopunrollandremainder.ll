...
source_filename = "dspi_dotprod_s8_ansi.c"
...
define dso_local noundef i32 @dspi_dotprod_s8_ansi(ptr noalias nocapture noundef readonly %in_image, ptr noalias nocapture noundef readonly %filter, ptr noalias nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift) local_unnamed_addr #0 {
entry:
...
for.body28.7:                                     ; preds = %for.cond25.preheader, %for.body28.7
  ...
  %mul37.1 = mul nsw i32 %conv36.1, %conv31.1
  ...
  %mul37.2 = mul nsw i32 %conv36.2, %conv31.2
  ...
  %mul37.3 = mul nsw i32 %conv36.3, %conv31.3
  ...
  %mul37.4 = mul nsw i32 %conv36.4, %conv31.4
  ...
  %mul37.5 = mul nsw i32 %conv36.5, %conv31.5
  ...
  %mul37.6 = mul nsw i32 %conv36.6, %conv31.6
  ...
  %mul37.7 = mul nsw i32 %conv36.7, %conv31.7
...
for.body28.clone:                                 ; preds = %for.cond128.preheader, %for.body28.clone
  ...
  %mul37.clone = mul nsw i32 %conv36.clone, %conv31.clone
