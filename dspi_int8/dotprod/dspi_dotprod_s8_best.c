...
esp_err_t dspi_dotprod_s8_ansi(image2d_t *in_image, image2d_t *filter, int8_t *out_value, int count_x, int count_y, int shift)
{
    ...
    for (int y = 0; y < count_y; y++) {
        ...
        int x = 0;
        for (; x < count_x - 7; x += 8) {
            acc0 += (int16_t)i_data[in_image->step_x * x] * (int16_t)f_data[filter->step_x * x];
            acc1 += (int16_t)i_data[in_image->step_x * (x+1)] * (int16_t)f_data[filter->step_x * (x+1)];
            acc2 += (int16_t)i_data[in_image->step_x * (x+2)] * (int16_t)f_data[filter->step_x * (x+2)];
            acc3 += (int16_t)i_data[in_image->step_x * (x+3)] * (int16_t)f_data[filter->step_x * (x+3)];
            acc4 += (int16_t)i_data[in_image->step_x * (x+4)] * (int16_t)f_data[filter->step_x * (x+4)];
            acc5 += (int16_t)i_data[in_image->step_x * (x+5)] * (int16_t)f_data[filter->step_x * (x+5)];
            acc6 += (int16_t)i_data[in_image->step_x * (x+6)] * (int16_t)f_data[filter->step_x * (x+6)];
            acc7 += (int16_t)i_data[in_image->step_x * (x+7)] * (int16_t)f_data[filter->step_x * (x+7)];
        }
        for (; x < count_x; x++) {
