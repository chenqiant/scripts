...
source_filename = "dspi_dotprod_off_u16_ansi.c"
...
define dso_local noundef i32 @dspi_dotprod_off_u16_ansi(ptr noalias nocapture noundef readonly %in_image, ptr noalias nocapture noundef readonly %filter, ptr noalias nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift, i16 noundef zeroext %offset) local_unnamed_addr #0 {
entry:
...
for.cond25.preheader.lr.ph:                       ; preds = %if.end16
  ...
  %cmp2675 = icmp sgt i32 %count_x, 7
...
for.cond25.preheader:                             ; preds = %for.cond.cleanup27, %for.cond25.preheader.lr.ph
  ...
  %acc.081 = phi i64 [ 0, %for.cond25.preheader.lr.ph ], [ %30, %for.cond.cleanup27 ]
  ...
  br i1 %cmp2675, label %for.body28.7, label %for.cond128.preheader
...
for.cond128.preheader:                            ; preds = %for.body28.7, %for.cond25.preheader
  ...
  %11 = phi i64 [ %acc.081, %for.cond25.preheader ], [ %add38.7, %for.body28.7 ]
...
for.body28.7:                                     ; preds = %for.cond25.preheader, %for.body28.7
  %x.077 = phi i32 [ %inc.7, %for.body28.7 ], [ 0, %for.cond25.preheader ]
  %acc.176 = phi i64 [ %add38.7, %for.body28.7 ], [ %acc.081, %for.cond25.preheader ]
  ...
  %inc = or disjoint i32 %x.077, 1
  %mul30.1 = mul nsw i32 %inc, %0
  %arrayidx.1 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.1
  %14 = load i16, ptr %arrayidx.1, align 2, !tbaa !14
  %conv.1 = zext i16 %14 to i32
  %mul32.1 = mul nsw i32 %inc, %4
  %arrayidx33.1 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.1
  %15 = load i16, ptr %arrayidx33.1, align 2, !tbaa !14
  %conv34.1 = zext i16 %15 to i32
  %add.1 = add nuw nsw i32 %conv34.1, %conv35
  %mul36.1 = mul nsw i32 %add.1, %conv.1
  %conv37.1 = zext nneg i32 %mul36.1 to i64
  %add38.1 = add nsw i64 %add38, %conv37.1
  %inc.1 = or disjoint i32 %x.077, 2
  %mul30.2 = mul nsw i32 %inc.1, %0
  %arrayidx.2 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.2
  %16 = load i16, ptr %arrayidx.2, align 2, !tbaa !14
  %conv.2 = zext i16 %16 to i32
  %mul32.2 = mul nsw i32 %inc.1, %4
  %arrayidx33.2 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.2
  %17 = load i16, ptr %arrayidx33.2, align 2, !tbaa !14
  %conv34.2 = zext i16 %17 to i32
  %add.2 = add nuw nsw i32 %conv34.2, %conv35
  %mul36.2 = mul nsw i32 %add.2, %conv.2
  %conv37.2 = zext nneg i32 %mul36.2 to i64
  %add38.2 = add nsw i64 %add38.1, %conv37.2
  %inc.2 = or disjoint i32 %x.077, 3
  %mul30.3 = mul nsw i32 %inc.2, %0
  %arrayidx.3 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.3
  %18 = load i16, ptr %arrayidx.3, align 2, !tbaa !14
  %conv.3 = zext i16 %18 to i32
  %mul32.3 = mul nsw i32 %inc.2, %4
  %arrayidx33.3 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.3
  %19 = load i16, ptr %arrayidx33.3, align 2, !tbaa !14
  %conv34.3 = zext i16 %19 to i32
  %add.3 = add nuw nsw i32 %conv34.3, %conv35
  %mul36.3 = mul nsw i32 %add.3, %conv.3
  %conv37.3 = zext nneg i32 %mul36.3 to i64
  %add38.3 = add nsw i64 %add38.2, %conv37.3
  %inc.3 = or disjoint i32 %x.077, 4
  %mul30.4 = mul nsw i32 %inc.3, %0
  %arrayidx.4 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.4
  %20 = load i16, ptr %arrayidx.4, align 2, !tbaa !14
  %conv.4 = zext i16 %20 to i32
  %mul32.4 = mul nsw i32 %inc.3, %4
  %arrayidx33.4 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.4
  %21 = load i16, ptr %arrayidx33.4, align 2, !tbaa !14
  %conv34.4 = zext i16 %21 to i32
  %add.4 = add nuw nsw i32 %conv34.4, %conv35
  %mul36.4 = mul nsw i32 %add.4, %conv.4
  %conv37.4 = zext nneg i32 %mul36.4 to i64
  %add38.4 = add nsw i64 %add38.3, %conv37.4
  %inc.4 = or disjoint i32 %x.077, 5
  %mul30.5 = mul nsw i32 %inc.4, %0
  %arrayidx.5 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.5
  %22 = load i16, ptr %arrayidx.5, align 2, !tbaa !14
  %conv.5 = zext i16 %22 to i32
  %mul32.5 = mul nsw i32 %inc.4, %4
  %arrayidx33.5 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.5
  %23 = load i16, ptr %arrayidx33.5, align 2, !tbaa !14
  %conv34.5 = zext i16 %23 to i32
  %add.5 = add nuw nsw i32 %conv34.5, %conv35
  %mul36.5 = mul nsw i32 %add.5, %conv.5
  %conv37.5 = zext nneg i32 %mul36.5 to i64
  %add38.5 = add nsw i64 %add38.4, %conv37.5
  %inc.5 = or disjoint i32 %x.077, 6
  %mul30.6 = mul nsw i32 %inc.5, %0
  %arrayidx.6 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.6
  %24 = load i16, ptr %arrayidx.6, align 2, !tbaa !14
  %conv.6 = zext i16 %24 to i32
  %mul32.6 = mul nsw i32 %inc.5, %4
  %arrayidx33.6 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.6
  %25 = load i16, ptr %arrayidx33.6, align 2, !tbaa !14
  %conv34.6 = zext i16 %25 to i32
  %add.6 = add nuw nsw i32 %conv34.6, %conv35
  %mul36.6 = mul nsw i32 %add.6, %conv.6
  %conv37.6 = zext nneg i32 %mul36.6 to i64
  %add38.6 = add nsw i64 %add38.5, %conv37.6
  %inc.6 = or disjoint i32 %x.077, 7
  %mul30.7 = mul nsw i32 %inc.6, %0
  %arrayidx.7 = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.7
  %26 = load i16, ptr %arrayidx.7, align 2, !tbaa !14
  %conv.7 = zext i16 %26 to i32
  %mul32.7 = mul nsw i32 %inc.6, %4
  %arrayidx33.7 = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.7
  %27 = load i16, ptr %arrayidx33.7, align 2, !tbaa !14
  %conv34.7 = zext i16 %27 to i32
  %add.7 = add nuw nsw i32 %conv34.7, %conv35
  %mul36.7 = mul nsw i32 %add.7, %conv.7
  %conv37.7 = zext nneg i32 %mul36.7 to i64
  %add38.7 = add nsw i64 %add38.6, %conv37.7
  %inc.7 = add nuw nsw i32 %x.077, 8
...
for.body28.clone:                                 ; preds = %for.cond128.preheader, %for.body28.clone
  %x.077.clone = phi i32 [ %inc.clone, %for.body28.clone ], [ %x.0.lcssa, %for.cond128.preheader ]
  %acc.176.clone = phi i64 [ %add38.clone, %for.body28.clone ], [ %11, %for.cond128.preheader ]
  %mul30.clone = mul nsw i32 %x.077.clone, %0
  %arrayidx.clone = getelementptr inbounds i16, ptr %i_data.080, i32 %mul30.clone
  %28 = load i16, ptr %arrayidx.clone, align 2, !tbaa !14
  %conv.clone = zext i16 %28 to i32
  %mul32.clone = mul nsw i32 %x.077.clone, %4
  %arrayidx33.clone = getelementptr inbounds i16, ptr %f_data.079, i32 %mul32.clone
  %29 = load i16, ptr %arrayidx33.clone, align 2, !tbaa !14
  %conv34.clone = zext i16 %29 to i32
  %add.clone = add nuw nsw i32 %conv34.clone, %conv35
  %mul36.clone = mul nsw i32 %add.clone, %conv.clone
  %conv37.clone = zext nneg i32 %mul36.clone to i64
  %add38.clone = add nsw i64 %acc.176.clone, %conv37.clone
  %inc.clone = add nuw nsw i32 %x.077.clone, 1
...
for.cond.cleanup27:                               ; preds = %for.body28.clone, %for.cond128.preheader
  %30 = phi i64 [ %11, %for.cond128.preheader ], [ %add38.clone, %for.body28.clone ]
