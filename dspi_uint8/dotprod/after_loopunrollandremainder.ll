...
source_filename = "dspi_dotprod_u8_ansi.c"
...
define dso_local noundef i32 @dspi_dotprod_u8_ansi(ptr noalias nocapture noundef readonly %in_image, ptr noalias nocapture noundef readonly %filter, ptr noalias nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift) local_unnamed_addr #0 {
entry:
...
for.cond25.preheader:                             ; preds = %for.cond.cleanup27, %for.cond25.preheader.lr.ph
  ...
  %acc.079 = phi i32 [ 0, %for.cond25.preheader.lr.ph ], [ %30, %for.cond.cleanup27 ]
...
for.body28.7:                                     ; preds = %for.cond25.preheader, %for.body28.7
  ...
  %arrayidx.1 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.1
  %14 = load i8, ptr %arrayidx.1, align 1, !tbaa !14
  %conv31.1 = zext i8 %14 to i32
  %mul33.1 = mul nsw i32 %inc, %4
  %arrayidx34.1 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.1
  %15 = load i8, ptr %arrayidx34.1, align 1, !tbaa !14
  %conv36.1 = zext i8 %15 to i32
  %mul37.1 = mul nuw nsw i32 %conv36.1, %conv31.1
  %add.1 = add nsw i32 %mul37.1, %add
  %inc.1 = or disjoint i32 %x.075, 2
  %mul30.2 = mul nsw i32 %inc.1, %0
  %arrayidx.2 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.2
  %16 = load i8, ptr %arrayidx.2, align 1, !tbaa !14
  %conv31.2 = zext i8 %16 to i32
  %mul33.2 = mul nsw i32 %inc.1, %4
  %arrayidx34.2 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.2
  %17 = load i8, ptr %arrayidx34.2, align 1, !tbaa !14
  %conv36.2 = zext i8 %17 to i32
  %mul37.2 = mul nuw nsw i32 %conv36.2, %conv31.2
  %add.2 = add nsw i32 %mul37.2, %add.1
  %inc.2 = or disjoint i32 %x.075, 3
  %mul30.3 = mul nsw i32 %inc.2, %0
  %arrayidx.3 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.3
  %18 = load i8, ptr %arrayidx.3, align 1, !tbaa !14
  %conv31.3 = zext i8 %18 to i32
  %mul33.3 = mul nsw i32 %inc.2, %4
  %arrayidx34.3 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.3
  %19 = load i8, ptr %arrayidx34.3, align 1, !tbaa !14
  %conv36.3 = zext i8 %19 to i32
  %mul37.3 = mul nuw nsw i32 %conv36.3, %conv31.3
  %add.3 = add nsw i32 %mul37.3, %add.2
  %inc.3 = or disjoint i32 %x.075, 4
  %mul30.4 = mul nsw i32 %inc.3, %0
  %arrayidx.4 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.4
  %20 = load i8, ptr %arrayidx.4, align 1, !tbaa !14
  %conv31.4 = zext i8 %20 to i32
  %mul33.4 = mul nsw i32 %inc.3, %4
  %arrayidx34.4 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.4
  %21 = load i8, ptr %arrayidx34.4, align 1, !tbaa !14
  %conv36.4 = zext i8 %21 to i32
  %mul37.4 = mul nuw nsw i32 %conv36.4, %conv31.4
  %add.4 = add nsw i32 %mul37.4, %add.3
  %inc.4 = or disjoint i32 %x.075, 5
  %mul30.5 = mul nsw i32 %inc.4, %0
  %arrayidx.5 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.5
  %22 = load i8, ptr %arrayidx.5, align 1, !tbaa !14
  %conv31.5 = zext i8 %22 to i32
  %mul33.5 = mul nsw i32 %inc.4, %4
  %arrayidx34.5 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.5
  %23 = load i8, ptr %arrayidx34.5, align 1, !tbaa !14
  %conv36.5 = zext i8 %23 to i32
  %mul37.5 = mul nuw nsw i32 %conv36.5, %conv31.5
  %add.5 = add nsw i32 %mul37.5, %add.4
  %inc.5 = or disjoint i32 %x.075, 6
  %mul30.6 = mul nsw i32 %inc.5, %0
  %arrayidx.6 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.6
  %24 = load i8, ptr %arrayidx.6, align 1, !tbaa !14
  %conv31.6 = zext i8 %24 to i32
  %mul33.6 = mul nsw i32 %inc.5, %4
  %arrayidx34.6 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.6
  %25 = load i8, ptr %arrayidx34.6, align 1, !tbaa !14
  %conv36.6 = zext i8 %25 to i32
  %mul37.6 = mul nuw nsw i32 %conv36.6, %conv31.6
  %add.6 = add nsw i32 %mul37.6, %add.5
  %inc.6 = or disjoint i32 %x.075, 7
  %mul30.7 = mul nsw i32 %inc.6, %0
  %arrayidx.7 = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.7
  %26 = load i8, ptr %arrayidx.7, align 1, !tbaa !14
  %conv31.7 = zext i8 %26 to i32
  %mul33.7 = mul nsw i32 %inc.6, %4
  %arrayidx34.7 = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.7
  %27 = load i8, ptr %arrayidx34.7, align 1, !tbaa !14
  %conv36.7 = zext i8 %27 to i32
  %mul37.7 = mul nuw nsw i32 %conv36.7, %conv31.7
  %add.7 = add nsw i32 %mul37.7, %add.6
...
for.body28.clone:                                 ; preds = %for.cond128.preheader, %for.body28.clone
  ...
  %acc.174.clone = phi i32 [ %add.clone, %for.body28.clone ], [ %11, %for.cond128.preheader ]
  %mul30.clone = mul nsw i32 %x.075.clone, %0
  %arrayidx.clone = getelementptr inbounds i8, ptr %i_data.078, i32 %mul30.clone
  %28 = load i8, ptr %arrayidx.clone, align 1, !tbaa !14
  %conv31.clone = zext i8 %28 to i32
  %mul33.clone = mul nsw i32 %x.075.clone, %4
  %arrayidx34.clone = getelementptr inbounds i8, ptr %f_data.077, i32 %mul33.clone
  %29 = load i8, ptr %arrayidx34.clone, align 1, !tbaa !14
  %conv36.clone = zext i8 %29 to i32
  %mul37.clone = mul nuw nsw i32 %conv36.clone, %conv31.clone
  %add.clone = add nsw i32 %mul37.clone, %acc.174.clone
...
for.cond.cleanup27:                               ; preds = %for.body28.clone, %for.cond128.preheader
  %30 = phi i32 [ %11, %for.cond128.preheader ], [ %add.clone, %for.body28.clone ]
  ...
  br i1 %exitcond82.not, label %for.cond.cleanup, label %for.cond25.preheader, !llvm.loop !17
