; ModuleID = 'dspi_dotprod_off_u8_ansi.ll'
...
define dso_local noundef i32 @dspi_dotprod_off_u8_ansi(ptr nocapture noundef readonly %in_image, ptr nocapture noundef readonly %filter, ptr nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift, i8 noundef zeroext %offset) local_unnamed_addr #0 {
entry:
...
for.cond.cleanup27:                               ; preds = %for.body28, %for.cond25.preheader
  ...
  br i1 %exitcond85.not, label %for.cond.cleanup, label %for.cond25.preheader, !llvm.loop !15
...
for.body28:                                       ; preds = %for.body28, %for.cond25.preheader
  ...
  br i1 %exitcond.not, label %for.cond.cleanup27, label %for.body28, !llvm.loop !17
