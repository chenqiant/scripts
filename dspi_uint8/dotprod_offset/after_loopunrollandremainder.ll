...
source_filename = "dspi_dotprod_off_u8_ansi.c"
...
define dso_local noundef i32 @dspi_dotprod_off_u8_ansi(ptr noalias nocapture noundef readonly %in_image, ptr noalias nocapture noundef readonly %filter, ptr noalias nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift, i8 noundef zeroext %offset) local_unnamed_addr #0 {
entry:
...
for.body28.7:                                     ; preds = %for.cond25.preheader, %for.body28.7
  ...
  %add.1 = add nuw nsw i32 %conv36.1, %conv38
  %mul39.1 = mul nuw nsw i32 %add.1, %conv31.1
  ...
  %add.2 = add nuw nsw i32 %conv36.2, %conv38
  %mul39.2 = mul nuw nsw i32 %add.2, %conv31.2
  ...
  %add.3 = add nuw nsw i32 %conv36.3, %conv38
  %mul39.3 = mul nuw nsw i32 %add.3, %conv31.3
  ...
  %add.4 = add nuw nsw i32 %conv36.4, %conv38
  %mul39.4 = mul nuw nsw i32 %add.4, %conv31.4
  ...
  %add.5 = add nuw nsw i32 %conv36.5, %conv38
  %mul39.5 = mul nuw nsw i32 %add.5, %conv31.5
  ...
  %add.6 = add nuw nsw i32 %conv36.6, %conv38
  %mul39.6 = mul nuw nsw i32 %add.6, %conv31.6
  ...
  %add.7 = add nuw nsw i32 %conv36.7, %conv38
  %mul39.7 = mul nuw nsw i32 %add.7, %conv31.7
...
for.body28.clone:                                 ; preds = %for.cond128.preheader, %for.body28.clone
  ...
  %add.clone = add nuw nsw i32 %conv36.clone, %conv38
  %mul39.clone = mul nuw nsw i32 %add.clone, %conv31.clone
