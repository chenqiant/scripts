...
for.body37.7:                                     ; preds = %for.cond34.preheader, %for.body37.7
  ...
  %m4 = load float, ptr %arrayidx39, align 4, !tbaa !4
  %m6 = load float, ptr %arrayidx39.1, align 4, !tbaa !4
  %m8 = load float, ptr %arrayidx39.2, align 4, !tbaa !4
  %m10 = load float, ptr %arrayidx39.3, align 4, !tbaa !4
  %m12 = load float, ptr %arrayidx39.4, align 4, !tbaa !4
  %m14 = load float, ptr %arrayidx39.5, align 4, !tbaa !4
  %m16 = load float, ptr %arrayidx39.6, align 4, !tbaa !4
  %m18 = load float, ptr %arrayidx39.7, align 4, !tbaa !4

  %add40 = fadd float %3, %m4
  %add40.1 = fadd float %5, %m6
  %add40.2 = fadd float %7, %m8
  %add40.3 = fadd float %9, %m10
  %add40.4 = fadd float %11, %m12
  %add40.5 = fadd float %13, %m14
  %add40.6 = fadd float %15, %m16
  %add40.7 = fadd float %17, %m18
