...
llc --mcpu=esp32p4 --mtriple=riscv32  dsps_add_f32_ansi.ll -O3 -filetype=asm -o dsps_add_f32_ansi.s

../preprocess_asm.sh dsps_add_f32_ansi.s
cp dsps_add_f32_ansi.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/math/add/float/dsps_add_f32_arp4.S