...
for.body14.clone.preheader:                       ; preds = %for.end38, %for.body
  %.ph = phi float [ 0.000000e+00, %for.body ], [ %sum28, %for.end38 ]
...
for.body33.15:                                    ; preds = %for.body25, %for.body33.15
  ...
  %.phi39 = phi float [ %63, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi40 = phi float [ %64, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi41 = phi float [ %65, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi42 = phi float [ %66, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi43 = phi float [ %67, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi44 = phi float [ %68, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi45 = phi float [ %69, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi46 = phi float [ %70, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi47 = phi float [ %71, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi48 = phi float [ %72, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi49 = phi float [ %73, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi50 = phi float [ %74, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi51 = phi float [ %75, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi52 = phi float [ %76, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi53 = phi float [ %77, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  %.phi54 = phi float [ %78, %for.body33.15 ], [ 0.000000e+00, %for.body25 ]
  ...
  %63 = tail call float @llvm.fmuladd.f32(float %31, float %32, float %.phi39)
  %64 = tail call float @llvm.fmuladd.f32(float %33, float %34, float %.phi40)
  %65 = tail call float @llvm.fmuladd.f32(float %35, float %36, float %.phi41)
  %66 = tail call float @llvm.fmuladd.f32(float %37, float %38, float %.phi42)
  %67 = tail call float @llvm.fmuladd.f32(float %39, float %40, float %.phi43)
  %68 = tail call float @llvm.fmuladd.f32(float %41, float %42, float %.phi44)
  %69 = tail call float @llvm.fmuladd.f32(float %43, float %44, float %.phi45)
  %70 = tail call float @llvm.fmuladd.f32(float %45, float %46, float %.phi46)
  %71 = tail call float @llvm.fmuladd.f32(float %47, float %48, float %.phi47)
  %72 = tail call float @llvm.fmuladd.f32(float %49, float %50, float %.phi48)
  %73 = tail call float @llvm.fmuladd.f32(float %51, float %52, float %.phi49)
  %74 = tail call float @llvm.fmuladd.f32(float %53, float %54, float %.phi50)
  %75 = tail call float @llvm.fmuladd.f32(float %55, float %56, float %.phi51)
  %76 = tail call float @llvm.fmuladd.f32(float %57, float %58, float %.phi52)
  %77 = tail call float @llvm.fmuladd.f32(float %59, float %60, float %.phi53)
  %78 = tail call float @llvm.fmuladd.f32(float %61, float %62, float %.phi54)
...
for.body60.7:                                     ; preds = %for.body50, %for.body60.7
  ...
  %.phi88 = phi float [ %99, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi89 = phi float [ %100, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi90 = phi float [ %101, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi91 = phi float [ %102, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi92 = phi float [ %103, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi93 = phi float [ %104, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi94 = phi float [ %105, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  %.phi95 = phi float [ %106, %for.body60.7 ], [ 0.000000e+00, %for.body50 ]
  ...
  %99 = tail call float @llvm.fmuladd.f32(float %83, float %84, float %.phi88)
  %100 = tail call float @llvm.fmuladd.f32(float %85, float %86, float %.phi89)
  %101 = tail call float @llvm.fmuladd.f32(float %87, float %88, float %.phi90)
  %102 = tail call float @llvm.fmuladd.f32(float %89, float %90, float %.phi91)
  %103 = tail call float @llvm.fmuladd.f32(float %91, float %92, float %.phi92)
  %104 = tail call float @llvm.fmuladd.f32(float %93, float %94, float %.phi93)
  %105 = tail call float @llvm.fmuladd.f32(float %95, float %96, float %.phi94)
  %106 = tail call float @llvm.fmuladd.f32(float %97, float %98, float %.phi95)
...
for.end164110:                                    ; preds = %for.end67.loopexit, %for.body50
  %phi.sum111 = phi i32 [ %add56, %for.body50 ], [ %inc66.7, %for.end67.loopexit ]
...
for.body60.clone:                                 ; preds = %for.end164110, %for.body60.clone
  %107 = phi float [ %110, %for.body60.clone ], [ %phi.float112, %for.end164110 ]
