...
.LBB0_22:                               # %for.body30.15
	...
	addi	a5, a5, 16
	addi	s0, s0, -64
.LBB0_23:                               # %for.body30.15
                                        #   in Loop: Header=BB0_22 Depth=2
                                        # Label of block must be emitted
	addi	a0, a0, 64
# %bb.24:                               # %for.end37.loopexit
                                        #   in Loop: Header=BB0_20 Depth=1
	fadd.s	fa4, fa4, fa3
	fadd.s	fa3, fa2, fa1
	fadd.s	fa2, fa0, ft0
...
.LBB0_25:                               #   in Loop: Header=BB0_20 Depth=1
	...
	fsw	fa5, 0(a0)
	bltu	t6, a5, .LBB0_19
.LBB0_26:                               # %for.body30.clone.preheader
                                        #   in Loop: Header=BB0_20 Depth=1
	slli	s0, a5, 2
	sub	s1, t3, s0
	add	s0, s0, a2
.LBB0_27:                               # %for.body30.clone
                                        #   Parent Loop BB0_20 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	fa3, 0(s0)
	flw	fa2, 0(s1)
...
# %bb.28:                               # %for.cond.for.end_crit_edge25
	...
	fsw	fa4, 0(a0)
	j	.LBB0_19
.LBB0_29:                               # %for.cond42.preheader
	add	a1, a1, a3
	addi	t1, a1, -1
	bge	a6, t1, .LBB0_41
# %bb.30:                               # %for.body47.lr.ph
	addi	a1, a6, -1
	slli	a0, a6, 2
	add	t0, a0, a7
	addi	t0, t0, -16
...
.LBB0_34:                               # %for.body57.7
	...
	fmadd.s	ft2, fs3, fs4, ft2
	addi	s0, s0, -32
.LBB0_35:                               # %for.body57.7
                                        #   in Loop: Header=BB0_34 Depth=2
                                        # Label of block must be emitted
	addi	a5, a5, 32
# %bb.36:                               # %for.end64.loopexit
                                        #   in Loop: Header=BB0_32 Depth=1
	fadd.s	fa4, fa4, fa3
	fadd.s	fa3, fa2, fa1
	fadd.s	fa2, fa0, ft0
...
.LBB0_37:                               #   in Loop: Header=BB0_32 Depth=1
	...
	fsw	fa5, 0(a0)
	bltu	a1, a3, .LBB0_31
.LBB0_38:                               # %for.body57.clone.preheader
                                        #   in Loop: Header=BB0_32 Depth=1
	slli	s1, a3, 2
	sub	a5, a7, s1
	add	s1, s1, a2
.LBB0_39:                               # %for.body57.clone
                                        #   Parent Loop BB0_32 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	fa3, 0(s1)
	flw	fa2, 0(a5)
