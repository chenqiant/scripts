...
# %bb.11:                               # %for.end8
	...
	fadd.s	fa4, fa4, fa3
	fsw	fa4, 0(t4)
.LBB0_12:                               # %for.body13.clone.preheader
                                        #   in Loop: Header=BB0_8 Depth=1
	add	a5, t6, a2
	addi	a5, a5, 4
	sub	s1, s3, t5
	add	t5, t5, a2
.LBB0_13:                               # %for.body13.clone
                                        #   Parent Loop BB0_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	fa3, 0(t5)
	flw	fa2, 0(s1)
...
# %bb.14:                               # %for.cond.for.end_crit_edge
	...
	addi	s3, s3, 4
	bne	a0, t2, .LBB0_8
.LBB0_15:                               # %for.cond21.preheader
	bge	t2, a6, .LBB0_26
# %bb.16:                               # %for.body24.preheader
	andi	t0, t2, -16
	slli	t3, t2, 2
	add	t3, t3, a7
	addi	t1, t3, -32
...
.LBB0_22:                               #   in Loop: Header=BB0_18 Depth=1
	...
	fsw	fa5, 0(a0)
	bltu	t6, a5, .LBB0_17
.LBB0_23:                               # %for.body30.clone.preheader
                                        #   in Loop: Header=BB0_18 Depth=1
	slli	s0, a5, 2
	sub	s1, t3, s0
	add	s0, s0, a2
.LBB0_24:                               # %for.body30.clone
                                        #   Parent Loop BB0_18 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	fa3, 0(s0)
	flw	fa2, 0(s1)
...
# %bb.25:                               # %for.cond.for.end_crit_edge25
	...
	fsw	fa4, 0(a0)
	j	.LBB0_17
.LBB0_26:                               # %for.cond42.preheader
	add	a1, a1, a3
	addi	t1, a1, -1
	bge	a6, t1, .LBB0_37
# %bb.27:                               # %for.body47.lr.ph
	addi	a1, a6, -1
	slli	a0, t2, 2
	slli	a3, a6, 2
	add	t0, a0, a7
...
.LBB0_33:                               #   in Loop: Header=BB0_29 Depth=1
	...
	fsw	fa5, 0(a0)
	bltu	a1, a3, .LBB0_28
.LBB0_34:                               # %for.body57.clone.preheader
                                        #   in Loop: Header=BB0_29 Depth=1
	slli	s1, a3, 2
	sub	a5, a7, s1
	add	s1, s1, a2
.LBB0_35:                               # %for.body57.clone
                                        #   Parent Loop BB0_29 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	fa3, 0(s1)
	flw	fa2, 0(a5)
