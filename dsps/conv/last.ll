...
for.body13.clone.preheader:                       ; preds = %for.end20, %for.body
  %.ph = phi float [ 0.000000e+00, %for.body ], [ %sum28, %for.end20 ]
...
for.body30.15:                                    ; preds = %for.body24, %for.body30.15
  ...
  %.phi21 = phi float [ %62, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi22 = phi float [ %63, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi23 = phi float [ %64, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi24 = phi float [ %65, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi25 = phi float [ %66, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi26 = phi float [ %67, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi27 = phi float [ %68, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi28 = phi float [ %69, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi29 = phi float [ %70, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi30 = phi float [ %71, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi31 = phi float [ %72, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi32 = phi float [ %73, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi33 = phi float [ %74, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi34 = phi float [ %75, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi35 = phi float [ %76, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  %.phi36 = phi float [ %77, %for.body30.15 ], [ 0.000000e+00, %for.body24 ]
  ...
  %62 = tail call float @llvm.fmuladd.f32(float %30, float %31, float %.phi21)
  %63 = tail call float @llvm.fmuladd.f32(float %32, float %33, float %.phi22)
  %64 = tail call float @llvm.fmuladd.f32(float %34, float %35, float %.phi23)
  %65 = tail call float @llvm.fmuladd.f32(float %36, float %37, float %.phi24)
  %66 = tail call float @llvm.fmuladd.f32(float %38, float %39, float %.phi25)
  %67 = tail call float @llvm.fmuladd.f32(float %40, float %41, float %.phi26)
  %68 = tail call float @llvm.fmuladd.f32(float %42, float %43, float %.phi27)
  %69 = tail call float @llvm.fmuladd.f32(float %44, float %45, float %.phi28)
  %70 = tail call float @llvm.fmuladd.f32(float %46, float %47, float %.phi29)
  %71 = tail call float @llvm.fmuladd.f32(float %48, float %49, float %.phi30)
  %72 = tail call float @llvm.fmuladd.f32(float %50, float %51, float %.phi31)
  %73 = tail call float @llvm.fmuladd.f32(float %52, float %53, float %.phi32)
  %74 = tail call float @llvm.fmuladd.f32(float %54, float %55, float %.phi33)
  %75 = tail call float @llvm.fmuladd.f32(float %56, float %57, float %.phi34)
  %76 = tail call float @llvm.fmuladd.f32(float %58, float %59, float %.phi35)
  %77 = tail call float @llvm.fmuladd.f32(float %60, float %61, float %.phi36)
...
for.body57.7:                                     ; preds = %for.body47, %for.body57.7
  ...
  %.phi70 = phi float [ %98, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi71 = phi float [ %99, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi72 = phi float [ %100, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi73 = phi float [ %101, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi74 = phi float [ %102, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi75 = phi float [ %103, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi76 = phi float [ %104, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  %.phi77 = phi float [ %105, %for.body57.7 ], [ 0.000000e+00, %for.body47 ]
  ...
  %98 = tail call float @llvm.fmuladd.f32(float %82, float %83, float %.phi70)
  %99 = tail call float @llvm.fmuladd.f32(float %84, float %85, float %.phi71)
  %100 = tail call float @llvm.fmuladd.f32(float %86, float %87, float %.phi72)
  %101 = tail call float @llvm.fmuladd.f32(float %88, float %89, float %.phi73)
  %102 = tail call float @llvm.fmuladd.f32(float %90, float %91, float %.phi74)
  %103 = tail call float @llvm.fmuladd.f32(float %92, float %93, float %.phi75)
  %104 = tail call float @llvm.fmuladd.f32(float %94, float %95, float %.phi76)
  %105 = tail call float @llvm.fmuladd.f32(float %96, float %97, float %.phi77)
...
for.end16492:                                     ; preds = %for.end64.loopexit, %for.body47
  %phi.sum93 = phi i32 [ %k50.0127, %for.body47 ], [ %k50.0.7, %for.end64.loopexit ]
...
for.body57.clone:                                 ; preds = %for.end16492, %for.body57.clone
  %106 = phi float [ %109, %for.body57.clone ], [ %phi.float94, %for.end16492 ]
