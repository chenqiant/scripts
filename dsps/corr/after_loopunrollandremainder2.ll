...
for.cond8.preheader:                              ; preds = %for.cond.cleanup, %for.cond8.preheader.lr.ph
  ...
  %n.0276 = phi i32 [ %add89, %for.cond.cleanup ], [ 0, %for.cond8.preheader.lr.ph ]
  br i1 %cmp9242, label %for.body14.us.unroll, label %for.cond.cleanup
...
for.cond11.preheader.preheader:                   ; preds = %for.cond95.preheader.lr.ph
  ...
  %.neg1 = add i32 %siglen, 1
  %1 = add i32 %n.0.lcssa, %patlen
  %2 = sub i32 %.neg1, %1
  %3 = shl i32 %2, 2
...
for.body14.us:                                    ; preds = %for.body14.us, %for.cond11.preheader.us
  ...
  %k_corr.036.us = phi float [ %9, %for.body14.us ], [ 0.000000e+00, %for.cond11.preheader.us ]
...
for.cond.cleanup:                                 ; preds = %for.body14.us.unroll, %for.cond8.preheader
  %10 = phi float [ 0.000000e+00, %for.cond8.preheader ], [ %58, %for.body14.us.unroll ]
  %11 = phi float [ 0.000000e+00, %for.cond8.preheader ], [ %59, %for.body14.us.unroll ]
...
for.body14.us.unroll:                             ; preds = %for.cond8.preheader, %for.body14.us.unroll
  %lsr.iv63 = phi i32 [ %lsr.iv.next64, %for.body14.us.unroll ], [ 0, %for.cond8.preheader ]
  %lsr.iv = phi i32 [ %lsr.iv.next, %for.body14.us.unroll ], [ %patlen, %for.cond8.preheader ]
  %k_corr.036.us.unroll = phi float [ %58, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %26 = phi float [ %59, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %27 = phi float [ %60, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %28 = phi float [ %61, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %29 = phi float [ %62, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %30 = phi float [ %63, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %31 = phi float [ %64, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %32 = phi float [ %65, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %33 = phi float [ %66, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %34 = phi float [ %67, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %35 = phi float [ %68, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %36 = phi float [ %69, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %37 = phi float [ %70, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %38 = phi float [ %71, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %39 = phi float [ %72, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
  %40 = phi float [ %73, %for.body14.us.unroll ], [ 0.000000e+00, %for.cond8.preheader ]
...
return:                                           ; preds = %for.cond11.for.cond.cleanup13_crit_edge.us, %for.cond11.preheader.preheader, %for.cond91.preheader, %entry
  %retval.0 = phi i32 [ 458755, %entry ], [ 0, %for.cond11.preheader.preheader ], [ 0, %for.cond91.preheader ], [ 0, %for.cond11.for.cond.cleanup13_crit_edge.us ]
  ret i32 %retval.0
}
