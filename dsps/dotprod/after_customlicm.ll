...
define dso_local noundef i32 @dsps_dotprod_f32_ansi(ptr nocapture noundef readonly %src1, ptr nocapture noundef readonly %src2, ptr nocapture noundef writeonly %dest, i32 noundef %len) local_unnamed_addr #0 !esp32_p4_metadata !4 {
entry:
...
for.body.clone:                                   ; preds = %for.body.clone, %for.cond.preheader
  ...
  %5 = load float, ptr %arrayidx1.clone, align 4, !tbaa !5
