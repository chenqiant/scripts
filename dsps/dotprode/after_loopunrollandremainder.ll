...
define dso_local noundef i32 @dsps_dotprode_f32_ansi(ptr noalias nocapture noundef readonly %src1, ptr noalias nocapture noundef readonly %src2, ptr noalias nocapture noundef writeonly %dest, i32 noundef %len, i32 noundef %step1, i32 noundef %step2) local_unnamed_addr #0 !esp32_p4_metadata !4 {
entry:
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %3 = load float, ptr %arrayidx2, align 4, !tbaa !5
  %4 = load float, ptr %arrayidx1_0, align 4, !tbaa !5
  %5 = load float, ptr %arrayidx1_1, align 4, !tbaa !5
  %6 = load float, ptr %arrayidx2_0, align 4, !tbaa !5
  %7 = load float, ptr %arrayidx2_1, align 4, !tbaa !5
  %8 = load float, ptr %arrayidx3_0, align 4, !tbaa !5
  %9 = load float, ptr %arrayidx3_1, align 4, !tbaa !5
  %10 = load float, ptr %arrayidx4_0, align 4, !tbaa !5
  %11 = load float, ptr %arrayidx4_1, align 4, !tbaa !5
  %12 = load float, ptr %arrayidx5_0, align 4, !tbaa !5
  %13 = load float, ptr %arrayidx5_1, align 4, !tbaa !5
  %14 = load float, ptr %arrayidx6_0, align 4, !tbaa !5
  %15 = load float, ptr %arrayidx6_1, align 4, !tbaa !5
  %16 = load float, ptr %arrayidx7_0, align 4, !tbaa !5
  %17 = load float, ptr %arrayidx7_1, align 4, !tbaa !5
...
for.body33:                                       ; preds = %for.body33, %for.cond31.preheader
  ...
  br i1 %exitcond.not33, label %for.end37, label %for.body33, !llvm.loop !9
