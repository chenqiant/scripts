...
for.cond.preheader1:                              ; preds = %entry
  ...
  br i1 %cmp1113, label %for.body, label %for.cond31.preheader

for.cond31.preheader.loopexit:                    ; preds = %for.body
  %1 = and i32 %len, 2147483640
  br label %for.cond31.preheader

for.cond31.preheader:                             ; preds = %for.cond31.preheader.loopexit, %for.cond.preheader1
  %acc0.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %18, %for.cond31.preheader.loopexit ]
  %acc1.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %19, %for.cond31.preheader.loopexit ]
  %acc2.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %20, %for.cond31.preheader.loopexit ]
  %acc3.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %21, %for.cond31.preheader.loopexit ]
  %acc4.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %22, %for.cond31.preheader.loopexit ]
  %acc5.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %23, %for.cond31.preheader.loopexit ]
  %acc6.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %24, %for.cond31.preheader.loopexit ]
  %acc7.0.lcssa = phi float [ 0.000000e+00, %for.cond.preheader1 ], [ %25, %for.cond31.preheader.loopexit ]
  %i.0.lcssa = phi i32 [ 0, %for.cond.preheader1 ], [ %1, %for.cond31.preheader.loopexit ]
  %cmp32132 = icmp slt i32 %i.0.lcssa, %len
  br i1 %cmp32132, label %for.body33, label %for.end37

for.body:                                         ; preds = %for.cond.preheader1, %for.body
  %i.0122 = phi i32 [ %add30, %for.body ], [ 0, %for.cond.preheader1 ]
  %acc.09 = phi float [ %18, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc1 = phi float [ %19, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc2 = phi float [ %20, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc3 = phi float [ %21, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc4 = phi float [ %22, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc5 = phi float [ %23, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc6 = phi float [ %24, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  %acc7 = phi float [ %25, %for.body ], [ 0.000000e+00, %for.cond.preheader1 ]
  ...
  br i1 %cmp1, label %for.body, label %for.cond31.preheader.loopexit, !llvm.loop !8
...
for.end37:                                        ; preds = %for.body33, %for.cond31.preheader
  %acc0.1.lcssa = phi float [ %acc0.0.lcssa, %for.cond31.preheader ], [ %28, %for.body33 ]
