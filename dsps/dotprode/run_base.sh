...
llc --mcpu=esp32p4 --mtriple=riscv32  dsps_dotprode_f32_ansi.ll -O3 -filetype=asm -o dsps_dotprode_f32_ansi.s

../preprocess_asm.sh dsps_dotprode_f32_ansi.s
cp dsps_dotprode_f32_ansi.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/dotprod/float/dsps_dotprode_f32_arp4.S 
