...
for.cond18.preheader.modify:                      ; preds = %for.body11.modify, %for.body
  ...
  %acc4.clone = phi float [ 0.000000e+00, %for.body ], [ %25, %for.body11.modify ]
  %acc7.clone = phi float [ 0.000000e+00, %for.body ], [ %26, %for.body11.modify ]
  %acc10.clone = phi float [ 0.000000e+00, %for.body ], [ %27, %for.body11.modify ]
  %acc13.clone = phi float [ 0.000000e+00, %for.body ], [ %28, %for.body11.modify ]
  %acc17.clone = phi float [ 0.000000e+00, %for.body ], [ %29, %for.body11.modify ]
  %acc20.clone = phi float [ 0.000000e+00, %for.body ], [ %30, %for.body11.modify ]
...
for.body11.modify:                                ; preds = %for.body11.modify, %for.body11.lr.ph.modify
  ...
  %acc4 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %25, %for.body11.modify ]
  %acc7 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %26, %for.body11.modify ]
  %acc10 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %27, %for.body11.modify ]
  %acc13 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %28, %for.body11.modify ]
  %acc17 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %29, %for.body11.modify ]
  %acc20 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %30, %for.body11.modify ]
  ...
  %arrayidx21 = getelementptr inbounds float, ptr %6, i32 %add7
  ...
  %9 = load float, ptr %arrayidx2, align 4, !tbaa !13
  %10 = load float, ptr %arrayidx3, align 4, !tbaa !13
  %11 = load float, ptr %arrayidx5, align 4, !tbaa !13
  %12 = load float, ptr %arrayidx6, align 4, !tbaa !13
  %13 = load float, ptr %arrayidx8, align 4, !tbaa !13
  %14 = load float, ptr %arrayidx9, align 4, !tbaa !13
  %15 = load float, ptr %arrayidx11, align 4, !tbaa !13
  %16 = load float, ptr %arrayidx12, align 4, !tbaa !13
  %17 = load float, ptr %arrayidx14, align 4, !tbaa !13
  %18 = load float, ptr %arrayidx16, align 4, !tbaa !13
  %19 = load float, ptr %arrayidx18, align 4, !tbaa !13
  %20 = load float, ptr %arrayidx19, align 4, !tbaa !13
  %21 = load float, ptr %arrayidx21, align 4, !tbaa !13
  %22 = load float, ptr %arrayidx22, align 4, !tbaa !13
  ...
  %25 = tail call float @llvm.fmuladd.f32(float %11, float %12, float %acc4)
  %26 = tail call float @llvm.fmuladd.f32(float %13, float %14, float %acc7)
  %27 = tail call float @llvm.fmuladd.f32(float %15, float %16, float %acc10)
  %28 = tail call float @llvm.fmuladd.f32(float %17, float %18, float %acc13)
  %29 = tail call float @llvm.fmuladd.f32(float %19, float %20, float %acc17)
  %30 = tail call float @llvm.fmuladd.f32(float %21, float %22, float %acc20)
...
for.cond18.preheader.loopexit:                    ; preds = %for.body11
  %31 = sub i32 %2, %n.060.modify.clone
...
for.cond.cleanup21.loopexit:                      ; preds = %for.body22.modify
  %38 = and i32 %spec.store.select, 2147483640
  br label %for.cond.cleanup21

for.cond.cleanup21:                               ; preds = %for.cond.cleanup21.loopexit, %for.cond18.preheader
  %n17.065.modify.clone = phi i32 [ 0, %for.cond18.preheader ], [ %38, %for.cond.cleanup21.loopexit ]
  %coeff_pos.164.modify.clone = phi i32 [ %coeff_pos.0.lcssa, %for.cond18.preheader ], [ %inc24.modify, %for.cond.cleanup21.loopexit ]
  %acc.163.modify.clone = phi float [ %acc.0.lcssa, %for.cond18.preheader ], [ %56, %for.cond.cleanup21.loopexit ]
  %acc23.clone = phi float [ %acc.clone, %for.cond18.preheader ], [ %57, %for.cond.cleanup21.loopexit ]
  %acc27.clone = phi float [ %acc4.clone, %for.cond18.preheader ], [ %58, %for.cond.cleanup21.loopexit ]
  %acc30.clone = phi float [ %acc7.clone, %for.cond18.preheader ], [ %59, %for.cond.cleanup21.loopexit ]
  %acc34.clone = phi float [ %acc10.clone, %for.cond18.preheader ], [ %60, %for.cond.cleanup21.loopexit ]
  %acc37.clone = phi float [ %acc13.clone, %for.cond18.preheader ], [ %61, %for.cond.cleanup21.loopexit ]
  %acc40.clone = phi float [ %acc17.clone, %for.cond18.preheader ], [ %62, %for.cond.cleanup21.loopexit ]
  %acc44.clone = phi float [ %acc20.clone, %for.cond18.preheader ], [ %63, %for.cond.cleanup21.loopexit ]
...
for.body22.lr.ph.modify:                          ; preds = %for.cond18.preheader
  %39 = load ptr, ptr %fir, align 4, !tbaa !15
...
for.body22.modify:                                ; preds = %for.body22.modify, %for.body22.lr.ph.modify
  ...
  %arrayidx25.modify = getelementptr inbounds float, ptr %39, i32 %coeff_pos.164.modify
  ...
  br i1 %cmp, label %for.body22.modify, label %for.cond.cleanup21.loopexit, !llvm.loop !19
...
for.end:                                          ; preds = %for.body22, %for.cond.cleanup21
  ...
  br i1 %exitcond71.not.modify, label %if.end.loopexit, label %for.body, !llvm.loop !18
...
for.cond.cleanup21.clone:                         ; preds = %for.body22.clone, %for.cond18.preheader.clone
  ...
  br i1 %exitcond71.not.clone, label %if.end.loopexit3, label %for.body.clone, !llvm.loop !18

if.end.loopexit:                                  ; preds = %for.end
  store i32 %spec.store.select, ptr %pos, align 4
  br label %if.end

if.end.loopexit3:                                 ; preds = %for.cond.cleanup21.clone
  store i32 %spec.store.select.clone, ptr %pos.clone, align 4
  br label %if.end

if.end:                                           ; preds = %if.end.loopexit3, %if.end.loopexit, %for.body.lr.ph.clone.preheader
  ret i32 0
}
