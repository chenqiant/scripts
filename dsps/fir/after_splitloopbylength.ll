...
for.cond18.preheader.modify:                      ; preds = %for.body11.modify, %for.body
  ...
  %acc78.clone = phi float [ 0.000000e+00, %for.body ], [ %26, %for.body11.modify ]
  %acc81.clone = phi float [ 0.000000e+00, %for.body ], [ %27, %for.body11.modify ]
  %acc84.clone = phi float [ 0.000000e+00, %for.body ], [ %28, %for.body11.modify ]
  %acc87.clone = phi float [ 0.000000e+00, %for.body ], [ %29, %for.body11.modify ]
  %acc90.clone = phi float [ 0.000000e+00, %for.body ], [ %30, %for.body11.modify ]
  %acc93.clone = phi float [ 0.000000e+00, %for.body ], [ %31, %for.body11.modify ]
...
for.body11.modify:                                ; preds = %for.body11.modify, %for.body11.lr.ph.modify
  ...
  %acc78 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %26, %for.body11.modify ]
  %acc81 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %27, %for.body11.modify ]
  %acc84 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %28, %for.body11.modify ]
  %acc87 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %29, %for.body11.modify ]
  %acc90 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %30, %for.body11.modify ]
  %acc93 = phi float [ 0.000000e+00, %for.body11.lr.ph.modify ], [ %31, %for.body11.modify ]
  ...
  %arrayidx94 = getelementptr inbounds float, ptr %7, i32 %add7
  ...
  %10 = load float, ptr %arrayidx76, align 4, !tbaa !13
  %11 = load float, ptr %arrayidx77, align 4, !tbaa !13
  %12 = load float, ptr %arrayidx79, align 4, !tbaa !13
  %13 = load float, ptr %arrayidx80, align 4, !tbaa !13
  %14 = load float, ptr %arrayidx82, align 4, !tbaa !13
  %15 = load float, ptr %arrayidx83, align 4, !tbaa !13
  %16 = load float, ptr %arrayidx85, align 4, !tbaa !13
  %17 = load float, ptr %arrayidx86, align 4, !tbaa !13
  %18 = load float, ptr %arrayidx88, align 4, !tbaa !13
  %19 = load float, ptr %arrayidx89, align 4, !tbaa !13
  %20 = load float, ptr %arrayidx91, align 4, !tbaa !13
  %21 = load float, ptr %arrayidx92, align 4, !tbaa !13
  %22 = load float, ptr %arrayidx94, align 4, !tbaa !13
  %23 = load float, ptr %arrayidx95, align 4, !tbaa !13
  ...
  %26 = tail call float @llvm.fmuladd.f32(float %12, float %13, float %acc78)
  %27 = tail call float @llvm.fmuladd.f32(float %14, float %15, float %acc81)
  %28 = tail call float @llvm.fmuladd.f32(float %16, float %17, float %acc84)
  %29 = tail call float @llvm.fmuladd.f32(float %18, float %19, float %acc87)
  %30 = tail call float @llvm.fmuladd.f32(float %20, float %21, float %acc90)
  %31 = tail call float @llvm.fmuladd.f32(float %22, float %23, float %acc93)
...
for.end:                                          ; preds = %for.body22, %for.cond.cleanup21
  ...
  %add139 = fadd float %67, %acc96.clone
