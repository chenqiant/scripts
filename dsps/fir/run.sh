...
clang -mllvm -enable-esp32-p4-optimize -O3 -march=rv32imafc_zicsr_zifencei_xesppie -mabi=ilp32f -emit-llvm -S -o dsps_fir_f32_ansi.ll \
dsps_fir_f32_ansi.c \
...
opt  dsps_fir_f32_ansi.ll -mtriple=riscv32-esp-unknown-elf -passes=riscv-split-loop-by-length -riscv-split-loop-by-length=true -S -o after_splitloopbylength.ll
...
cp after_loopunrollandremainder.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/fir/float/dsps_fir_f32_arp4.S
