...
for.body14.clone:                                 ; preds = %for.body14.clone, %for.body27.lr.ph
  ...
  %acc.067.clone = phi float [ %47, %for.body14.clone ], [ %acc.0.lcssa, %for.body27.lr.ph ]
...
for.cond.cleanup26:                               ; preds = %for.cond.cleanup26.loopexit, %for.cond63.preheader
  ...
  %acc.1.lcssa = phi float [ %acc.0.lcssa, %for.cond63.preheader ], [ %47, %for.cond.cleanup26.loopexit ]
