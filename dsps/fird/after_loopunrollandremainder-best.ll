...
for.body14.7:                                     ; preds = %for.body14.lr.ph, %for.body14.7
  ...
  %add21 = or disjoint i32 %coeff_pos.068, 7
  ...
  %arrayidx16.7 = getelementptr inbounds float, ptr %5, i32 %add21
...
for.cond130.preheader:                            ; preds = %for.body27.7, %for.cond.cleanup26
  ...
  %coeff_pos.0.lcssa.clone = phi i32 [ %coeff_pos.1.lcssa, %for.cond.cleanup26 ], [ %add59, %for.body27.7 ]
...
for.body27.7:                                     ; preds = %for.body79.lr.ph, %for.body27.7
  ...
  %coeff_pos.174 = phi i32 [ %coeff_pos.1.lcssa, %for.body79.lr.ph ], [ %add59, %for.body27.7 ]
  %acc22 = phi float [ %acc.1.lcssa, %for.body79.lr.ph ], [ %59, %for.body27.7 ]
  %acc23 = phi float [ %acc.1.lcssa2, %for.body79.lr.ph ], [ %60, %for.body27.7 ]
  %acc24 = phi float [ %acc.2.lcssa, %for.body79.lr.ph ], [ %61, %for.body27.7 ]
  %acc25 = phi float [ %acc.3.lcssa, %for.body79.lr.ph ], [ %62, %for.body27.7 ]
  %acc26 = phi float [ %acc.4.lcssa, %for.body79.lr.ph ], [ %63, %for.body27.7 ]
  %acc27 = phi float [ %acc.5.lcssa, %for.body79.lr.ph ], [ %64, %for.body27.7 ]
  %acc28 = phi float [ %acc.6.lcssa, %for.body79.lr.ph ], [ %65, %for.body27.7 ]
  %acc29 = phi float [ %acc.7.lcssa, %for.body79.lr.ph ], [ %66, %for.body27.7 ]
  %add33 = or disjoint i32 %n22.075, 1
  %add37 = or disjoint i32 %n22.075, 2
  %add41 = or disjoint i32 %n22.075, 3
  %add45 = or disjoint i32 %n22.075, 4
  %add49 = or disjoint i32 %n22.075, 5
  %add53 = or disjoint i32 %n22.075, 6
  %add57 = or disjoint i32 %n22.075, 7
  %add59 = or disjoint i32 %coeff_pos.174, 8
  ...
  %arrayidx32.1 = getelementptr inbounds float, ptr %37, i32 %add33
  %arrayidx30.2 = getelementptr inbounds float, ptr %arrayidx30, i32 2
  %arrayidx32.2 = getelementptr inbounds float, ptr %37, i32 %add37
  %arrayidx30.3 = getelementptr inbounds float, ptr %arrayidx30, i32 3
  %arrayidx32.3 = getelementptr inbounds float, ptr %37, i32 %add41
  %arrayidx30.4 = getelementptr inbounds float, ptr %arrayidx30, i32 4
  %arrayidx32.4 = getelementptr inbounds float, ptr %37, i32 %add45
  %arrayidx30.5 = getelementptr inbounds float, ptr %arrayidx30, i32 5
  %arrayidx32.5 = getelementptr inbounds float, ptr %37, i32 %add49
  %arrayidx30.6 = getelementptr inbounds float, ptr %arrayidx30, i32 6
  %arrayidx32.6 = getelementptr inbounds float, ptr %37, i32 %add53
  %arrayidx30.7 = getelementptr inbounds float, ptr %arrayidx30, i32 7
  %arrayidx32.7 = getelementptr inbounds float, ptr %37, i32 %add57
  ...
  %59 = tail call float @llvm.fmuladd.f32(float %43, float %44, float %acc22)
  %60 = tail call float @llvm.fmuladd.f32(float %45, float %46, float %acc23)
  %61 = tail call float @llvm.fmuladd.f32(float %47, float %48, float %acc24)
  %62 = tail call float @llvm.fmuladd.f32(float %49, float %50, float %acc25)
  %63 = tail call float @llvm.fmuladd.f32(float %51, float %52, float %acc26)
  %64 = tail call float @llvm.fmuladd.f32(float %53, float %54, float %acc27)
  %65 = tail call float @llvm.fmuladd.f32(float %55, float %56, float %acc28)
  %66 = tail call float @llvm.fmuladd.f32(float %57, float %58, float %acc29)
