...
.LBB0_6:                                # %for.body4
	...
	and	s2, s1, a3
# %bb.7:                                # %for.cond1.for.cond.cleanup3_crit_edge
                                        #   in Loop: Header=BB0_3 Depth=1
	sw	s2, 12(a0)
.LBB0_8:                                # %for.cond.cleanup3
                                        #   in Loop: Header=BB0_3 Depth=1
	addi	a5, s2, 8
	bge	t6, a5, .LBB0_12
# %bb.9:                                #   in Loop: Header=BB0_3 Depth=1
	...
	mv	s1, s2
	blt	s2, t6, .LBB0_16
.LBB0_10:                               # %for.cond.cleanup26
                                        #   in Loop: Header=BB0_3 Depth=1
	bge	s2, t1, .LBB0_19
.LBB0_11:                               #   in Loop: Header=BB0_3 Depth=1
	li	t5, 0
	j	.LBB0_22
.LBB0_12:                               # %for.body14.lr.ph
                                        #   in Loop: Header=BB0_3 Depth=1
	lw	s1, 4(a0)
	li	a4, 0
	lw	s0, 0(a0)
	...
	sub	t3, a3, t6
	srli	t3, t3, 0
	esp.lp.setup	 0, t3, .LBB0_14
.LBB0_13:                               # %for.body14.7
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	ft3, -16(s0)
	flw	ft4, -16(s1)
	...
	add	a3, a5, a4
	addi	s0, s0, 32
.LBB0_14:                               # %for.body14.7
                                        #   in Loop: Header=BB0_13 Depth=2
                                        # Label of block must be emitted
	addi	s1, s1, 32
# %bb.15:                               # %for.cond63.preheader.loopexit
                                        #   in Loop: Header=BB0_3 Depth=1
	add	s1, s2, a4
	bge	s1, t6, .LBB0_10
.LBB0_16:                               # %for.body27.lr.ph
                                        #   in Loop: Header=BB0_3 Depth=1
	lw	s0, 4(a0)
	lw	a3, 0(a0)
	add	t5, a4, t6
...
.LBB0_17:                               # %for.body14.clone
	...
	addi	a4, a4, 4
	bnez	a5, .LBB0_17
# %bb.18:                               # %for.cond.cleanup26.loopexit
                                        #   in Loop: Header=BB0_3 Depth=1
	sub	a4, t5, s1
	blt	s2, t1, .LBB0_11
.LBB0_19:                               # %for.body79.lr.ph
                                        #   in Loop: Header=BB0_3 Depth=1
	lw	a5, 4(a0)
	lw	s3, 0(a0)
	and	t5, s2, t2
	...
	sub	t3, s1, s0
	srli	t3, t3, 5
	esp.lp.setup	 0, t3, .LBB0_21
.LBB0_20:                               # %for.body27.7
                                        #   Parent Loop BB0_3 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	flw	ft3, -16(s0)
	flw	ft4, -16(a5)
	...
	addi	a4, a4, 8
	addi	s0, s0, 32
.LBB0_21:                               # %for.body27.7
                                        #   in Loop: Header=BB0_20 Depth=2
                                        # Label of block must be emitted
	addi	a5, a5, 32
.LBB0_22:                               # %for.cond130.preheader
                                        #   in Loop: Header=BB0_3 Depth=1
	bge	t5, s2, .LBB0_2
# %bb.23:                               # %for.body133.lr.ph
                                        #   in Loop: Header=BB0_3 Depth=1
	lw	a5, 4(a0)
	lw	a3, 0(a0)
	slli	s0, t5, 2
