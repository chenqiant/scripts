...
for.body27.7:                                     ; preds = %for.body27.7, %for.body27.clone
  ...
  %arrayidx30.1 = getelementptr inbounds float, ptr %38, i32 %add28
  ...
  %arrayidx30.2 = getelementptr inbounds float, ptr %38, i32 %add32
  ...
  %arrayidx30.3 = getelementptr inbounds float, ptr %38, i32 %add36
  ...
  %arrayidx30.4 = getelementptr inbounds float, ptr %38, i32 %add40
 ...
 ; %exitcond84.not.4 = icmp eq i32 %add46, %4
  ...
  %arrayidx30.5 = getelementptr inbounds float, ptr %38, i32 %add44
  ...
  %arrayidx30.6 = getelementptr inbounds float, ptr %38, i32 %add48
  ...
  %arrayidx30.7 = getelementptr inbounds float, ptr %38, i32 %add52
