; ModuleID = 'dsps_wind_flat_top_f32.ll'
source_filename = "dsps_wind_flat_top_f32.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree nounwind memory(write)
define dso_local void @dsps_wind_flat_top_f32(ptr nocapture noundef writeonly %window, i32 noundef %len) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %call30 = tail call float @cosf(float noundef %conv29) #3
