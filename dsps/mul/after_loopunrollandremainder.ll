...
define dso_local noundef i32 @dsps_mul_f32_ansi(ptr noalias noundef readonly %input1, ptr noalias noundef readonly %input2, ptr noalias noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out) local_unnamed_addr #0 !esp32_p4_metadata !4 {
entry:
...
for.body.modify:                                  ; preds = %for.cond.preheader.new, %for.body.modify
  %i.022.modify = phi i32 [ %48, %for.body.modify ], [ 0, %for.cond.preheader.new ]
  %add = or disjoint i32 %i.022.modify, 1
  %add4 = or disjoint i32 %i.022.modify, 2
  %add8 = or disjoint i32 %i.022.modify, 3
  %add14 = or disjoint i32 %i.022.modify, 4
  %add18 = or disjoint i32 %i.022.modify, 5
  %add22 = or disjoint i32 %i.022.modify, 6
  %add26 = or disjoint i32 %i.022.modify, 7
  %add30 = or disjoint i32 %i.022.modify, 8
  %add34 = or disjoint i32 %i.022.modify, 9
  %add38 = or disjoint i32 %i.022.modify, 10
  %add42 = or disjoint i32 %i.022.modify, 11
  %add46 = or disjoint i32 %i.022.modify, 12
  %add50 = or disjoint i32 %i.022.modify, 13
  %add54 = or disjoint i32 %i.022.modify, 14
  %add58 = or disjoint i32 %i.022.modify, 15
  %arrayidx.modify = getelementptr inbounds float, ptr %input1, i32 %i.022.modify
  %arrayidx9.modify = getelementptr inbounds float, ptr %input2, i32 %i.022.modify
  %arrayidx12.modify = getelementptr inbounds float, ptr %output, i32 %i.022.modify
  ...
  %arrayidx11 = getelementptr inbounds float, ptr %input2, i32 %add8
  ...
  %8 = load float, ptr %arrayidx11, align 4, !tbaa !5
  ...
  store float %mul10.modify, ptr %arrayidx12.modify, align 4, !tbaa !5
  %48 = add nuw i32 %i.022.modify, 16
  %exitcond.not.modify = icmp sgt i32 %48, %sub
...
for.body:                                         ; preds = %for.cond.preheader.new2, %for.body
  %i.022 = phi i32 [ %inc, %for.body ], [ %0, %for.cond.preheader.new2 ]
