...
define dso_local noundef i32 @dsps_mul_f32_ansi(ptr noalias noundef readonly %input1, ptr noalias noundef readonly %input2, ptr noalias noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out) local_unnamed_addr #0 {
entry:
...
for.body.modify:                                  ; preds = %for.cond.preheader.new, %for.body.modify
  %i.022.modify = phi i32 [ %1, %for.body.modify ], [ 0, %for.cond.preheader.new ]
  %1 = add nuw i32 %i.022.modify, 16
  ...
  %9 = load float, ptr %arrayidx11, align 4, !tbaa !4
  ...
  %47 = fmul float %30, %31
  %48 = fmul float %32, %33
  store float %mul10.modify, ptr %arrayidx12.modify, align 4, !tbaa !4
