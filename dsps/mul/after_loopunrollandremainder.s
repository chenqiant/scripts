# 2024-11-19 14:52:51
	...
	.file	"dsps_mul_f32_arp4.c"
	.option	push
	#.option	arch, -zca, -zcb, -zcmp, -zcmt
	.globl	dsps_mul_f32_arp4               # -- Begin function dsps_mul_f32_arp4
	.p2align	1
	.type	dsps_mul_f32_arp4,@function
dsps_mul_f32_arp4:                      # @dsps_mul_f32_arp4
# %bb.0:                                # %entry
	addi	sp, sp, -48
...
.LBB0_10:                               # %for.body.modify
	...
	fmul.s	ft1, fa6, fa7
	fmul.s	ft2, ft8, ft9
	fmul.s	ft3, ft10, ft11
	fmul.s	ft4, fs0, fs1
	fmul.s	ft5, fs2, fs3
	fmul.s	ft6, fs4, fs5
	fmul.s	ft7, fs6, fs7
	fmul.s	fa6, fs8, fs9
	fmul.s	fa7, fs10, fs11
	fsw	fa5, -32(t3)
	fsw	fa4, -28(t3)
	fsw	fa3, -24(t3)
	fsw	fa2, -20(t3)
...
.LBB0_17:                               # %return
	...
	ret
.Lfunc_end0:
	.size	dsps_mul_f32_arp4, .Lfunc_end0-dsps_mul_f32_arp4
                                        # -- End function
	.option	pop
