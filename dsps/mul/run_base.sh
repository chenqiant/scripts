...
llc --mcpu=esp32p4 --mtriple=riscv32  dsps_mul_f32_ansi.ll -O3 -filetype=asm -o dsps_mul_f32_ansi.s

../preprocess_asm.sh dsps_mul_f32_ansi.s
cp dsps_mul_f32_ansi.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/math/mul/float/dsps_mul_f32_arp4.S
