; ModuleID = 'dsps_mulc_f32_ansi.ll'
source_filename = "dsps_mulc_f32_ansi.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define dso_local noundef i32 @dsps_mulc_f32_ansi(ptr noundef readonly %input, ptr noundef writeonly %output, i32 noundef %len, float noundef %C, i32 noundef %step_in, i32 noundef %step_out) local_unnamed_addr #0 {
entry:
...
for.body.clone:                                   ; preds = %for.cond.preheader, %for.body.clone
  ...
  %1 = load float, ptr %arrayidx.clone, align 4, !tbaa !4
