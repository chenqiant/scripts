...
llc --mcpu=esp32p4 --mtriple=riscv32  dsps_sub_f32_ansi.ll -O3 -filetype=asm -o dsps_sub_f32_ansi.s

../preprocess_asm.sh dsps_sub_f32_ansi.s
cp dsps_sub_f32_ansi.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/math/sub/float/dsps_sub_f32_arp4.S
