...
source_filename = "dsps_wind_blackman_harris_f32.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree nounwind memory(write)
define dso_local void @dsps_wind_blackman_harris_f32_arp4(ptr noalias nocapture noundef writeonly %window, i32 noundef %len) local_unnamed_addr #0 {
entry:
...
for.body.7:                                       ; preds = %for.body.lr.ph, %for.body.7
  ...
  %call22 = tail call float @cosf(float noundef %mul124) #3
  ...
  %3 = tail call float @llvm.fmuladd.f32(float %call.1, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.1 = fmul float %mul33, %conv5.1
  %call14.1 = tail call float @cosf(float noundef %mul9.1) #3
  %4 = tail call float @llvm.fmuladd.f32(float %call14.1, float 0x3FC2157680000000, float %3)
  %mul124.1 = fmul float %mul4, %conv5.1
  %call22.1 = tail call float @cosf(float noundef %mul124.1) #3
  %5 = tail call float @llvm.fmuladd.f32(float %call22.1, float 0xBF87EBAF20000000, float %4)
  %arrayidx.1 = getelementptr inbounds float, ptr %window, i32 %inc
  store float %5, ptr %arrayidx.1, align 4, !tbaa !4
  ...
  %6 = tail call float @llvm.fmuladd.f32(float %call.2, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.2 = fmul float %mul33, %conv5.2
  %call14.2 = tail call float @cosf(float noundef %mul9.2) #3
  %7 = tail call float @llvm.fmuladd.f32(float %call14.2, float 0x3FC2157680000000, float %6)
  %mul124.2 = fmul float %mul4, %conv5.2
  %call22.2 = tail call float @cosf(float noundef %mul124.2) #3
  %8 = tail call float @llvm.fmuladd.f32(float %call22.2, float 0xBF87EBAF20000000, float %7)
  %arrayidx.2 = getelementptr inbounds float, ptr %window, i32 %inc.1
  store float %8, ptr %arrayidx.2, align 4, !tbaa !4
  ...
  %9 = tail call float @llvm.fmuladd.f32(float %call.3, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.3 = fmul float %mul33, %conv5.3
  %call14.3 = tail call float @cosf(float noundef %mul9.3) #3
  %10 = tail call float @llvm.fmuladd.f32(float %call14.3, float 0x3FC2157680000000, float %9)
  %mul124.3 = fmul float %mul4, %conv5.3
  %call22.3 = tail call float @cosf(float noundef %mul124.3) #3
  %11 = tail call float @llvm.fmuladd.f32(float %call22.3, float 0xBF87EBAF20000000, float %10)
  %arrayidx.3 = getelementptr inbounds float, ptr %window, i32 %inc.2
  store float %11, ptr %arrayidx.3, align 4, !tbaa !4
  ...
  %12 = tail call float @llvm.fmuladd.f32(float %call.4, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.4 = fmul float %mul33, %conv5.4
  %call14.4 = tail call float @cosf(float noundef %mul9.4) #3
  %13 = tail call float @llvm.fmuladd.f32(float %call14.4, float 0x3FC2157680000000, float %12)
  %mul124.4 = fmul float %mul4, %conv5.4
  %call22.4 = tail call float @cosf(float noundef %mul124.4) #3
  %14 = tail call float @llvm.fmuladd.f32(float %call22.4, float 0xBF87EBAF20000000, float %13)
  %arrayidx.4 = getelementptr inbounds float, ptr %window, i32 %inc.3
  store float %14, ptr %arrayidx.4, align 4, !tbaa !4
  ...
  %15 = tail call float @llvm.fmuladd.f32(float %call.5, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.5 = fmul float %mul33, %conv5.5
  %call14.5 = tail call float @cosf(float noundef %mul9.5) #3
  %16 = tail call float @llvm.fmuladd.f32(float %call14.5, float 0x3FC2157680000000, float %15)
  %mul124.5 = fmul float %mul4, %conv5.5
  %call22.5 = tail call float @cosf(float noundef %mul124.5) #3
  %17 = tail call float @llvm.fmuladd.f32(float %call22.5, float 0xBF87EBAF20000000, float %16)
  %arrayidx.5 = getelementptr inbounds float, ptr %window, i32 %inc.4
  store float %17, ptr %arrayidx.5, align 4, !tbaa !4
  ...
  %18 = tail call float @llvm.fmuladd.f32(float %call.6, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.6 = fmul float %mul33, %conv5.6
  %call14.6 = tail call float @cosf(float noundef %mul9.6) #3
  %19 = tail call float @llvm.fmuladd.f32(float %call14.6, float 0x3FC2157680000000, float %18)
  %mul124.6 = fmul float %mul4, %conv5.6
  %call22.6 = tail call float @cosf(float noundef %mul124.6) #3
  %20 = tail call float @llvm.fmuladd.f32(float %call22.6, float 0xBF87EBAF20000000, float %19)
  %arrayidx.6 = getelementptr inbounds float, ptr %window, i32 %inc.5
  store float %20, ptr %arrayidx.6, align 4, !tbaa !4
  ...
  %21 = tail call float @llvm.fmuladd.f32(float %call.7, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.7 = fmul float %mul33, %conv5.7
  %call14.7 = tail call float @cosf(float noundef %mul9.7) #3
  %22 = tail call float @llvm.fmuladd.f32(float %call14.7, float 0x3FC2157680000000, float %21)
  %mul124.7 = fmul float %mul4, %conv5.7
  %call22.7 = tail call float @cosf(float noundef %mul124.7) #3
  %23 = tail call float @llvm.fmuladd.f32(float %call22.7, float 0xBF87EBAF20000000, float %22)
  %arrayidx.7 = getelementptr inbounds float, ptr %window, i32 %inc.6
  store float %23, ptr %arrayidx.7, align 4, !tbaa !4
...
for.body.clone:                                   ; preds = %for.cond97.preheader, %for.body.clone
  ...
  %24 = tail call float @llvm.fmuladd.f32(float %call.clone, float 0xBFDF4024C0000000, float 0x3FD6F5C280000000)
  %mul9.clone = fmul float %mul33, %conv5.clone
  %call14.clone = tail call float @cosf(float noundef %mul9.clone) #3
  %25 = tail call float @llvm.fmuladd.f32(float %call14.clone, float 0x3FC2157680000000, float %24)
  %mul124.clone = fmul float %mul4, %conv5.clone
  %call22.clone = tail call float @cosf(float noundef %mul124.clone) #3
  %26 = tail call float @llvm.fmuladd.f32(float %call22.clone, float 0xBF87EBAF20000000, float %25)
  %arrayidx.clone = getelementptr inbounds float, ptr %window, i32 %i.033.clone
  store float %26, ptr %arrayidx.clone, align 4, !tbaa !4
