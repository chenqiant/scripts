; ModuleID = 'dsps_wind_blackman_harris_f32_best.c'
source_filename = "dsps_wind_blackman_harris_f32_best.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree nounwind memory(write)
define dso_local void @dsps_wind_blackman_harris_f32_arp4(ptr nocapture noundef writeonly %window, i32 noundef %len) local_unnamed_addr #0 {
entry:
  ...
  %mul4 = fmul float %conv2, 3.000000e+00
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %conv6 = sitofp i32 %i.026 to float
  ...
  %1 = tail call float @llvm.fmuladd.f32(float %call11, float 0x3FC2157680000000, float %0)
  %mul14 = fmul float %mul4, %conv6
  %call15 = tail call float @cosf(float noundef %mul14) #3
  %2 = tail call float @llvm.fmuladd.f32(float %call15, float 0xBF87EBAF20000000, float %1)
  %arrayidx = getelementptr inbounds float, ptr %window, i32 %i.026
