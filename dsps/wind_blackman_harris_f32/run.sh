clang -O3 -march=rv32imafc_zicsr_zifencei_xesppie -mabi=ilp32f -emit-llvm -S -o dsps_wind_blackman_harris_f32.ll \
dsps_wind_blackman_harris_f32.c \
--target=riscv32-esp-elf \
-I /usr/include/

opt  dsps_wind_blackman_harris_f32.ll -mtriple=riscv32-esp-unknown-elf -passes=riscv-split-loop-by-length -riscv-split-loop-by-length=true -S -o after_splitloopbylength.ll
...
cp after_loopunrollandremainder.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/windows/blackman_harris/float/dsps_wind_blackman_harris_f32_arp4.S
