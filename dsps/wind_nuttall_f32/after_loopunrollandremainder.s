	...
	.file	"dsps_wind_nuttall_f32.c"
	.option	push
	.option	arch, -zca, -zcb, -zcmp, -zcmt
	.section	.sdata,"aw",@progbits
	.p2align	2, 0x0                          # -- Begin function dsps_wind_nuttall_f32
.LCPI0_0:
	.word	0x3eb62739                      # float 0.355767995
.LCPI0_1:
	.word	0xbef98bf8                      # float -0.487396002
.LCPI0_2:
	.word	0x3e13b18e                      # float 0.144232005
.LCPI0_3:
	.word	0xbc4e8102                      # float -0.012604
	.text
	.globl	dsps_wind_nuttall_f32
	.p2align	1
	.type	dsps_wind_nuttall_f32,@function
dsps_wind_nuttall_f32:                  # @dsps_wind_nuttall_f32
# %bb.0:                                # %entry
	blez	a1, .LBB0_9
# %bb.1:                                # %for.body.lr.ph
	addi	sp, sp, -64
...
.LBB0_9:                                # %for.cond.cleanup
	ret
.Lfunc_end0:
	.size	dsps_wind_nuttall_f32, .Lfunc_end0-dsps_wind_nuttall_f32
                                        # -- End function
	.option	pop
