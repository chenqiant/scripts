...
for.cond73.preheader:                             ; preds = %entry, %for.cond.cleanup.loopexit
  ...
  %result0.0.lcssa1 = phi i64 [ 0, %entry ], [ %add.6, %for.cond.cleanup.loopexit ]
  %result0.0.lcssa2 = phi i64 [ 0, %entry ], [ %add.5, %for.cond.cleanup.loopexit ]
  %result0.0.lcssa3 = phi i64 [ 0, %entry ], [ %add.4, %for.cond.cleanup.loopexit ]
  %result0.0.lcssa4 = phi i64 [ 0, %entry ], [ %add.3, %for.cond.cleanup.loopexit ]
  %result0.0.lcssa5 = phi i64 [ 0, %entry ], [ %add.2, %for.cond.cleanup.loopexit ]
  %result0.0.lcssa6 = phi i64 [ 0, %entry ], [ %add.1, %for.cond.cleanup.loopexit ]
  %result0.0.lcssa7 = phi i64 [ %conv1, %entry ], [ %add, %for.cond.cleanup.loopexit ]
...
for.body.clone:                                   ; preds = %for.body.clone, %for.cond73.preheader
  %19 = phi i64 [ %result0.0.lcssa7, %for.cond73.preheader ], [ %add.clone, %for.body.clone ]
...
for.end85:                                        ; preds = %for.body.clone, %for.cond73.preheader
  %acc.0.lcssa = phi i64 [ %result0.0.lcssa7, %for.cond73.preheader ], [ %add.clone, %for.body.clone ]
