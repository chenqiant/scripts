...
define dso_local noundef i32 @dsps_fft2r_sc16_ansi_(ptr noalias nocapture noundef %data, i32 noundef %N, ptr noalias nocapture noundef readonly %sc_table) local_unnamed_addr #0 {
entry:
