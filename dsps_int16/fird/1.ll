...
for.body46.prol:                                  ; preds = %for.body46.prol, %for.body46.prol.preheader
  ...
  %arrayidx51.prol = getelementptr inbounds i16, ptr %4, i32 %n.0144.prol
...
for.body46.prol.loopexit:                         ; preds = %for.body46.prol.loopexit.unr-lcssa, %for.body46.lr.ph
  %add.lcssa.unr = phi i64 [ poison, %for.body46.lr.ph ], [ %add.lcssa.unr.ph, %for.body46.prol.loopexit.unr-lcssa ]
...
for.cond58.preheader:                             ; preds = %for.cond58.preheader.loopexit, %for.cond.cleanup20
  ...
  %coeff_pos.0.lcssa = phi i16 [ %coeff_pos.0141, %for.cond.cleanup20 ], [ %19, %for.cond58.preheader.loopexit ]
...
for.body64.lr.ph:                                 ; preds = %for.cond58.preheader
  %20 = load ptr, ptr %fir, align 4, !tbaa !17
  %21 = add nsw i32 %conv39, -1
  %xtraiter1 = and i32 %conv39, 7
  %22 = icmp ult i32 %21, 7
  br i1 %22, label %for.cond.cleanup63.loopexit.unr-lcssa, label %for.body64.lr.ph.new
...
for.body46:                                       ; preds = %for.body46, %for.body46.lr.ph.new
  ...
  %23 = load i16, ptr %arrayidx48, align 2, !tbaa !18
  %conv49 = sext i16 %23 to i32
  %arrayidx51 = getelementptr inbounds i16, ptr %4, i32 %n.0144
  %24 = load i16, ptr %arrayidx51, align 2, !tbaa !18
  ...
  %25 = load i16, ptr %arrayidx48.1, align 2, !tbaa !18
  %conv49.1 = sext i16 %25 to i32
  %arrayidx51.1 = getelementptr inbounds i16, ptr %4, i32 %inc55
  %26 = load i16, ptr %arrayidx51.1, align 2, !tbaa !18
  %conv52.1 = sext i16 %26 to i32
  ...
  %27 = load i16, ptr %arrayidx48.2, align 2, !tbaa !18
  %conv49.2 = sext i16 %27 to i32
  %arrayidx51.2 = getelementptr inbounds i16, ptr %4, i32 %inc55.1
  %28 = load i16, ptr %arrayidx51.2, align 2, !tbaa !18
  %conv52.2 = sext i16 %28 to i32
  ...
  %29 = load i16, ptr %arrayidx48.3, align 2, !tbaa !18
  %conv49.3 = sext i16 %29 to i32
  %arrayidx51.3 = getelementptr inbounds i16, ptr %4, i32 %inc55.2
  %30 = load i16, ptr %arrayidx51.3, align 2, !tbaa !18
  %conv52.3 = sext i16 %30 to i32
  ...
  %31 = load i16, ptr %arrayidx48.4, align 2, !tbaa !18
  %conv49.4 = sext i16 %31 to i32
  %arrayidx51.4 = getelementptr inbounds i16, ptr %4, i32 %inc55.3
  %32 = load i16, ptr %arrayidx51.4, align 2, !tbaa !18
  %conv52.4 = sext i16 %32 to i32
  ...
  %33 = load i16, ptr %arrayidx48.5, align 2, !tbaa !18
  %conv49.5 = sext i16 %33 to i32
  %arrayidx51.5 = getelementptr inbounds i16, ptr %4, i32 %inc55.4
  %34 = load i16, ptr %arrayidx51.5, align 2, !tbaa !18
  %conv52.5 = sext i16 %34 to i32
  ...
  %35 = load i16, ptr %arrayidx48.6, align 2, !tbaa !18
  %conv49.6 = sext i16 %35 to i32
  %arrayidx51.6 = getelementptr inbounds i16, ptr %4, i32 %inc55.5
  %36 = load i16, ptr %arrayidx51.6, align 2, !tbaa !18
  %conv52.6 = sext i16 %36 to i32
  ...
  %37 = load i16, ptr %arrayidx48.7, align 2, !tbaa !18
  %conv49.7 = sext i16 %37 to i32
  %arrayidx51.7 = getelementptr inbounds i16, ptr %4, i32 %inc55.6
  %38 = load i16, ptr %arrayidx51.7, align 2, !tbaa !18
  %conv52.7 = sext i16 %38 to i32
...
for.cond.cleanup63.loopexit.unr-lcssa:            ; preds = %for.cond.cleanup63.loopexit.unr-lcssa.loopexit, %for.body64.lr.ph
  %add75.lcssa.ph = phi i64 [ poison, %for.body64.lr.ph ], [ %add75.lcssa.ph.ph, %for.cond.cleanup63.loopexit.unr-lcssa.loopexit ]
...
for.body64.epil:                                  ; preds = %for.body64.epil, %for.body64.epil.preheader
  ...
  %arrayidx68.epil = getelementptr inbounds i16, ptr %20, i32 %idxprom67.epil
  %39 = load i16, ptr %arrayidx68.epil, align 2, !tbaa !18
  %conv69.epil = sext i16 %39 to i32
  %arrayidx71.epil = getelementptr inbounds i16, ptr %4, i32 %n57.0151.epil
  %40 = load i16, ptr %arrayidx71.epil, align 2, !tbaa !18
  %conv72.epil = sext i16 %40 to i32
...
for.cond.cleanup63:                               ; preds = %for.cond.cleanup63.loopexit, %for.cond58.preheader
  ...
  %41 = getelementptr inbounds i16, ptr %output, i32 %i.0156
  store i16 %conv91, ptr %41, align 2
...
for.body64:                                       ; preds = %for.body64, %for.body64.lr.ph.new
  ...
  %arrayidx68 = getelementptr inbounds i16, ptr %20, i32 %idxprom67
  %42 = load i16, ptr %arrayidx68, align 2, !tbaa !18
  %conv69 = sext i16 %42 to i32
  %arrayidx71 = getelementptr inbounds i16, ptr %4, i32 %n57.0151
  %43 = load i16, ptr %arrayidx71, align 2, !tbaa !18
  ...
  %arrayidx68.1 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.1
  %44 = load i16, ptr %arrayidx68.1, align 2, !tbaa !18
  %conv69.1 = sext i16 %44 to i32
  %arrayidx71.1 = getelementptr inbounds i16, ptr %4, i32 %inc77
  %45 = load i16, ptr %arrayidx71.1, align 2, !tbaa !18
  %conv72.1 = sext i16 %45 to i32
  ...
  %arrayidx68.2 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.2
  %46 = load i16, ptr %arrayidx68.2, align 2, !tbaa !18
  %conv69.2 = sext i16 %46 to i32
  %arrayidx71.2 = getelementptr inbounds i16, ptr %4, i32 %inc77.1
  %47 = load i16, ptr %arrayidx71.2, align 2, !tbaa !18
  %conv72.2 = sext i16 %47 to i32
  ...
  %arrayidx68.3 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.3
  %48 = load i16, ptr %arrayidx68.3, align 2, !tbaa !18
  %conv69.3 = sext i16 %48 to i32
  %arrayidx71.3 = getelementptr inbounds i16, ptr %4, i32 %inc77.2
  %49 = load i16, ptr %arrayidx71.3, align 2, !tbaa !18
  %conv72.3 = sext i16 %49 to i32
  ...
  %arrayidx68.4 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.4
  %50 = load i16, ptr %arrayidx68.4, align 2, !tbaa !18
  %conv69.4 = sext i16 %50 to i32
  %arrayidx71.4 = getelementptr inbounds i16, ptr %4, i32 %inc77.3
  %51 = load i16, ptr %arrayidx71.4, align 2, !tbaa !18
  %conv72.4 = sext i16 %51 to i32
  ...
  %arrayidx68.5 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.5
  %52 = load i16, ptr %arrayidx68.5, align 2, !tbaa !18
  %conv69.5 = sext i16 %52 to i32
  %arrayidx71.5 = getelementptr inbounds i16, ptr %4, i32 %inc77.4
  %53 = load i16, ptr %arrayidx71.5, align 2, !tbaa !18
  %conv72.5 = sext i16 %53 to i32
  ...
  %arrayidx68.6 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.6
  %54 = load i16, ptr %arrayidx68.6, align 2, !tbaa !18
  %conv69.6 = sext i16 %54 to i32
  %arrayidx71.6 = getelementptr inbounds i16, ptr %4, i32 %inc77.5
  %55 = load i16, ptr %arrayidx71.6, align 2, !tbaa !18
  %conv72.6 = sext i16 %55 to i32
  ...
  %arrayidx68.7 = getelementptr inbounds i16, ptr %20, i32 %idxprom67.7
  %56 = load i16, ptr %arrayidx68.7, align 2, !tbaa !18
  %conv69.7 = sext i16 %56 to i32
  %arrayidx71.7 = getelementptr inbounds i16, ptr %4, i32 %inc77.6
  %57 = load i16, ptr %arrayidx71.7, align 2, !tbaa !18
  %conv72.7 = sext i16 %57 to i32
