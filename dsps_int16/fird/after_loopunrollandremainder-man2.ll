...
for.body46.15:                                    ; preds = %for.cond.cleanup20, %for.body46.15
  ...
  %arrayidx48.1 = getelementptr i16, ptr %arrayidx48, i32 -1
  ...
  %arrayidx51.1 = getelementptr i16, ptr %arrayidx51, i32 1
...
for.cond227.preheader.loopexit:                   ; preds = %for.body46.clone
  ; %.neg = sub i16 0, %4
  %44 = sub i16 %coeff_pos.0.lcssa, %4
  %45 = add i16 %44, %11
...
for.body46.clone:                                 ; preds = %for.cond58.preheader, %for.body46.clone
  %coeff_pos.0145.clone = phi i16 [ %coeff_pos.0.clone, %for.body46.clone ], [ %coeff_pos.0.lcssa, %for.body64.lr.ph ]
  %n.0144.clone = phi i32 [ %inc55.clone, %for.body46.clone ], [ %n.0.lcssa, %for.body64.lr.ph ]
  %acc.0143.clone = phi i64 [ %add.clone, %for.body46.clone ], [ %acc.0.lcssa, %for.body64.lr.ph ]
