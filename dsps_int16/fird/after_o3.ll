...
for.cond14.preheader.lr.ph:                       ; preds = %if.end
  ...
  %d_pos.promoted = load i16, ptr %d_pos, align 2, !tbaa !16
  %pos.promoted3 = load i16, ptr %pos, align 2, !tbaa !17
  %conv15 = sext i16 %3 to i32
  br label %for.cond14.preheader

for.cond14.preheader:                             ; preds = %for.cond.cleanup63, %for.cond14.preheader.lr.ph
  %inc30.lcssa5 = phi i16 [ %pos.promoted3, %for.cond14.preheader.lr.ph ], [ %inc30.lcssa4, %for.cond.cleanup63 ]
  %6 = phi i16 [ %d_pos.promoted, %for.cond14.preheader.lr.ph ], [ 0, %for.cond.cleanup63 ]
  ...
  br i1 %cmp18138, label %for.body21.preheader, label %for.cond.cleanup20

for.body21.preheader:                             ; preds = %for.cond14.preheader
  %conv16 = sext i16 %6 to i32
  %sub17 = sub nsw i32 %conv15, %conv16
  %smax = tail call i32 @llvm.smax.i32(i32 %sub17, i32 1)
  %7 = add i32 %input_pos.0154, %smax
  br label %for.body21
...
for.cond.cleanup20:                               ; preds = %for.cond.cleanup20.loopexit, %for.cond14.preheader
  %inc30.lcssa4 = phi i16 [ %inc30.lcssa5, %for.cond14.preheader ], [ %inc30, %for.cond.cleanup20.loopexit ]
  %input_pos.1.lcssa = phi i32 [ %input_pos.0154, %for.cond14.preheader ], [ %7, %for.cond.cleanup20.loopexit ]
  %conv39 = sext i16 %inc30.lcssa4 to i32
  %cmp43142 = icmp sgt i32 %sub45, %conv39
  br i1 %cmp43142, label %for.body46.15, label %for.cond58.preheader

for.body21:                                       ; preds = %for.body21.preheader, %for.body21
  %inc302 = phi i16 [ %inc30, %for.body21 ], [ %inc30.lcssa5, %for.body21.preheader ]
  %input_pos.1139 = phi i32 [ %inc, %for.body21 ], [ %input_pos.0154, %for.body21.preheader ]
  %cmp24.not = icmp slt i16 %inc302, %4
  %spec.select = select i1 %cmp24.not, i16 %inc302, i16 0
  %inc = add i32 %input_pos.1139, 1
  %arrayidx = getelementptr inbounds i16, ptr %input, i32 %input_pos.1139
  %8 = load i16, ptr %arrayidx, align 2, !tbaa !18
  %inc30 = add nsw i16 %spec.select, 1
  %idxprom = sext i16 %spec.select to i32
  %arrayidx31 = getelementptr inbounds i16, ptr %5, i32 %idxprom
  store i16 %8, ptr %arrayidx31, align 2, !tbaa !18
  %exitcond.not = icmp eq i32 %inc, %7
  br i1 %exitcond.not, label %for.cond.cleanup20.loopexit, label %for.body21, !llvm.loop !19
...
for.cond58.preheader:                             ; preds = %for.body46.15, %for.cond.cleanup20
  ...
  %9 = trunc i32 %n.0.lcssa to i16
  %cmp61148 = icmp slt i32 %n.0.lcssa, %conv42
...
for.body46.15:                                    ; preds = %for.cond.cleanup20, %for.body46.15
  ...
  %10 = load i16, ptr %arrayidx48, align 2, !tbaa !18
  %conv49 = sext i16 %10 to i32
  %arrayidx51 = getelementptr inbounds i16, ptr %5, i32 %n.0144
  %11 = load i16, ptr %arrayidx51, align 2, !tbaa !18
  %conv52 = sext i16 %11 to i32
  ...
  %12 = load i16, ptr %arrayidx48.1, align 2, !tbaa !18
  %conv49.1 = sext i16 %12 to i32
  %arrayidx51.1 = getelementptr inbounds i16, ptr %arrayidx51, i32 1
  %13 = load i16, ptr %arrayidx51.1, align 2, !tbaa !18
  %conv52.1 = sext i16 %13 to i32
  ...
  %14 = load i16, ptr %arrayidx48.2, align 2, !tbaa !18
  %conv49.2 = sext i16 %14 to i32
  %arrayidx51.2 = getelementptr inbounds i16, ptr %arrayidx51, i32 2
  %15 = load i16, ptr %arrayidx51.2, align 2, !tbaa !18
  %conv52.2 = sext i16 %15 to i32
  ...
  %16 = load i16, ptr %arrayidx48.3, align 2, !tbaa !18
  %conv49.3 = sext i16 %16 to i32
  %arrayidx51.3 = getelementptr inbounds i16, ptr %arrayidx51, i32 3
  %17 = load i16, ptr %arrayidx51.3, align 2, !tbaa !18
  %conv52.3 = sext i16 %17 to i32
  ...
  %18 = load i16, ptr %arrayidx48.4, align 2, !tbaa !18
  %conv49.4 = sext i16 %18 to i32
  %arrayidx51.4 = getelementptr inbounds i16, ptr %arrayidx51, i32 4
  %19 = load i16, ptr %arrayidx51.4, align 2, !tbaa !18
  %conv52.4 = sext i16 %19 to i32
  ...
  %20 = load i16, ptr %arrayidx48.5, align 2, !tbaa !18
  %conv49.5 = sext i16 %20 to i32
  %arrayidx51.5 = getelementptr inbounds i16, ptr %arrayidx51, i32 5
  %21 = load i16, ptr %arrayidx51.5, align 2, !tbaa !18
  %conv52.5 = sext i16 %21 to i32
  ...
  %22 = load i16, ptr %arrayidx48.6, align 2, !tbaa !18
  %conv49.6 = sext i16 %22 to i32
  %arrayidx51.6 = getelementptr inbounds i16, ptr %arrayidx51, i32 6
  %23 = load i16, ptr %arrayidx51.6, align 2, !tbaa !18
  %conv52.6 = sext i16 %23 to i32
  ...
  %24 = load i16, ptr %arrayidx48.7, align 2, !tbaa !18
  %conv49.7 = sext i16 %24 to i32
  %arrayidx51.7 = getelementptr inbounds i16, ptr %arrayidx51, i32 7
  %25 = load i16, ptr %arrayidx51.7, align 2, !tbaa !18
  %conv52.7 = sext i16 %25 to i32
  ...
  %26 = load i16, ptr %arrayidx48.8, align 2, !tbaa !18
  %conv49.8 = sext i16 %26 to i32
  %arrayidx51.8 = getelementptr inbounds i16, ptr %arrayidx51, i32 8
  %27 = load i16, ptr %arrayidx51.8, align 2, !tbaa !18
  %conv52.8 = sext i16 %27 to i32
  ...
  %28 = load i16, ptr %arrayidx48.9, align 2, !tbaa !18
  %conv49.9 = sext i16 %28 to i32
  %arrayidx51.9 = getelementptr inbounds i16, ptr %arrayidx51, i32 9
  %29 = load i16, ptr %arrayidx51.9, align 2, !tbaa !18
  %conv52.9 = sext i16 %29 to i32
  ...
  %30 = load i16, ptr %arrayidx48.10, align 2, !tbaa !18
  %conv49.10 = sext i16 %30 to i32
  %arrayidx51.10 = getelementptr inbounds i16, ptr %arrayidx51, i32 10
  %31 = load i16, ptr %arrayidx51.10, align 2, !tbaa !18
  %conv52.10 = sext i16 %31 to i32
  ...
  %32 = load i16, ptr %arrayidx48.11, align 2, !tbaa !18
  %conv49.11 = sext i16 %32 to i32
  %arrayidx51.11 = getelementptr inbounds i16, ptr %arrayidx51, i32 11
  %33 = load i16, ptr %arrayidx51.11, align 2, !tbaa !18
  %conv52.11 = sext i16 %33 to i32
  ...
  %34 = load i16, ptr %arrayidx48.12, align 2, !tbaa !18
  %conv49.12 = sext i16 %34 to i32
  %arrayidx51.12 = getelementptr inbounds i16, ptr %arrayidx51, i32 12
  %35 = load i16, ptr %arrayidx51.12, align 2, !tbaa !18
  %conv52.12 = sext i16 %35 to i32
  ...
  %36 = load i16, ptr %arrayidx48.13, align 2, !tbaa !18
  %conv49.13 = sext i16 %36 to i32
  %arrayidx51.13 = getelementptr inbounds i16, ptr %arrayidx51, i32 13
  %37 = load i16, ptr %arrayidx51.13, align 2, !tbaa !18
  %conv52.13 = sext i16 %37 to i32
  ...
  %38 = load i16, ptr %arrayidx48.14, align 2, !tbaa !18
  %conv49.14 = sext i16 %38 to i32
  %arrayidx51.14 = getelementptr inbounds i16, ptr %arrayidx51, i32 14
  %39 = load i16, ptr %arrayidx51.14, align 2, !tbaa !18
  %conv52.14 = sext i16 %39 to i32
  ...
  %40 = load i16, ptr %arrayidx48.15, align 2, !tbaa !18
  %conv49.15 = sext i16 %40 to i32
  %arrayidx51.15 = getelementptr inbounds i16, ptr %arrayidx51, i32 15
  %41 = load i16, ptr %arrayidx51.15, align 2, !tbaa !18
  %conv52.15 = sext i16 %41 to i32
...
for.cond227.preheader.loopexit:                   ; preds = %for.body46.clone
  %42 = sub i16 %coeff_pos.0.lcssa, %4
  %43 = add i16 %42, %9
  br label %for.cond227.preheader

for.cond227.preheader:                            ; preds = %for.cond227.preheader.loopexit, %for.cond58.preheader
  %acc.1.lcssa1 = phi i64 [ %acc.0.lcssa, %for.cond58.preheader ], [ %add.clone, %for.cond227.preheader.loopexit ]
  %coeff_pos.1.lcssa = phi i16 [ %coeff_pos.0.lcssa, %for.cond58.preheader ], [ %43, %for.cond227.preheader.loopexit ]
  %sub230 = add nuw nsw i32 %conv39, -15
  %cmp231659 = icmp sgt i16 %inc30.lcssa4, 15
  br i1 %cmp231659, label %for.body64.15, label %for.cond398.preheader
...
for.body46.clone:                                 ; preds = %for.cond58.preheader, %for.body46.clone
  ...
  %44 = load i16, ptr %arrayidx48.clone, align 2, !tbaa !18
  %conv49.clone = sext i16 %44 to i32
  %arrayidx51.clone = getelementptr inbounds i16, ptr %5, i32 %n.0144.clone
  %45 = load i16, ptr %arrayidx51.clone, align 2, !tbaa !18
  %conv52.clone = sext i16 %45 to i32
...
for.cond398.preheader.loopexit:                   ; preds = %for.body64.15
  %m47 = and i32 %conv39, 32752
  br label %for.cond398.preheader

for.cond398.preheader:                            ; preds = %for.cond398.preheader.loopexit, %for.cond227.preheader
  %46 = phi i64 [ %acc.1.lcssa1, %for.cond227.preheader ], [ %add75.15, %for.cond398.preheader.loopexit ]
  %47 = phi i16 [ %coeff_pos.1.lcssa, %for.cond227.preheader ], [ %dec66.15, %for.cond398.preheader.loopexit ]
  %48 = phi i32 [ 0, %for.cond227.preheader ], [ %m47, %for.cond398.preheader.loopexit ]
  %cmp401666 = icmp slt i32 %48, %conv39
  br i1 %cmp401666, label %for.body64.clone, label %for.cond.cleanup63

for.body64.15:                                    ; preds = %for.cond227.preheader, %for.body64.15
  %n57.0151 = phi i32 [ %inc77.15, %for.body64.15 ], [ 0, %for.cond227.preheader ]
  %coeff_pos.1150 = phi i16 [ %dec66.15, %for.body64.15 ], [ %coeff_pos.1.lcssa, %for.cond227.preheader ]
  %acc.1149 = phi i64 [ %add75.15, %for.body64.15 ], [ %acc.1.lcssa1, %for.cond227.preheader ]
  %idxprom67 = sext i16 %coeff_pos.1150 to i32
  %arrayidx68 = getelementptr inbounds i16, ptr %0, i32 %idxprom67
  %49 = load i16, ptr %arrayidx68, align 2, !tbaa !18
  %conv69 = sext i16 %49 to i32
  %arrayidx71 = getelementptr inbounds i16, ptr %5, i32 %n57.0151
  %50 = load i16, ptr %arrayidx71, align 2, !tbaa !18
  ...
  %51 = load i16, ptr %arrayidx68.1, align 2, !tbaa !18
  %conv69.1 = sext i16 %51 to i32
  %arrayidx71.1 = getelementptr inbounds i16, ptr %arrayidx71, i32 1
  %52 = load i16, ptr %arrayidx71.1, align 2, !tbaa !18
  %conv72.1 = sext i16 %52 to i32
  ...
  %53 = load i16, ptr %arrayidx68.2, align 2, !tbaa !18
  %conv69.2 = sext i16 %53 to i32
  %arrayidx71.2 = getelementptr inbounds i16, ptr %arrayidx71, i32 2
  %54 = load i16, ptr %arrayidx71.2, align 2, !tbaa !18
  %conv72.2 = sext i16 %54 to i32
  ...
  %55 = load i16, ptr %arrayidx68.3, align 2, !tbaa !18
  %conv69.3 = sext i16 %55 to i32
  %arrayidx71.3 = getelementptr inbounds i16, ptr %arrayidx71, i32 3
  %56 = load i16, ptr %arrayidx71.3, align 2, !tbaa !18
  %conv72.3 = sext i16 %56 to i32
  ...
  %57 = load i16, ptr %arrayidx68.4, align 2, !tbaa !18
  %conv69.4 = sext i16 %57 to i32
  %arrayidx71.4 = getelementptr inbounds i16, ptr %arrayidx71, i32 4
  %58 = load i16, ptr %arrayidx71.4, align 2, !tbaa !18
  %conv72.4 = sext i16 %58 to i32
  ...
  %59 = load i16, ptr %arrayidx68.5, align 2, !tbaa !18
  %conv69.5 = sext i16 %59 to i32
  %arrayidx71.5 = getelementptr inbounds i16, ptr %arrayidx71, i32 5
  %60 = load i16, ptr %arrayidx71.5, align 2, !tbaa !18
  %conv72.5 = sext i16 %60 to i32
  ...
  %61 = load i16, ptr %arrayidx68.6, align 2, !tbaa !18
  %conv69.6 = sext i16 %61 to i32
  %arrayidx71.6 = getelementptr inbounds i16, ptr %arrayidx71, i32 6
  %62 = load i16, ptr %arrayidx71.6, align 2, !tbaa !18
  %conv72.6 = sext i16 %62 to i32
  ...
  %63 = load i16, ptr %arrayidx68.7, align 2, !tbaa !18
  %conv69.7 = sext i16 %63 to i32
  %arrayidx71.7 = getelementptr inbounds i16, ptr %arrayidx71, i32 7
  %64 = load i16, ptr %arrayidx71.7, align 2, !tbaa !18
  %conv72.7 = sext i16 %64 to i32
  ...
  %65 = load i16, ptr %arrayidx68.8, align 2, !tbaa !18
  %conv69.8 = sext i16 %65 to i32
  %arrayidx71.8 = getelementptr inbounds i16, ptr %arrayidx71, i32 8
  %66 = load i16, ptr %arrayidx71.8, align 2, !tbaa !18
  %conv72.8 = sext i16 %66 to i32
  ...
  %67 = load i16, ptr %arrayidx68.9, align 2, !tbaa !18
  %conv69.9 = sext i16 %67 to i32
  %arrayidx71.9 = getelementptr inbounds i16, ptr %arrayidx71, i32 9
  %68 = load i16, ptr %arrayidx71.9, align 2, !tbaa !18
  %conv72.9 = sext i16 %68 to i32
  ...
  %69 = load i16, ptr %arrayidx68.10, align 2, !tbaa !18
  %conv69.10 = sext i16 %69 to i32
  %arrayidx71.10 = getelementptr inbounds i16, ptr %arrayidx71, i32 10
  %70 = load i16, ptr %arrayidx71.10, align 2, !tbaa !18
  %conv72.10 = sext i16 %70 to i32
  ...
  %71 = load i16, ptr %arrayidx68.11, align 2, !tbaa !18
  %conv69.11 = sext i16 %71 to i32
  %arrayidx71.11 = getelementptr inbounds i16, ptr %arrayidx71, i32 11
  %72 = load i16, ptr %arrayidx71.11, align 2, !tbaa !18
  %conv72.11 = sext i16 %72 to i32
  ...
  %73 = load i16, ptr %arrayidx68.12, align 2, !tbaa !18
  %conv69.12 = sext i16 %73 to i32
  %arrayidx71.12 = getelementptr inbounds i16, ptr %arrayidx71, i32 12
  %74 = load i16, ptr %arrayidx71.12, align 2, !tbaa !18
  %conv72.12 = sext i16 %74 to i32
  ...
  %75 = load i16, ptr %arrayidx68.13, align 2, !tbaa !18
  %conv69.13 = sext i16 %75 to i32
  %arrayidx71.13 = getelementptr inbounds i16, ptr %arrayidx71, i32 13
  %76 = load i16, ptr %arrayidx71.13, align 2, !tbaa !18
  %conv72.13 = sext i16 %76 to i32
  ...
  %77 = load i16, ptr %arrayidx68.14, align 2, !tbaa !18
  %conv69.14 = sext i16 %77 to i32
  %arrayidx71.14 = getelementptr inbounds i16, ptr %arrayidx71, i32 14
  %78 = load i16, ptr %arrayidx71.14, align 2, !tbaa !18
  %conv72.14 = sext i16 %78 to i32
  ...
  %79 = load i16, ptr %arrayidx68.15, align 2, !tbaa !18
  %conv69.15 = sext i16 %79 to i32
  %arrayidx71.15 = getelementptr inbounds i16, ptr %arrayidx71, i32 15
  %80 = load i16, ptr %arrayidx71.15, align 2, !tbaa !18
  %conv72.15 = sext i16 %80 to i32
  ...
  br i1 %exitcond159.not.15, label %for.body64.15, label %for.cond398.preheader.loopexit, !llvm.loop !22

for.body64.clone:                                 ; preds = %for.cond398.preheader, %for.body64.clone
  %n57.0151.clone = phi i32 [ %inc77.clone, %for.body64.clone ], [ %48, %for.cond398.preheader ]
  %coeff_pos.1150.clone = phi i16 [ %dec66.clone, %for.body64.clone ], [ %47, %for.cond398.preheader ]
  %acc.1149.clone = phi i64 [ %add75.clone, %for.body64.clone ], [ %46, %for.cond398.preheader ]
  ...
  %81 = load i16, ptr %arrayidx68.clone, align 2, !tbaa !18
  %conv69.clone = sext i16 %81 to i32
  %arrayidx71.clone = getelementptr inbounds i16, ptr %5, i32 %n57.0151.clone
  %82 = load i16, ptr %arrayidx71.clone, align 2, !tbaa !18
  %conv72.clone = sext i16 %82 to i32
...
for.cond.cleanup63:                               ; preds = %for.body64.clone, %for.cond398.preheader
  %acc.3.lcssa = phi i64 [ %46, %for.cond398.preheader ], [ %add75.clone, %for.body64.clone ]
  ...
  %83 = getelementptr inbounds i16, ptr %output, i32 %i.0156
  store i16 %conv91, ptr %83, align 2
  %inc96 = add nuw nsw i32 %i.0156, 1
  %exitcond160.not = icmp eq i32 %inc96, %len
  br i1 %exitcond160.not, label %for.cond.cleanup.loopexit, label %for.cond14.preheader, !llvm.loop !23
}
