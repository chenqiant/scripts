...
; for.cond58.preheader.loopexit:                    ; preds = %for.body46.15
...
for.body46.15:                                    ; preds = %for.body46.15, %for.body46.lr.ph
  %coeff_pos.0145 = phi i16 [ %coeff_pos.0141, %for.cond.cleanup20 ], [ %coeff_pos.0.15, %for.body46.15 ]
  ...
  %arrayidx48.1 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.1
  %16 = load i16, ptr %arrayidx48.1, align 2, !tbaa !18
  %conv49.1 = sext i16 %16 to i32
  %arrayidx51.1 = getelementptr inbounds i16, ptr %5, i32 %inc55
  ...
  %arrayidx48.2 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.2
  %18 = load i16, ptr %arrayidx48.2, align 2, !tbaa !18
  %conv49.2 = sext i16 %18 to i32
  %arrayidx51.2 = getelementptr inbounds i16, ptr %5, i32 %inc55.1
  ...
  %arrayidx48.3 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.3
  %20 = load i16, ptr %arrayidx48.3, align 2, !tbaa !18
  %conv49.3 = sext i16 %20 to i32
  %arrayidx51.3 = getelementptr inbounds i16, ptr %5, i32 %inc55.2
  ...
  %arrayidx48.4 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.4
  %22 = load i16, ptr %arrayidx48.4, align 2, !tbaa !18
  %conv49.4 = sext i16 %22 to i32
  %arrayidx51.4 = getelementptr inbounds i16, ptr %5, i32 %inc55.3
  ...
  %arrayidx48.5 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.5
  %24 = load i16, ptr %arrayidx48.5, align 2, !tbaa !18
  %conv49.5 = sext i16 %24 to i32
  %arrayidx51.5 = getelementptr inbounds i16, ptr %5, i32 %inc55.4
  ...
  %arrayidx48.6 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.6
  %26 = load i16, ptr %arrayidx48.6, align 2, !tbaa !18
  %conv49.6 = sext i16 %26 to i32
  %arrayidx51.6 = getelementptr inbounds i16, ptr %5, i32 %inc55.5
  ...
  %arrayidx48.7 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.7
  %28 = load i16, ptr %arrayidx48.7, align 2, !tbaa !18
  %conv49.7 = sext i16 %28 to i32
  %arrayidx51.7 = getelementptr inbounds i16, ptr %5, i32 %inc55.6
  ...
  %arrayidx48.8 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.8
  %30 = load i16, ptr %arrayidx48.8, align 2, !tbaa !18
  %conv49.8 = sext i16 %30 to i32
  %arrayidx51.8 = getelementptr inbounds i16, ptr %5, i32 %inc55.7
  ...
  %arrayidx48.9 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.9
  %32 = load i16, ptr %arrayidx48.9, align 2, !tbaa !18
  %conv49.9 = sext i16 %32 to i32
  %arrayidx51.9 = getelementptr inbounds i16, ptr %5, i32 %inc55.8
  ...
  %arrayidx48.10 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.10
  %34 = load i16, ptr %arrayidx48.10, align 2, !tbaa !18
  %conv49.10 = sext i16 %34 to i32
  %arrayidx51.10 = getelementptr inbounds i16, ptr %5, i32 %inc55.9
  ...
  %arrayidx48.11 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.11
  %36 = load i16, ptr %arrayidx48.11, align 2, !tbaa !18
  %conv49.11 = sext i16 %36 to i32
  %arrayidx51.11 = getelementptr inbounds i16, ptr %5, i32 %inc55.10
  ...
  %arrayidx48.12 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.12
  %38 = load i16, ptr %arrayidx48.12, align 2, !tbaa !18
  %conv49.12 = sext i16 %38 to i32
  %arrayidx51.12 = getelementptr inbounds i16, ptr %5, i32 %inc55.11
  ...
  %arrayidx48.13 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.13
  %40 = load i16, ptr %arrayidx48.13, align 2, !tbaa !18
  %conv49.13 = sext i16 %40 to i32
  %arrayidx51.13 = getelementptr inbounds i16, ptr %5, i32 %inc55.12
  ...
  %arrayidx48.14 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.14
  %42 = load i16, ptr %arrayidx48.14, align 2, !tbaa !18
  %conv49.14 = sext i16 %42 to i32
  %arrayidx51.14 = getelementptr inbounds i16, ptr %5, i32 %inc55.13
  ...
  %arrayidx48.15 = getelementptr inbounds i16, ptr %0, i32 %idxprom47.15
  %44 = load i16, ptr %arrayidx48.15, align 2, !tbaa !18
  %conv49.15 = sext i16 %44 to i32
  %arrayidx51.15 = getelementptr inbounds i16, ptr %5, i32 %inc55.14
...
for.cond227.preheader.loopexit:                   ; preds = %for.body46.clone
  %46 = sub i16 %coeff_pos.0.lcssa, %4
  %47 = add i16 %46, %13
...
for.cond227.preheader:                            ; preds = %for.cond58.preheader, %for.cond227.preheader.loopexit
  ...
  %coeff_pos.1.lcssa = phi i16 [ %coeff_pos.0.lcssa, %for.cond58.preheader ], [ %47, %for.cond227.preheader.loopexit ]
  %sub230 = add nuw i32 %conv42, -15
...
for.body46.clone:                                 ; preds = %for.body46.clone
  %coeff_pos.0145.clone = phi i16 [ %coeff_pos.0141, %for.body64.lr.ph ], [ %coeff_pos.0.clone, %for.body46.clone ]
  ...
  %48 = load i16, ptr %arrayidx48.clone, align 2, !tbaa !18
  %conv49.clone = sext i16 %48 to i32
  %arrayidx51.clone = getelementptr inbounds i16, ptr %5, i32 %n.0144.clone
  %49 = load i16, ptr %arrayidx51.clone, align 2, !tbaa !18
  %conv52.clone = sext i16 %49 to i32
  ...
  %exitcond.not.clone = icmp eq i32 %inc55.clone, %conv39
...
for.cond398.preheader:                            ; preds = %for.body64.15, %for.cond227.preheader
  %50 = phi i64 [ %acc.1.lcssa1, %for.cond227.preheader ], [ %add75.15, %for.body64.15 ]
  %51 = phi i16 [ %coeff_pos.1.lcssa, %for.cond227.preheader ], [ %dec66.15, %for.body64.15 ]
  %52 = phi i32 [ 0, %for.cond227.preheader ], [ %m47, %for.body64.15 ]
  %cmp401666 = icmp slt i32 %52, %conv39
  br i1 %cmp401666, label %for.body64.clone, label %for.cond.cleanup63

for.body64.15:                                    ; preds = %for.body64.15, %for.body233.preheader, %for.body64.lr.ph
  ...
  %53 = load i16, ptr %arrayidx68, align 2, !tbaa !18
  %conv69 = sext i16 %53 to i32
  %arrayidx71 = getelementptr inbounds i16, ptr %5, i32 %n57.0151
  %54 = load i16, ptr %arrayidx71, align 2, !tbaa !18
  ...
  %arrayidx68.1 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.1
  %55 = load i16, ptr %arrayidx68.1, align 2, !tbaa !18
  %conv69.1 = sext i16 %55 to i32
  %arrayidx71.1 = getelementptr inbounds i16, ptr %5, i32 %inc77
  %56 = load i16, ptr %arrayidx71.1, align 2, !tbaa !18
  %conv72.1 = sext i16 %56 to i32
  ...
  %arrayidx68.2 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.2
  %57 = load i16, ptr %arrayidx68.2, align 2, !tbaa !18
  %conv69.2 = sext i16 %57 to i32
  %arrayidx71.2 = getelementptr inbounds i16, ptr %5, i32 %inc77.1
  %58 = load i16, ptr %arrayidx71.2, align 2, !tbaa !18
  %conv72.2 = sext i16 %58 to i32
  ...
  %arrayidx68.3 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.3
  %59 = load i16, ptr %arrayidx68.3, align 2, !tbaa !18
  %conv69.3 = sext i16 %59 to i32
  %arrayidx71.3 = getelementptr inbounds i16, ptr %5, i32 %inc77.2
  %60 = load i16, ptr %arrayidx71.3, align 2, !tbaa !18
  %conv72.3 = sext i16 %60 to i32
  ...
  %arrayidx68.4 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.4
  %61 = load i16, ptr %arrayidx68.4, align 2, !tbaa !18
  %conv69.4 = sext i16 %61 to i32
  %arrayidx71.4 = getelementptr inbounds i16, ptr %5, i32 %inc77.3
  %62 = load i16, ptr %arrayidx71.4, align 2, !tbaa !18
  %conv72.4 = sext i16 %62 to i32
  ...
  %arrayidx68.5 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.5
  %63 = load i16, ptr %arrayidx68.5, align 2, !tbaa !18
  %conv69.5 = sext i16 %63 to i32
  %arrayidx71.5 = getelementptr inbounds i16, ptr %5, i32 %inc77.4
  %64 = load i16, ptr %arrayidx71.5, align 2, !tbaa !18
  %conv72.5 = sext i16 %64 to i32
  ...
  %arrayidx68.6 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.6
  %65 = load i16, ptr %arrayidx68.6, align 2, !tbaa !18
  %conv69.6 = sext i16 %65 to i32
  %arrayidx71.6 = getelementptr inbounds i16, ptr %5, i32 %inc77.5
  %66 = load i16, ptr %arrayidx71.6, align 2, !tbaa !18
  %conv72.6 = sext i16 %66 to i32
  ...
  %arrayidx68.7 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.7
  %67 = load i16, ptr %arrayidx68.7, align 2, !tbaa !18
  %conv69.7 = sext i16 %67 to i32
  %arrayidx71.7 = getelementptr inbounds i16, ptr %5, i32 %inc77.6
  %68 = load i16, ptr %arrayidx71.7, align 2, !tbaa !18
  %conv72.7 = sext i16 %68 to i32
  ...
  %arrayidx68.8 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.8
  %69 = load i16, ptr %arrayidx68.8, align 2, !tbaa !18
  %conv69.8 = sext i16 %69 to i32
  %arrayidx71.8 = getelementptr inbounds i16, ptr %5, i32 %inc77.7
  %70 = load i16, ptr %arrayidx71.8, align 2, !tbaa !18
  %conv72.8 = sext i16 %70 to i32
  ...
  %arrayidx68.9 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.9
  %71 = load i16, ptr %arrayidx68.9, align 2, !tbaa !18
  %conv69.9 = sext i16 %71 to i32
  %arrayidx71.9 = getelementptr inbounds i16, ptr %5, i32 %inc77.8
  %72 = load i16, ptr %arrayidx71.9, align 2, !tbaa !18
  %conv72.9 = sext i16 %72 to i32
  ...
  %arrayidx68.10 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.10
  %73 = load i16, ptr %arrayidx68.10, align 2, !tbaa !18
  %conv69.10 = sext i16 %73 to i32
  %arrayidx71.10 = getelementptr inbounds i16, ptr %5, i32 %inc77.9
  %74 = load i16, ptr %arrayidx71.10, align 2, !tbaa !18
  %conv72.10 = sext i16 %74 to i32
  ...
  %arrayidx68.11 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.11
  %75 = load i16, ptr %arrayidx68.11, align 2, !tbaa !18
  %conv69.11 = sext i16 %75 to i32
  %arrayidx71.11 = getelementptr inbounds i16, ptr %5, i32 %inc77.10
  %76 = load i16, ptr %arrayidx71.11, align 2, !tbaa !18
  %conv72.11 = sext i16 %76 to i32
  ...
  %arrayidx68.12 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.12
  %77 = load i16, ptr %arrayidx68.12, align 2, !tbaa !18
  %conv69.12 = sext i16 %77 to i32
  %arrayidx71.12 = getelementptr inbounds i16, ptr %5, i32 %inc77.11
  %78 = load i16, ptr %arrayidx71.12, align 2, !tbaa !18
  %conv72.12 = sext i16 %78 to i32
  ...
  %arrayidx68.13 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.13
  %79 = load i16, ptr %arrayidx68.13, align 2, !tbaa !18
  %conv69.13 = sext i16 %79 to i32
  %arrayidx71.13 = getelementptr inbounds i16, ptr %5, i32 %inc77.12
  %80 = load i16, ptr %arrayidx71.13, align 2, !tbaa !18
  %conv72.13 = sext i16 %80 to i32
  ...
  %arrayidx68.14 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.14
  %81 = load i16, ptr %arrayidx68.14, align 2, !tbaa !18
  %conv69.14 = sext i16 %81 to i32
  %arrayidx71.14 = getelementptr inbounds i16, ptr %5, i32 %inc77.13
  %82 = load i16, ptr %arrayidx71.14, align 2, !tbaa !18
  %conv72.14 = sext i16 %82 to i32
  ...
  %arrayidx68.15 = getelementptr inbounds i16, ptr %0, i32 %idxprom67.15
  %83 = load i16, ptr %arrayidx68.15, align 2, !tbaa !18
  %conv69.15 = sext i16 %83 to i32
  %arrayidx71.15 = getelementptr inbounds i16, ptr %5, i32 %inc77.14
  %84 = load i16, ptr %arrayidx71.15, align 2, !tbaa !18
  %conv72.15 = sext i16 %84 to i32
...
for.body64.clone:                                 ; preds = %for.body64.clone, %for.cond398.preheader
  %n57.0151.clone = phi i32 [ %52, %for.cond398.preheader ], [ %inc77.clone, %for.body64.clone ]
  %coeff_pos.1150.clone = phi i16 [ %51, %for.cond398.preheader ], [ %dec66.clone, %for.body64.clone ]
  %acc.1149.clone = phi i64 [ %50, %for.cond398.preheader ], [ %add75.clone, %for.body64.clone ]
  ...
  %85 = load i16, ptr %arrayidx68.clone, align 2, !tbaa !18
  %conv69.clone = sext i16 %85 to i32
  %arrayidx71.clone = getelementptr inbounds i16, ptr %5, i32 %n57.0151.clone
  %86 = load i16, ptr %arrayidx71.clone, align 2, !tbaa !18
  %conv72.clone = sext i16 %86 to i32
...
for.cond.cleanup63:                               ; preds = %for.cond398.preheader, %for.body64.clone
  %acc.3.lcssa = phi i64 [ %50, %for.cond398.preheader ], [ %add75.clone, %for.body64.clone ]
  ...
  %87 = getelementptr inbounds i16, ptr %output, i32 %i.0156
  store i16 %conv91, ptr %87, align 2
