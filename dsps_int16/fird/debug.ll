...
for.body46.clone:                                 ; No predecessors!
  ...
  %arrayidx48.clone = getelementptr inbounds i16, ptr %7, i32 %idxprom47.clone
  %14 = load i16, ptr %arrayidx48.clone, align 2, !tbaa !18
  %conv49.clone = sext i16 %14 to i32
  %arrayidx51.clone = getelementptr inbounds i16, ptr %4, i32 %n.0144.clone
  %15 = load i16, ptr %arrayidx51.clone, align 2, !tbaa !18
  %conv52.clone = sext i16 %15 to i32
...
for.cond.cleanup63:                               ; preds = %for.body64.clone, %for.body64.15, %for.cond58.preheader
  ...
  %48 = getelementptr inbounds i16, ptr %output, i32 %i.0156
  store i16 %conv91, ptr %48, align 2
...
for.body64.clone:                                 ; No predecessors!
  ...
  %acc.1149.clone = phi i64 [ %acc.0.lcssa, %for.body64.lr.ph ], [ %add75.15, %for.body64.15 ]
  %dec66.clone = add i16 %coeff_pos.1150.clone, -1
  %idxprom67.clone = sext i16 %coeff_pos.1150.clone to i32
  %arrayidx68.clone = getelementptr inbounds i16, ptr %13, i32 %idxprom67.clone
  %49 = load i16, ptr %arrayidx68.clone, align 2, !tbaa !18
  %conv69.clone = sext i16 %49 to i32
  %arrayidx71.clone = getelementptr inbounds i16, ptr %4, i32 %n57.0151.clone
  %50 = load i16, ptr %arrayidx71.clone, align 2, !tbaa !18
  %conv72.clone = sext i16 %50 to i32
  ...
  br i1 %exitcond159.not.clone, label %for.cond.cleanup63, label %for.body64.15, !llvm.loop !23
