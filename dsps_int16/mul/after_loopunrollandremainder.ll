; ModuleID = 'dsps_mul_s16_ansi.ll'
source_filename = "dsps_mul_s16_ansi.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define dso_local noundef i32 @dsps_mul_s16_ansi(ptr noalias noundef readonly %input1, ptr noalias noundef readonly %input2, ptr noalias noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out, i32 noundef %shift) local_unnamed_addr #0 {
entry:
...
for.body.15:                                      ; preds = %for.body.15, %for.cond.preheader
  ...
  store i16 %conv12, ptr %arrayidx14, align 2, !tbaa !4
  ...
  %arrayidx14.1 = getelementptr inbounds i16, ptr %output, i32 %mul13.1
  store i16 %conv12.1, ptr %arrayidx14.1, align 2, !tbaa !4
  ...
  %arrayidx14.2 = getelementptr inbounds i16, ptr %output, i32 %mul13.2
  store i16 %conv12.2, ptr %arrayidx14.2, align 2, !tbaa !4
  ...
  %arrayidx14.3 = getelementptr inbounds i16, ptr %output, i32 %mul13.3
  store i16 %conv12.3, ptr %arrayidx14.3, align 2, !tbaa !4
  ...
  %arrayidx14.4 = getelementptr inbounds i16, ptr %output, i32 %mul13.4
  store i16 %conv12.4, ptr %arrayidx14.4, align 2, !tbaa !4
  ...
  %arrayidx14.5 = getelementptr inbounds i16, ptr %output, i32 %mul13.5
  store i16 %conv12.5, ptr %arrayidx14.5, align 2, !tbaa !4
  ...
  %arrayidx14.6 = getelementptr inbounds i16, ptr %output, i32 %mul13.6
  store i16 %conv12.6, ptr %arrayidx14.6, align 2, !tbaa !4
  ...
  %arrayidx14.7 = getelementptr inbounds i16, ptr %output, i32 %mul13.7
  store i16 %conv12.7, ptr %arrayidx14.7, align 2, !tbaa !4
  ...
  %arrayidx14.8 = getelementptr inbounds i16, ptr %output, i32 %mul13.8
  store i16 %conv12.8, ptr %arrayidx14.8, align 2, !tbaa !4
  ...
  %arrayidx14.9 = getelementptr inbounds i16, ptr %output, i32 %mul13.9
  store i16 %conv12.9, ptr %arrayidx14.9, align 2, !tbaa !4
  ...
  %arrayidx14.10 = getelementptr inbounds i16, ptr %output, i32 %mul13.10
  store i16 %conv12.10, ptr %arrayidx14.10, align 2, !tbaa !4
  ...
  %arrayidx14.11 = getelementptr inbounds i16, ptr %output, i32 %mul13.11
  store i16 %conv12.11, ptr %arrayidx14.11, align 2, !tbaa !4
  ...
  %arrayidx14.12 = getelementptr inbounds i16, ptr %output, i32 %mul13.12
  store i16 %conv12.12, ptr %arrayidx14.12, align 2, !tbaa !4
  ...
  %arrayidx14.13 = getelementptr inbounds i16, ptr %output, i32 %mul13.13
  store i16 %conv12.13, ptr %arrayidx14.13, align 2, !tbaa !4
  ...
  %arrayidx14.14 = getelementptr inbounds i16, ptr %output, i32 %mul13.14
  store i16 %conv12.14, ptr %arrayidx14.14, align 2, !tbaa !4
  ...
  %arrayidx14.15 = getelementptr inbounds i16, ptr %output, i32 %mul13.15
  store i16 %conv12.15, ptr %arrayidx14.15, align 2, !tbaa !4
...
for.body.clone:                                   ; preds = %for.body.clone, %for.body.preheader
  ...
  %conv12.clone = trunc i32 %shr.clone to i16
  %mul13.clone = mul nsw i32 %i.024.clone, %step_out
  %arrayidx14.clone = getelementptr inbounds i16, ptr %output, i32 %mul13.clone
  store i16 %conv12.clone, ptr %arrayidx14.clone, align 2, !tbaa !4
