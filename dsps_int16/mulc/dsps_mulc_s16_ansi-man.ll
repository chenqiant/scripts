; ModuleID = 'dsps_mulc_s16_ansi.c'
source_filename = "dsps_mulc_s16_ansi.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define dso_local noundef i32 @dsps_mulc_s16_ansi(ptr noundef readonly %input, ptr noundef writeonly %output, i32 noundef %len, i16 noundef signext %C, i32 noundef %step_in, i32 noundef %step_out) local_unnamed_addr #0 {
entry:
...
for.cond.preheader:                               ; preds = %entry
  ...
  br i1 %cmp415, label %for.body, label %return
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %i.016 = phi i32 [ 0, %for.cond.preheader ], [ %inc, %for.body ]
