...
llc --mcpu=esp32p4 --mtriple=riscv32 dsps_mulc_s16_ansi.ll -O3 -filetype=asm -o dsps_mulc_s16_ansi.s

../preprocess_asm.sh dsps_mulc_s16_ansi.s

cp dsps_mulc_s16_ansi.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/math/mulc/fixed/dsps_mulc_s16_arp4.S
