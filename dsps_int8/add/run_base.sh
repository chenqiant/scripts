...
llc --mcpu=esp32p4 --mtriple=riscv32  dsps_add_s8_ansi.ll -O3 -filetype=asm -o dsps_add_s8_ansi.s

../preprocess_asm.sh dsps_add_s8_ansi.s
cp dsps_add_s8_ansi.s /home/chenqian/esp/esp-idf/components/esp-dsp/modules/math/add/fixed/dsps_add_s8_arp4.S
