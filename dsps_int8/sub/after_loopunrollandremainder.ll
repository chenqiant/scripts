; ModuleID = 'dsps_sub_s8_ansi.ll'
source_filename = "dsps_sub_s8_ansi.c"
target datalayout = "e-m:e-p:32:32-i64:64-n32-S128"
target triple = "riscv32-esp-unknown-elf"

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite)
define dso_local noundef i32 @dsps_sub_s8_ansi(ptr noalias noundef readonly %input1, ptr noalias noundef readonly %input2, ptr noalias noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out, i32 noundef %shift) local_unnamed_addr #0 {
entry:
...
for.body.15:                                      ; preds = %for.body.15, %for.cond.preheader
  ...
  store i8 %conv11, ptr %arrayidx13, align 1, !tbaa !4
  ...
  %conv11.1 = trunc i32 %shr.1 to i8
  %mul12.1 = mul nsw i32 %add, %step_out
  %arrayidx13.1 = getelementptr inbounds i8, ptr %output, i32 %mul12.1
  store i8 %conv11.1, ptr %arrayidx13.1, align 1, !tbaa !4
  ...
  %conv11.2 = trunc i32 %shr.2 to i8
  %mul12.2 = mul nsw i32 %add2, %step_out
  %arrayidx13.2 = getelementptr inbounds i8, ptr %output, i32 %mul12.2
  store i8 %conv11.2, ptr %arrayidx13.2, align 1, !tbaa !4
  ...
  %conv11.3 = trunc i32 %shr.3 to i8
  %mul12.3 = mul nsw i32 %add4, %step_out
  %arrayidx13.3 = getelementptr inbounds i8, ptr %output, i32 %mul12.3
  store i8 %conv11.3, ptr %arrayidx13.3, align 1, !tbaa !4
  ...
  %conv11.4 = trunc i32 %shr.4 to i8
  %mul12.4 = mul nsw i32 %add6, %step_out
  %arrayidx13.4 = getelementptr inbounds i8, ptr %output, i32 %mul12.4
  store i8 %conv11.4, ptr %arrayidx13.4, align 1, !tbaa !4
  ...
  %conv11.5 = trunc i32 %shr.5 to i8
  %mul12.5 = mul nsw i32 %add8, %step_out
  %arrayidx13.5 = getelementptr inbounds i8, ptr %output, i32 %mul12.5
  store i8 %conv11.5, ptr %arrayidx13.5, align 1, !tbaa !4
  ...
  %conv11.6 = trunc i32 %shr.6 to i8
  %mul12.6 = mul nsw i32 %add10, %step_out
  %arrayidx13.6 = getelementptr inbounds i8, ptr %output, i32 %mul12.6
  store i8 %conv11.6, ptr %arrayidx13.6, align 1, !tbaa !4
  ...
  %conv11.7 = trunc i32 %shr.7 to i8
  %mul12.7 = mul nsw i32 %add12, %step_out
  %arrayidx13.7 = getelementptr inbounds i8, ptr %output, i32 %mul12.7
  store i8 %conv11.7, ptr %arrayidx13.7, align 1, !tbaa !4
  ...
  %conv11.8 = trunc i32 %shr.8 to i8
  %mul12.8 = mul nsw i32 %add14, %step_out
  %arrayidx13.8 = getelementptr inbounds i8, ptr %output, i32 %mul12.8
  store i8 %conv11.8, ptr %arrayidx13.8, align 1, !tbaa !4
  ...
  %conv11.9 = trunc i32 %shr.9 to i8
  %mul12.9 = mul nsw i32 %add16, %step_out
  %arrayidx13.9 = getelementptr inbounds i8, ptr %output, i32 %mul12.9
  store i8 %conv11.9, ptr %arrayidx13.9, align 1, !tbaa !4
  ...
  %conv11.10 = trunc i32 %shr.10 to i8
  %mul12.10 = mul nsw i32 %add18, %step_out
  %arrayidx13.10 = getelementptr inbounds i8, ptr %output, i32 %mul12.10
  store i8 %conv11.10, ptr %arrayidx13.10, align 1, !tbaa !4
  ...
  %conv11.11 = trunc i32 %shr.11 to i8
  %mul12.11 = mul nsw i32 %add20, %step_out
  %arrayidx13.11 = getelementptr inbounds i8, ptr %output, i32 %mul12.11
  store i8 %conv11.11, ptr %arrayidx13.11, align 1, !tbaa !4
  ...
  %conv11.12 = trunc i32 %shr.12 to i8
  %mul12.12 = mul nsw i32 %add22, %step_out
  %arrayidx13.12 = getelementptr inbounds i8, ptr %output, i32 %mul12.12
  store i8 %conv11.12, ptr %arrayidx13.12, align 1, !tbaa !4
  ...
  %conv11.13 = trunc i32 %shr.13 to i8
  %mul12.13 = mul nsw i32 %add24, %step_out
  %arrayidx13.13 = getelementptr inbounds i8, ptr %output, i32 %mul12.13
  store i8 %conv11.13, ptr %arrayidx13.13, align 1, !tbaa !4
  ...
  %conv11.14 = trunc i32 %shr.14 to i8
  %mul12.14 = mul nsw i32 %add26, %step_out
  %arrayidx13.14 = getelementptr inbounds i8, ptr %output, i32 %mul12.14
  store i8 %conv11.14, ptr %arrayidx13.14, align 1, !tbaa !4
  ...
  %conv11.15 = trunc i32 %shr.15 to i8
  %mul12.15 = mul nsw i32 %add28, %step_out
  %arrayidx13.15 = getelementptr inbounds i8, ptr %output, i32 %mul12.15
  store i8 %conv11.15, ptr %arrayidx13.15, align 1, !tbaa !4
...
for.body.clone:                                   ; preds = %for.body.clone, %for.body.preheader
  ...
  %conv11.clone = trunc i32 %shr.clone to i8
  %mul12.clone = mul nsw i32 %i.023.clone, %step_out
  %arrayidx13.clone = getelementptr inbounds i8, ptr %output, i32 %mul12.clone
  store i8 %conv11.clone, ptr %arrayidx13.clone, align 1, !tbaa !4
