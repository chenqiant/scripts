...
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[TMP33:%.*]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
; CHECK-NEXT:    [[CMP85209:%.*]] = icmp slt i32 [[TMP0]], [[LEN]]
; CHECK-NEXT:    br i1 [[CMP85209]], label [[FOR_BODY:%.*]], label [[RETURN]]
; CHECK:       for.body.modify:
; CHECK-NEXT:    [[I_021_MODIFY:%.*]] = phi i32 [ [[TMP33]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
...
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX19]], align 4
; CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX20]], align 4
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX24]], align 4
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX25]], align 4
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX29]], align 4
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX30]], align 4
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX34]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX35]], align 4
; CHECK-NEXT:    [[TMP17:%.*]] = load float, ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    [[TMP18:%.*]] = load float, ptr [[ARRAYIDX40]], align 4
; CHECK-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX44]], align 4
; CHECK-NEXT:    [[TMP20:%.*]] = load float, ptr [[ARRAYIDX45]], align 4
; CHECK-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX49]], align 4
; CHECK-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX50]], align 4
; CHECK-NEXT:    [[TMP23:%.*]] = load float, ptr [[ARRAYIDX54]], align 4
; CHECK-NEXT:    [[TMP24:%.*]] = load float, ptr [[ARRAYIDX55]], align 4
; CHECK-NEXT:    [[TMP25:%.*]] = load float, ptr [[ARRAYIDX59]], align 4
; CHECK-NEXT:    [[TMP26:%.*]] = load float, ptr [[ARRAYIDX60]], align 4
; CHECK-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX64]], align 4
; CHECK-NEXT:    [[TMP28:%.*]] = load float, ptr [[ARRAYIDX65]], align 4
; CHECK-NEXT:    [[TMP29:%.*]] = load float, ptr [[ARRAYIDX69]], align 4
; CHECK-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX70]], align 4
; CHECK-NEXT:    [[TMP31:%.*]] = load float, ptr [[ARRAYIDX74]], align 4
; CHECK-NEXT:    [[TMP32:%.*]] = load float, ptr [[ARRAYIDX75]], align 4
; CHECK-NEXT:    [[ADD_MODIFY:%.*]] = fadd float [[TMP1]], [[TMP2]]
; CHECK-NEXT:    [[ADD5:%.*]] = fadd float [[TMP3]], [[TMP4]]
; CHECK-NEXT:    [[ADD11:%.*]] = fadd float [[TMP5]], [[TMP6]]
; CHECK-NEXT:    [[ADD16:%.*]] = fadd float [[TMP7]], [[TMP8]]
; CHECK-NEXT:    [[ADD21:%.*]] = fadd float [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[ADD26:%.*]] = fadd float [[TMP11]], [[TMP12]]
; CHECK-NEXT:    [[ADD31:%.*]] = fadd float [[TMP13]], [[TMP14]]
; CHECK-NEXT:    [[ADD36:%.*]] = fadd float [[TMP15]], [[TMP16]]
; CHECK-NEXT:    [[ADD41:%.*]] = fadd float [[TMP17]], [[TMP18]]
; CHECK-NEXT:    [[ADD46:%.*]] = fadd float [[TMP19]], [[TMP20]]
; CHECK-NEXT:    [[ADD51:%.*]] = fadd float [[TMP21]], [[TMP22]]
; CHECK-NEXT:    [[ADD56:%.*]] = fadd float [[TMP23]], [[TMP24]]
; CHECK-NEXT:    [[ADD61:%.*]] = fadd float [[TMP25]], [[TMP26]]
; CHECK-NEXT:    [[ADD66:%.*]] = fadd float [[TMP27]], [[TMP28]]
; CHECK-NEXT:    [[ADD71:%.*]] = fadd float [[TMP29]], [[TMP30]]
; CHECK-NEXT:    [[ADD76:%.*]] = fadd float [[TMP31]], [[TMP32]]
...
; CHECK-NEXT:    [[TMP33]] = add nuw i32 [[I_021_MODIFY]], 16
; CHECK-NEXT:    [[EXITCOND_NOT_MODIFY:%.*]] = icmp sgt i32 [[TMP33]], [[SUB]]
