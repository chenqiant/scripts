...
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[TMP17:%.*]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
; CHECK-NEXT:    [[CMP85209:%.*]] = icmp slt i32 [[TMP0]], [[LEN]]
; CHECK-NEXT:    br i1 [[CMP85209]], label [[FOR_BODY:%.*]], label [[RETURN]]
; CHECK:       for.body.modify:
; CHECK-NEXT:    [[I_013_MODIFY:%.*]] = phi i32 [ [[TMP17]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
...
; CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[ARRAYIDX7]], align 4
...
; CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[ARRAYIDX23]], align 4
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX27]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX31]], align 4
; CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX35]], align 4
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX43]], align 4
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX47]], align 4
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX51]], align 4
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX55]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX59]], align 4
; CHECK-NEXT:    [[ADD_MODIFY:%.*]] = fadd float [[TMP1]], [[C]]
; CHECK-NEXT:    [[ADD4:%.*]] = fadd float [[TMP2]], [[C]]
; CHECK-NEXT:    [[ADD8:%.*]] = fadd float [[TMP3]], [[C]]
; CHECK-NEXT:    [[ADD12:%.*]] = fadd float [[TMP4]], [[C]]
; CHECK-NEXT:    [[ADD16:%.*]] = fadd float [[TMP5]], [[C]]
; CHECK-NEXT:    [[ADD20:%.*]] = fadd float [[TMP6]], [[C]]
; CHECK-NEXT:    [[ADD24:%.*]] = fadd float [[TMP7]], [[C]]
; CHECK-NEXT:    [[ADD28:%.*]] = fadd float [[TMP8]], [[C]]
; CHECK-NEXT:    [[ADD32:%.*]] = fadd float [[TMP9]], [[C]]
; CHECK-NEXT:    [[ADD36:%.*]] = fadd float [[TMP10]], [[C]]
; CHECK-NEXT:    [[ADD40:%.*]] = fadd float [[TMP11]], [[C]]
; CHECK-NEXT:    [[ADD44:%.*]] = fadd float [[TMP12]], [[C]]
; CHECK-NEXT:    [[ADD48:%.*]] = fadd float [[TMP13]], [[C]]
; CHECK-NEXT:    [[ADD52:%.*]] = fadd float [[TMP14]], [[C]]
; CHECK-NEXT:    [[ADD56:%.*]] = fadd float [[TMP15]], [[C]]
; CHECK-NEXT:    [[ADD60:%.*]] = fadd float [[TMP16]], [[C]]
...
; CHECK-NEXT:    [[TMP17]] = add nuw i32 [[I_013_MODIFY]], 16
; CHECK-NEXT:    [[EXITCOND_NOT_MODIFY:%.*]] = icmp sgt i32 [[TMP17]], [[SUB]]
...
; CHECK-NEXT:    [[ADD:%.*]] = fadd float [[TMP18]], [[C]]
...
; CHECK-NEXT:    [[ADD_CLONE:%.*]] = fadd float [[TMP19]], [[C]]
