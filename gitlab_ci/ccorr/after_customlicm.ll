...
; CHECK-NEXT:    [[TMP0:%.*]] = and i32 [[N_0125]], 2147483640
; CHECK-NEXT:    [[TMP1:%.*]] = add nsw i32 [[TMP0]], -1
; CHECK-NEXT:    [[TMP2:%.*]] = and i32 [[TMP1]], -8
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[TMP2]], 8
; CHECK-NEXT:    [[TMP4:%.*]] = and i32 [[N_0125]], 2147483640
; CHECK-NEXT:    [[TMP5:%.*]] = icmp eq i32 [[TMP4]], 0
; CHECK-NEXT:    [[TMP6:%.*]] = xor i32 [[N_0125]], -1
; CHECK-NEXT:    [[SUB11:%.*]] = add nsw i32 [[LKERN_0]], [[TMP6]]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[CORRVOUT]], i32 [[N_0125]]
; CHECK-NEXT:    br i1 [[TMP5]], label [[FOR_BODY14_CLONE_PREHEADER:%.*]], label [[FOR_BODY14_7:%.*]]
; CHECK:       for.body14.7:
; CHECK-NEXT:    [[K_0123:%.*]] = phi i32 [ 0, [[FOR_BODY]] ], [ [[INC_7:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP9:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI1:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP12:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI2:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP15:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI3:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP18:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI4:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP21:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI5:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP24:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI6:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP27:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[DOTPHI7:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP30:%.*]], [[FOR_BODY14_7]] ]
; CHECK-NEXT:    [[ARRAYIDX15:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K_0123]]
; CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[ARRAYIDX15]], align 4
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[SUB11]], [[K_0123]]
; CHECK-NEXT:    [[ARRAYIDX16:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD]]
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX16]], align 4
; CHECK-NEXT:    [[TMP9]] = tail call float @llvm.fmuladd.f32(float [[TMP7]], float [[TMP8]], float [[DOTPHI]])
; CHECK-NEXT:    [[ADD9:%.*]] = or disjoint i32 [[K_0123]], 1
; CHECK-NEXT:    [[ARRAYIDX15_1:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD9]]
; CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX15_1]], align 4
; CHECK-NEXT:    [[ADD_1:%.*]] = add i32 [[SUB11]], [[ADD9]]
; CHECK-NEXT:    [[ARRAYIDX16_1:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_1]]
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX16_1]], align 4
; CHECK-NEXT:    [[TMP12]] = tail call float @llvm.fmuladd.f32(float [[TMP10]], float [[TMP11]], float [[DOTPHI1]])
; CHECK-NEXT:    [[ADD11:%.*]] = or disjoint i32 [[K_0123]], 2
; CHECK-NEXT:    [[ARRAYIDX15_2:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD11]]
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX15_2]], align 4
; CHECK-NEXT:    [[ADD_2:%.*]] = add i32 [[SUB11]], [[ADD11]]
; CHECK-NEXT:    [[ARRAYIDX16_2:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_2]]
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX16_2]], align 4
; CHECK-NEXT:    [[TMP15]] = tail call float @llvm.fmuladd.f32(float [[TMP13]], float [[TMP14]], float [[DOTPHI2]])
; CHECK-NEXT:    [[ADD13:%.*]] = or disjoint i32 [[K_0123]], 3
; CHECK-NEXT:    [[ARRAYIDX15_3:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD13]]
; CHECK-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX15_3]], align 4
; CHECK-NEXT:    [[ADD_3:%.*]] = add i32 [[SUB11]], [[ADD13]]
; CHECK-NEXT:    [[ARRAYIDX16_3:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_3]]
; CHECK-NEXT:    [[TMP17:%.*]] = load float, ptr [[ARRAYIDX16_3]], align 4
; CHECK-NEXT:    [[TMP18]] = tail call float @llvm.fmuladd.f32(float [[TMP16]], float [[TMP17]], float [[DOTPHI3]])
; CHECK-NEXT:    [[ADD15:%.*]] = or disjoint i32 [[K_0123]], 4
; CHECK-NEXT:    [[ARRAYIDX15_4:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD15]]
; CHECK-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX15_4]], align 4
; CHECK-NEXT:    [[ADD_4:%.*]] = add i32 [[SUB11]], [[ADD15]]
; CHECK-NEXT:    [[ARRAYIDX16_4:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_4]]
; CHECK-NEXT:    [[TMP20:%.*]] = load float, ptr [[ARRAYIDX16_4]], align 4
; CHECK-NEXT:    [[TMP21]] = tail call float @llvm.fmuladd.f32(float [[TMP19]], float [[TMP20]], float [[DOTPHI4]])
; CHECK-NEXT:    [[ADD17:%.*]] = or disjoint i32 [[K_0123]], 5
; CHECK-NEXT:    [[ARRAYIDX15_5:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD17]]
; CHECK-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX15_5]], align 4
; CHECK-NEXT:    [[ADD_5:%.*]] = add i32 [[SUB11]], [[ADD17]]
; CHECK-NEXT:    [[ARRAYIDX16_5:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_5]]
; CHECK-NEXT:    [[TMP23:%.*]] = load float, ptr [[ARRAYIDX16_5]], align 4
; CHECK-NEXT:    [[TMP24]] = tail call float @llvm.fmuladd.f32(float [[TMP22]], float [[TMP23]], float [[DOTPHI5]])
; CHECK-NEXT:    [[ADD19:%.*]] = or disjoint i32 [[K_0123]], 6
; CHECK-NEXT:    [[ARRAYIDX15_6:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD19]]
; CHECK-NEXT:    [[TMP25:%.*]] = load float, ptr [[ARRAYIDX15_6]], align 4
; CHECK-NEXT:    [[ADD_6:%.*]] = add i32 [[SUB11]], [[ADD19]]
; CHECK-NEXT:    [[ARRAYIDX16_6:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_6]]
; CHECK-NEXT:    [[TMP26:%.*]] = load float, ptr [[ARRAYIDX16_6]], align 4
; CHECK-NEXT:    [[TMP27]] = tail call float @llvm.fmuladd.f32(float [[TMP25]], float [[TMP26]], float [[DOTPHI6]])
; CHECK-NEXT:    [[ADD21:%.*]] = or disjoint i32 [[K_0123]], 7
; CHECK-NEXT:    [[ARRAYIDX15_7:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD21]]
; CHECK-NEXT:    [[TMP28:%.*]] = load float, ptr [[ARRAYIDX15_7]], align 4
; CHECK-NEXT:    [[ADD_7:%.*]] = add i32 [[SUB11]], [[ADD21]]
; CHECK-NEXT:    [[ARRAYIDX16_7:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_7]]
; CHECK-NEXT:    [[TMP29:%.*]] = load float, ptr [[ARRAYIDX16_7]], align 4
; CHECK-NEXT:    [[TMP30]] = tail call float @llvm.fmuladd.f32(float [[TMP28]], float [[TMP29]], float [[DOTPHI7]])
; CHECK-NEXT:    [[INC_7]] = add nuw nsw i32 [[K_0123]], 8
; CHECK-NEXT:    [[EXITCOND_7:%.*]] = icmp ult i32 [[INC_7]], [[TMP4]]
; CHECK-NEXT:    br i1 [[EXITCOND_7]], label [[FOR_BODY14_7]], label [[FOR_END22:%.*]]
; CHECK:       for.end22:
; CHECK-NEXT:    [[SUM:%.*]] = fadd float [[TMP9]], [[TMP12]]
; CHECK-NEXT:    [[SUM23:%.*]] = fadd float [[SUM]], [[TMP15]]
; CHECK-NEXT:    [[SUM24:%.*]] = fadd float [[SUM23]], [[TMP18]]
; CHECK-NEXT:    [[SUM25:%.*]] = fadd float [[SUM24]], [[TMP21]]
; CHECK-NEXT:    [[SUM26:%.*]] = fadd float [[SUM25]], [[TMP24]]
; CHECK-NEXT:    [[SUM27:%.*]] = fadd float [[SUM26]], [[TMP27]]
; CHECK-NEXT:    [[SUM28:%.*]] = fadd float [[SUM27]], [[TMP30]]
; CHECK-NEXT:    store float [[SUM28]], ptr [[ARRAYIDX]], align 4
; CHECK-NEXT:    [[CMP37_NOT548:%.*]] = icmp ugt i32 [[TMP3]], [[N_0125]]
; CHECK-NEXT:    br i1 [[CMP37_NOT548]], label [[FOR_END]], label [[FOR_BODY14_CLONE_PREHEADER]]
; CHECK:       for.body14.clone.preheader:
; CHECK-NEXT:    [[SUM_PHI:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[SUM28]], [[FOR_END22]] ]
; CHECK-NEXT:    [[ADD_PHI:%.*]] = phi i32 [ 0, [[FOR_BODY]] ], [ [[TMP3]], [[FOR_END22]] ]
...
; CHECK-NEXT:    [[TMP31:%.*]] = phi float [ [[SUM_PHI]], [[FOR_BODY14_CLONE_PREHEADER]] ], [ [[TMP34:%.*]], [[FOR_BODY14_CLONE]] ]
; CHECK-NEXT:    [[ARRAYIDX15_CLONE:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K_0123_CLONE]]
; CHECK-NEXT:    [[TMP32:%.*]] = load float, ptr [[ARRAYIDX15_CLONE]], align 4
; CHECK-NEXT:    [[ADD_CLONE:%.*]] = add i32 [[SUB11]], [[K_0123_CLONE]]
; CHECK-NEXT:    [[ARRAYIDX16_CLONE:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[ADD_CLONE]]
; CHECK-NEXT:    [[TMP33:%.*]] = load float, ptr [[ARRAYIDX16_CLONE]], align 4
...
; CHECK-NEXT:    [[ADD60:%.*]] = add i32 [[DIV536]], [[ADD30]]
...
; CHECK-NEXT:    [[DOTPHI29:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP37:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI30:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP40:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI31:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP43:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI32:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP46:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI33:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP49:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI34:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP52:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI35:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP55:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI36:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP58:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI37:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP61:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI38:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP64:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI39:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP67:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI40:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP70:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI41:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP73:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI42:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP76:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI43:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP79:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[DOTPHI44:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY33_PREHEADER]] ], [ [[TMP82:%.*]], [[FOR_BODY33_15]] ]
; CHECK-NEXT:    [[ARRAYIDX34:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K27_0127]]
; CHECK-NEXT:    [[TMP35:%.*]] = load float, ptr [[ARRAYIDX34]], align 4
; CHECK-NEXT:    [[SUB35:%.*]] = sub i32 [[K27_0127]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35]]
; CHECK-NEXT:    [[TMP36:%.*]] = load float, ptr [[ARRAYIDX36]], align 4
; CHECK-NEXT:    [[TMP37]] = tail call float @llvm.fmuladd.f32(float [[TMP35]], float [[TMP36]], float [[DOTPHI29]])
; CHECK-NEXT:    [[INC39:%.*]] = add i32 [[K27_0127]], 1
; CHECK-NEXT:    [[ARRAYIDX34_1:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39]]
; CHECK-NEXT:    [[TMP38:%.*]] = load float, ptr [[ARRAYIDX34_1]], align 4
; CHECK-NEXT:    [[SUB35_1:%.*]] = sub i32 [[INC39]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_1:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_1]]
; CHECK-NEXT:    [[TMP39:%.*]] = load float, ptr [[ARRAYIDX36_1]], align 4
; CHECK-NEXT:    [[TMP40]] = tail call float @llvm.fmuladd.f32(float [[TMP38]], float [[TMP39]], float [[DOTPHI30]])
; CHECK-NEXT:    [[INC39_1:%.*]] = add i32 [[K27_0127]], 2
; CHECK-NEXT:    [[ARRAYIDX34_2:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_1]]
; CHECK-NEXT:    [[TMP41:%.*]] = load float, ptr [[ARRAYIDX34_2]], align 4
; CHECK-NEXT:    [[SUB35_2:%.*]] = sub i32 [[INC39_1]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_2:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_2]]
; CHECK-NEXT:    [[TMP42:%.*]] = load float, ptr [[ARRAYIDX36_2]], align 4
; CHECK-NEXT:    [[TMP43]] = tail call float @llvm.fmuladd.f32(float [[TMP41]], float [[TMP42]], float [[DOTPHI31]])
; CHECK-NEXT:    [[INC39_2:%.*]] = add i32 [[K27_0127]], 3
; CHECK-NEXT:    [[ARRAYIDX34_3:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_2]]
; CHECK-NEXT:    [[TMP44:%.*]] = load float, ptr [[ARRAYIDX34_3]], align 4
; CHECK-NEXT:    [[SUB35_3:%.*]] = sub i32 [[INC39_2]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_3:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_3]]
; CHECK-NEXT:    [[TMP45:%.*]] = load float, ptr [[ARRAYIDX36_3]], align 4
; CHECK-NEXT:    [[TMP46]] = tail call float @llvm.fmuladd.f32(float [[TMP44]], float [[TMP45]], float [[DOTPHI32]])
; CHECK-NEXT:    [[INC39_3:%.*]] = add i32 [[K27_0127]], 4
; CHECK-NEXT:    [[ARRAYIDX34_4:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_3]]
; CHECK-NEXT:    [[TMP47:%.*]] = load float, ptr [[ARRAYIDX34_4]], align 4
; CHECK-NEXT:    [[SUB35_4:%.*]] = sub i32 [[INC39_3]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_4:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_4]]
; CHECK-NEXT:    [[TMP48:%.*]] = load float, ptr [[ARRAYIDX36_4]], align 4
; CHECK-NEXT:    [[TMP49]] = tail call float @llvm.fmuladd.f32(float [[TMP47]], float [[TMP48]], float [[DOTPHI33]])
; CHECK-NEXT:    [[INC39_4:%.*]] = add i32 [[K27_0127]], 5
; CHECK-NEXT:    [[ARRAYIDX34_5:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_4]]
; CHECK-NEXT:    [[TMP50:%.*]] = load float, ptr [[ARRAYIDX34_5]], align 4
; CHECK-NEXT:    [[SUB35_5:%.*]] = sub i32 [[INC39_4]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_5:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_5]]
; CHECK-NEXT:    [[TMP51:%.*]] = load float, ptr [[ARRAYIDX36_5]], align 4
; CHECK-NEXT:    [[TMP52]] = tail call float @llvm.fmuladd.f32(float [[TMP50]], float [[TMP51]], float [[DOTPHI34]])
; CHECK-NEXT:    [[INC39_5:%.*]] = add i32 [[K27_0127]], 6
; CHECK-NEXT:    [[ARRAYIDX34_6:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_5]]
; CHECK-NEXT:    [[TMP53:%.*]] = load float, ptr [[ARRAYIDX34_6]], align 4
; CHECK-NEXT:    [[SUB35_6:%.*]] = sub i32 [[INC39_5]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_6:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_6]]
; CHECK-NEXT:    [[TMP54:%.*]] = load float, ptr [[ARRAYIDX36_6]], align 4
; CHECK-NEXT:    [[TMP55]] = tail call float @llvm.fmuladd.f32(float [[TMP53]], float [[TMP54]], float [[DOTPHI35]])
; CHECK-NEXT:    [[INC39_6:%.*]] = add i32 [[K27_0127]], 7
; CHECK-NEXT:    [[ARRAYIDX34_7:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_6]]
; CHECK-NEXT:    [[TMP56:%.*]] = load float, ptr [[ARRAYIDX34_7]], align 4
; CHECK-NEXT:    [[SUB35_7:%.*]] = sub i32 [[INC39_6]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_7:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_7]]
; CHECK-NEXT:    [[TMP57:%.*]] = load float, ptr [[ARRAYIDX36_7]], align 4
; CHECK-NEXT:    [[TMP58]] = tail call float @llvm.fmuladd.f32(float [[TMP56]], float [[TMP57]], float [[DOTPHI36]])
; CHECK-NEXT:    [[INC39_7:%.*]] = add i32 [[K27_0127]], 8
; CHECK-NEXT:    [[ARRAYIDX34_8:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_7]]
; CHECK-NEXT:    [[TMP59:%.*]] = load float, ptr [[ARRAYIDX34_8]], align 4
; CHECK-NEXT:    [[SUB35_8:%.*]] = sub i32 [[INC39_7]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_8:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_8]]
; CHECK-NEXT:    [[TMP60:%.*]] = load float, ptr [[ARRAYIDX36_8]], align 4
; CHECK-NEXT:    [[TMP61]] = tail call float @llvm.fmuladd.f32(float [[TMP59]], float [[TMP60]], float [[DOTPHI37]])
; CHECK-NEXT:    [[INC39_8:%.*]] = add i32 [[K27_0127]], 9
; CHECK-NEXT:    [[ARRAYIDX34_9:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_8]]
; CHECK-NEXT:    [[TMP62:%.*]] = load float, ptr [[ARRAYIDX34_9]], align 4
; CHECK-NEXT:    [[SUB35_9:%.*]] = sub i32 [[INC39_8]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_9:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_9]]
; CHECK-NEXT:    [[TMP63:%.*]] = load float, ptr [[ARRAYIDX36_9]], align 4
; CHECK-NEXT:    [[TMP64]] = tail call float @llvm.fmuladd.f32(float [[TMP62]], float [[TMP63]], float [[DOTPHI38]])
; CHECK-NEXT:    [[INC39_9:%.*]] = add i32 [[K27_0127]], 10
; CHECK-NEXT:    [[ARRAYIDX34_10:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_9]]
; CHECK-NEXT:    [[TMP65:%.*]] = load float, ptr [[ARRAYIDX34_10]], align 4
; CHECK-NEXT:    [[SUB35_10:%.*]] = sub i32 [[INC39_9]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_10:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_10]]
; CHECK-NEXT:    [[TMP66:%.*]] = load float, ptr [[ARRAYIDX36_10]], align 4
; CHECK-NEXT:    [[TMP67]] = tail call float @llvm.fmuladd.f32(float [[TMP65]], float [[TMP66]], float [[DOTPHI39]])
; CHECK-NEXT:    [[INC39_10:%.*]] = add i32 [[K27_0127]], 11
; CHECK-NEXT:    [[ARRAYIDX34_11:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_10]]
; CHECK-NEXT:    [[TMP68:%.*]] = load float, ptr [[ARRAYIDX34_11]], align 4
; CHECK-NEXT:    [[SUB35_11:%.*]] = sub i32 [[INC39_10]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_11:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_11]]
; CHECK-NEXT:    [[TMP69:%.*]] = load float, ptr [[ARRAYIDX36_11]], align 4
; CHECK-NEXT:    [[TMP70]] = tail call float @llvm.fmuladd.f32(float [[TMP68]], float [[TMP69]], float [[DOTPHI40]])
; CHECK-NEXT:    [[INC39_11:%.*]] = add i32 [[K27_0127]], 12
; CHECK-NEXT:    [[ARRAYIDX34_12:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_11]]
; CHECK-NEXT:    [[TMP71:%.*]] = load float, ptr [[ARRAYIDX34_12]], align 4
; CHECK-NEXT:    [[SUB35_12:%.*]] = sub i32 [[INC39_11]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_12:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_12]]
; CHECK-NEXT:    [[TMP72:%.*]] = load float, ptr [[ARRAYIDX36_12]], align 4
; CHECK-NEXT:    [[TMP73]] = tail call float @llvm.fmuladd.f32(float [[TMP71]], float [[TMP72]], float [[DOTPHI41]])
; CHECK-NEXT:    [[INC39_12:%.*]] = add i32 [[K27_0127]], 13
; CHECK-NEXT:    [[ARRAYIDX34_13:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_12]]
; CHECK-NEXT:    [[TMP74:%.*]] = load float, ptr [[ARRAYIDX34_13]], align 4
; CHECK-NEXT:    [[SUB35_13:%.*]] = sub i32 [[INC39_12]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_13:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_13]]
; CHECK-NEXT:    [[TMP75:%.*]] = load float, ptr [[ARRAYIDX36_13]], align 4
; CHECK-NEXT:    [[TMP76]] = tail call float @llvm.fmuladd.f32(float [[TMP74]], float [[TMP75]], float [[DOTPHI42]])
; CHECK-NEXT:    [[INC39_13:%.*]] = add i32 [[K27_0127]], 14
; CHECK-NEXT:    [[ARRAYIDX34_14:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_13]]
; CHECK-NEXT:    [[TMP77:%.*]] = load float, ptr [[ARRAYIDX34_14]], align 4
; CHECK-NEXT:    [[SUB35_14:%.*]] = sub i32 [[INC39_13]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_14:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_14]]
; CHECK-NEXT:    [[TMP78:%.*]] = load float, ptr [[ARRAYIDX36_14]], align 4
; CHECK-NEXT:    [[TMP79]] = tail call float @llvm.fmuladd.f32(float [[TMP77]], float [[TMP78]], float [[DOTPHI43]])
; CHECK-NEXT:    [[INC39_14:%.*]] = add i32 [[K27_0127]], 15
; CHECK-NEXT:    [[ARRAYIDX34_15:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC39_14]]
; CHECK-NEXT:    [[TMP80:%.*]] = load float, ptr [[ARRAYIDX34_15]], align 4
; CHECK-NEXT:    [[SUB35_15:%.*]] = sub i32 [[INC39_14]], [[ADD30]]
; CHECK-NEXT:    [[ARRAYIDX36_15:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB35_15]]
; CHECK-NEXT:    [[TMP81:%.*]] = load float, ptr [[ARRAYIDX36_15]], align 4
; CHECK-NEXT:    [[TMP82]] = tail call float @llvm.fmuladd.f32(float [[TMP80]], float [[TMP81]], float [[DOTPHI44]])
...
; CHECK-NEXT:    [[SUM45:%.*]] = fadd float [[TMP37]], [[TMP40]]
; CHECK-NEXT:    [[SUM46:%.*]] = fadd float [[SUM45]], [[TMP43]]
; CHECK-NEXT:    [[SUM47:%.*]] = fadd float [[SUM46]], [[TMP46]]
; CHECK-NEXT:    [[SUM48:%.*]] = fadd float [[SUM47]], [[TMP49]]
; CHECK-NEXT:    [[SUM49:%.*]] = fadd float [[SUM48]], [[TMP52]]
; CHECK-NEXT:    [[SUM50:%.*]] = fadd float [[SUM49]], [[TMP55]]
; CHECK-NEXT:    [[SUM51:%.*]] = fadd float [[SUM50]], [[TMP58]]
; CHECK-NEXT:    [[SUM52:%.*]] = fadd float [[SUM51]], [[TMP61]]
; CHECK-NEXT:    [[SUM53:%.*]] = fadd float [[SUM52]], [[TMP64]]
; CHECK-NEXT:    [[SUM54:%.*]] = fadd float [[SUM53]], [[TMP67]]
; CHECK-NEXT:    [[SUM55:%.*]] = fadd float [[SUM54]], [[TMP70]]
; CHECK-NEXT:    [[SUM56:%.*]] = fadd float [[SUM55]], [[TMP73]]
; CHECK-NEXT:    [[SUM57:%.*]] = fadd float [[SUM56]], [[TMP76]]
; CHECK-NEXT:    [[SUM58:%.*]] = fadd float [[SUM57]], [[TMP79]]
; CHECK-NEXT:    [[SUM59:%.*]] = fadd float [[SUM58]], [[TMP82]]
...
; CHECK-NEXT:    [[TMP83:%.*]] = phi float [ [[TMP86:%.*]], [[FOR_BODY33_CLONE]] ], [ [[PHI_FLOAT]], [[FOR_END164]] ]
...
; CHECK-NEXT:    [[TMP84:%.*]] = load float, ptr [[ARRAYIDX34_CLONE]], align 4
...
; CHECK-NEXT:    [[TMP85:%.*]] = load float, ptr [[ARRAYIDX36_CLONE]], align 4
...
; CHECK-NEXT:    br i1 [[CMP32_NOT_CLONE]], label [[FOR_COND_FOR_END_CRIT_EDGE60:%.*]], label [[FOR_BODY33_CLONE]]
; CHECK:       for.cond.for.end_crit_edge60:
; CHECK-NEXT:    store float [[TMP86]], ptr [[ARRAYIDX28]], align 4
...
; CHECK-NEXT:    br i1 [[CMP59_NOT130]], label [[FOR_BODY60_PREHEADER:%.*]], label [[FOR_END16476:%.*]]
...
; CHECK-NEXT:    [[DOTPHI61:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP89:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI62:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP92:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI63:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP95:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI64:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP98:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI65:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP101:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI66:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP104:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI67:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP107:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[DOTPHI68:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY60_PREHEADER]] ], [ [[TMP110:%.*]], [[FOR_BODY60_7]] ]
; CHECK-NEXT:    [[ARRAYIDX61:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K53_0131]]
; CHECK-NEXT:    [[TMP87:%.*]] = load float, ptr [[ARRAYIDX61]], align 4
; CHECK-NEXT:    [[SUB62:%.*]] = sub i32 [[K53_0131]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62]]
; CHECK-NEXT:    [[TMP88:%.*]] = load float, ptr [[ARRAYIDX63]], align 4
; CHECK-NEXT:    [[TMP89]] = tail call float @llvm.fmuladd.f32(float [[TMP87]], float [[TMP88]], float [[DOTPHI61]])
; CHECK-NEXT:    [[INC66:%.*]] = add i32 [[K53_0131]], 1
; CHECK-NEXT:    [[ARRAYIDX61_1:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66]]
; CHECK-NEXT:    [[TMP90:%.*]] = load float, ptr [[ARRAYIDX61_1]], align 4
; CHECK-NEXT:    [[SUB62_1:%.*]] = sub i32 [[INC66]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_1:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_1]]
; CHECK-NEXT:    [[TMP91:%.*]] = load float, ptr [[ARRAYIDX63_1]], align 4
; CHECK-NEXT:    [[TMP92]] = tail call float @llvm.fmuladd.f32(float [[TMP90]], float [[TMP91]], float [[DOTPHI62]])
; CHECK-NEXT:    [[INC66_1:%.*]] = add i32 [[K53_0131]], 2
; CHECK-NEXT:    [[ARRAYIDX61_2:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66_1]]
; CHECK-NEXT:    [[TMP93:%.*]] = load float, ptr [[ARRAYIDX61_2]], align 4
; CHECK-NEXT:    [[SUB62_2:%.*]] = sub i32 [[INC66_1]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_2:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_2]]
; CHECK-NEXT:    [[TMP94:%.*]] = load float, ptr [[ARRAYIDX63_2]], align 4
; CHECK-NEXT:    [[TMP95]] = tail call float @llvm.fmuladd.f32(float [[TMP93]], float [[TMP94]], float [[DOTPHI63]])
; CHECK-NEXT:    [[INC66_2:%.*]] = add i32 [[K53_0131]], 3
; CHECK-NEXT:    [[ARRAYIDX61_3:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66_2]]
; CHECK-NEXT:    [[TMP96:%.*]] = load float, ptr [[ARRAYIDX61_3]], align 4
; CHECK-NEXT:    [[SUB62_3:%.*]] = sub i32 [[INC66_2]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_3:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_3]]
; CHECK-NEXT:    [[TMP97:%.*]] = load float, ptr [[ARRAYIDX63_3]], align 4
; CHECK-NEXT:    [[TMP98]] = tail call float @llvm.fmuladd.f32(float [[TMP96]], float [[TMP97]], float [[DOTPHI64]])
; CHECK-NEXT:    [[INC66_3:%.*]] = add i32 [[K53_0131]], 4
; CHECK-NEXT:    [[ARRAYIDX61_4:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66_3]]
; CHECK-NEXT:    [[TMP99:%.*]] = load float, ptr [[ARRAYIDX61_4]], align 4
; CHECK-NEXT:    [[SUB62_4:%.*]] = sub i32 [[INC66_3]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_4:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_4]]
; CHECK-NEXT:    [[TMP100:%.*]] = load float, ptr [[ARRAYIDX63_4]], align 4
; CHECK-NEXT:    [[TMP101]] = tail call float @llvm.fmuladd.f32(float [[TMP99]], float [[TMP100]], float [[DOTPHI65]])
; CHECK-NEXT:    [[INC66_4:%.*]] = add i32 [[K53_0131]], 5
; CHECK-NEXT:    [[ARRAYIDX61_5:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66_4]]
; CHECK-NEXT:    [[TMP102:%.*]] = load float, ptr [[ARRAYIDX61_5]], align 4
; CHECK-NEXT:    [[SUB62_5:%.*]] = sub i32 [[INC66_4]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_5:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_5]]
; CHECK-NEXT:    [[TMP103:%.*]] = load float, ptr [[ARRAYIDX63_5]], align 4
; CHECK-NEXT:    [[TMP104]] = tail call float @llvm.fmuladd.f32(float [[TMP102]], float [[TMP103]], float [[DOTPHI66]])
; CHECK-NEXT:    [[INC66_5:%.*]] = add i32 [[K53_0131]], 6
; CHECK-NEXT:    [[ARRAYIDX61_6:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66_5]]
; CHECK-NEXT:    [[TMP105:%.*]] = load float, ptr [[ARRAYIDX61_6]], align 4
; CHECK-NEXT:    [[SUB62_6:%.*]] = sub i32 [[INC66_5]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_6:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_6]]
; CHECK-NEXT:    [[TMP106:%.*]] = load float, ptr [[ARRAYIDX63_6]], align 4
; CHECK-NEXT:    [[TMP107]] = tail call float @llvm.fmuladd.f32(float [[TMP105]], float [[TMP106]], float [[DOTPHI67]])
; CHECK-NEXT:    [[INC66_6:%.*]] = add i32 [[K53_0131]], 7
; CHECK-NEXT:    [[ARRAYIDX61_7:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[INC66_6]]
; CHECK-NEXT:    [[TMP108:%.*]] = load float, ptr [[ARRAYIDX61_7]], align 4
; CHECK-NEXT:    [[SUB62_7:%.*]] = sub i32 [[INC66_6]], [[ADD56]]
; CHECK-NEXT:    [[ARRAYIDX63_7:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB62_7]]
; CHECK-NEXT:    [[TMP109:%.*]] = load float, ptr [[ARRAYIDX63_7]], align 4
; CHECK-NEXT:    [[TMP110]] = tail call float @llvm.fmuladd.f32(float [[TMP108]], float [[TMP109]], float [[DOTPHI68]])
...
; CHECK-NEXT:    [[SUM69:%.*]] = fadd float [[TMP89]], [[TMP92]]
; CHECK-NEXT:    [[SUM70:%.*]] = fadd float [[SUM69]], [[TMP95]]
; CHECK-NEXT:    [[SUM71:%.*]] = fadd float [[SUM70]], [[TMP98]]
; CHECK-NEXT:    [[SUM72:%.*]] = fadd float [[SUM71]], [[TMP101]]
; CHECK-NEXT:    [[SUM73:%.*]] = fadd float [[SUM72]], [[TMP104]]
; CHECK-NEXT:    [[SUM74:%.*]] = fadd float [[SUM73]], [[TMP107]]
; CHECK-NEXT:    [[SUM75:%.*]] = fadd float [[SUM74]], [[TMP110]]
; CHECK-NEXT:    br label [[FOR_END16476]]
; CHECK:       for.end16476:
; CHECK-NEXT:    [[PHI_SUM77:%.*]] = phi i32 [ [[ADD56]], [[FOR_BODY50]] ], [ [[INC66_7]], [[FOR_END67_LOOPEXIT]] ]
; CHECK-NEXT:    [[PHI_FLOAT78:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY50]] ], [ [[SUM75]], [[FOR_END67_LOOPEXIT]] ]
; CHECK-NEXT:    store float [[PHI_FLOAT78]], ptr [[ARRAYIDX54]], align 4
; CHECK-NEXT:    [[CMP182_NOT58779:%.*]] = icmp ugt i32 [[PHI_SUM77]], [[SUB57]]
; CHECK-NEXT:    br i1 [[CMP182_NOT58779]], label [[FOR_END67]], label [[FOR_BODY60_CLONE:%.*]]
; CHECK:       for.body60.clone:
; CHECK-NEXT:    [[TMP111:%.*]] = phi float [ [[TMP114:%.*]], [[FOR_BODY60_CLONE]] ], [ [[PHI_FLOAT78]], [[FOR_END16476]] ]
; CHECK-NEXT:    [[K53_0131_CLONE:%.*]] = phi i32 [ [[INC66_CLONE:%.*]], [[FOR_BODY60_CLONE]] ], [ [[PHI_SUM77]], [[FOR_END16476]] ]
; CHECK-NEXT:    [[ARRAYIDX61_CLONE:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K53_0131_CLONE]]
; CHECK-NEXT:    [[TMP112:%.*]] = load float, ptr [[ARRAYIDX61_CLONE]], align 4
...
; CHECK-NEXT:    [[TMP113:%.*]] = load float, ptr [[ARRAYIDX63_CLONE]], align 4
; CHECK-NEXT:    [[TMP114]] = tail call float @llvm.fmuladd.f32(float [[TMP112]], float [[TMP113]], float [[TMP111]])
; CHECK-NEXT:    [[INC66_CLONE]] = add i32 [[K53_0131_CLONE]], 1
; CHECK-NEXT:    [[CMP59_NOT_CLONE:%.*]] = icmp ugt i32 [[INC66_CLONE]], [[SUB57]]
; CHECK-NEXT:    br i1 [[CMP59_NOT_CLONE]], label [[FOR_COND_FOR_END_CRIT_EDGE80:%.*]], label [[FOR_BODY60_CLONE]]
; CHECK:       for.cond.for.end_crit_edge80:
; CHECK-NEXT:    store float [[TMP114]], ptr [[ARRAYIDX54]], align 4
...
; CHECK-NEXT:    [[RETVAL_0_PH:%.*]] = phi i32 [ 0, [[FOR_END67]] ]
; CHECK-NEXT:    br label [[RETURN]]
; CHECK:       return:
; CHECK-NEXT:    [[RETVAL_0:%.*]] = phi i32 [ 458755, [[ENTRY:%.*]] ], [ 0, [[FOR_COND45_PREHEADER]] ], [ [[RETVAL_0_PH]], [[RETURN_LOOPEXIT]] ]
