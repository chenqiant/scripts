...
; CHECK-NEXT:    [[ADD0:%.*]] = fadd float [[RESULT0_0_LCSSA1]], [[RESULT_0_LCSSA]]
; CHECK-NEXT:    [[ADD1:%.*]] = fadd float [[RESULT0_0_LCSSA2]], [[ADD0]]
; CHECK-NEXT:    [[ADD2:%.*]] = fadd float [[RESULT0_0_LCSSA3]], [[ADD1]]
; CHECK-NEXT:    [[ADD39:%.*]] = fadd float [[RESULT0_0_LCSSA4]], [[ADD2]]
; CHECK-NEXT:    [[ADD4:%.*]] = fadd float [[RESULT0_0_LCSSA5]], [[ADD39]]
; CHECK-NEXT:    [[ADD5:%.*]] = fadd float [[RESULT0_0_LCSSA6]], [[ADD4]]
; CHECK-NEXT:    [[ADD6:%.*]] = fadd float [[RESULT0_0_LCSSA7]], [[ADD5]]
; CHECK-NEXT:    ret float [[ADD6]]
;
entry:
