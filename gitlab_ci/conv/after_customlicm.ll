...
; CHECK-NEXT:    [[TMP0:%.*]] = and i32 [[N_0121]], 2147483640
; CHECK-NEXT:    [[TMP1:%.*]] = add nsw i32 [[TMP0]], -1
; CHECK-NEXT:    [[TMP2:%.*]] = and i32 [[TMP1]], -8
; CHECK-NEXT:    [[TMP3:%.*]] = add i32 [[TMP2]], 8
; CHECK-NEXT:    [[TMP4:%.*]] = and i32 [[N_0121]], 2147483640
; CHECK-NEXT:    [[TMP5:%.*]] = icmp eq i32 [[TMP4]], 0
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, ptr [[CONVOUT]], i32 [[N_0121]]
; CHECK-NEXT:    br i1 [[TMP5]], label [[FOR_BODY13_CLONE_PREHEADER:%.*]], label [[FOR_BODY13_7:%.*]]
; CHECK:       for.body13.7:
; CHECK-NEXT:    [[K_0119:%.*]] = phi i32 [ 0, [[FOR_BODY]] ], [ [[INC_7:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP8:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI1:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP11:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI2:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP14:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI3:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP17:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI4:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP20:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI5:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP23:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI6:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP26:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[DOTPHI7:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[TMP29:%.*]], [[FOR_BODY13_7]] ]
; CHECK-NEXT:    [[ARRAYIDX14:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K_0119]]
; CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[ARRAYIDX14]], align 4
...
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX14_1]], align 4
...
; CHECK-NEXT:    [[ADD9:%.*]] = or disjoint i32 [[K_0119]], 2
; CHECK-NEXT:    [[ARRAYIDX14_2:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD9]]
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX14_2]], align 4
; CHECK-NEXT:    [[SUB_2:%.*]] = sub nsw i32 [[N_0121]], [[ADD9]]
...
; CHECK-NEXT:    [[ADD11:%.*]] = or disjoint i32 [[K_0119]], 3
; CHECK-NEXT:    [[ARRAYIDX14_3:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD11]]
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX14_3]], align 4
; CHECK-NEXT:    [[SUB_3:%.*]] = sub nsw i32 [[N_0121]], [[ADD11]]
...
; CHECK-NEXT:    [[ADD13:%.*]] = or disjoint i32 [[K_0119]], 4
; CHECK-NEXT:    [[ARRAYIDX14_4:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD13]]
; CHECK-NEXT:    [[TMP18:%.*]] = load float, ptr [[ARRAYIDX14_4]], align 4
; CHECK-NEXT:    [[SUB_4:%.*]] = sub nsw i32 [[N_0121]], [[ADD13]]
...
; CHECK-NEXT:    [[TMP20]] = tail call float @llvm.fmuladd.f32(float [[TMP18]], float [[TMP19]], float [[DOTPHI4]])
; CHECK-NEXT:    [[ADD15:%.*]] = or disjoint i32 [[K_0119]], 5
; CHECK-NEXT:    [[ARRAYIDX14_5:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD15]]
; CHECK-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX14_5]], align 4
; CHECK-NEXT:    [[SUB_5:%.*]] = sub nsw i32 [[N_0121]], [[ADD15]]
...
; CHECK-NEXT:    [[TMP23]] = tail call float @llvm.fmuladd.f32(float [[TMP21]], float [[TMP22]], float [[DOTPHI5]])
; CHECK-NEXT:    [[ADD17:%.*]] = or disjoint i32 [[K_0119]], 6
; CHECK-NEXT:    [[ARRAYIDX14_6:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD17]]
; CHECK-NEXT:    [[TMP24:%.*]] = load float, ptr [[ARRAYIDX14_6]], align 4
; CHECK-NEXT:    [[SUB_6:%.*]] = sub nsw i32 [[N_0121]], [[ADD17]]
...
; CHECK-NEXT:    [[TMP26]] = tail call float @llvm.fmuladd.f32(float [[TMP24]], float [[TMP25]], float [[DOTPHI6]])
; CHECK-NEXT:    [[ADD19:%.*]] = or disjoint i32 [[K_0119]], 7
; CHECK-NEXT:    [[ARRAYIDX14_7:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[ADD19]]
; CHECK-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX14_7]], align 4
; CHECK-NEXT:    [[SUB_7:%.*]] = sub nsw i32 [[N_0121]], [[ADD19]]
...
; CHECK-NEXT:    [[TMP29]] = tail call float @llvm.fmuladd.f32(float [[TMP27]], float [[TMP28]], float [[DOTPHI7]])
; CHECK-NEXT:    [[INC_7]] = add nuw nsw i32 [[K_0119]], 8
; CHECK-NEXT:    [[EXITCOND_7:%.*]] = icmp ult i32 [[INC_7]], [[TMP4]]
; CHECK-NEXT:    br i1 [[EXITCOND_7]], label [[FOR_BODY13_7]], label [[FOR_END20:%.*]]
; CHECK:       for.end20:
; CHECK-NEXT:    [[SUM:%.*]] = fadd float [[TMP8]], [[TMP11]]
; CHECK-NEXT:    [[SUM21:%.*]] = fadd float [[SUM]], [[TMP14]]
; CHECK-NEXT:    [[SUM22:%.*]] = fadd float [[SUM21]], [[TMP17]]
; CHECK-NEXT:    [[SUM23:%.*]] = fadd float [[SUM22]], [[TMP20]]
; CHECK-NEXT:    [[SUM24:%.*]] = fadd float [[SUM23]], [[TMP23]]
; CHECK-NEXT:    [[SUM25:%.*]] = fadd float [[SUM24]], [[TMP26]]
; CHECK-NEXT:    [[SUM26:%.*]] = fadd float [[SUM25]], [[TMP29]]
; CHECK-NEXT:    store float [[SUM26]], ptr [[ARRAYIDX]], align 4
...
; CHECK-NEXT:    [[SUM_PHI:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY]] ], [ [[SUM26]], [[FOR_END20]] ]
; CHECK-NEXT:    [[ADD_PHI:%.*]] = phi i32 [ 0, [[FOR_BODY]] ], [ [[TMP3]], [[FOR_END20]] ]
...
; CHECK-NEXT:    [[TMP30:%.*]] = phi float [ [[SUM_PHI]], [[FOR_BODY13_CLONE_PREHEADER]] ], [ [[TMP33:%.*]], [[FOR_BODY13_CLONE]] ]
; CHECK-NEXT:    [[ARRAYIDX14_CLONE:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K_0119_CLONE]]
; CHECK-NEXT:    [[TMP31:%.*]] = load float, ptr [[ARRAYIDX14_CLONE]], align 4
...
; CHECK-NEXT:    store float [[TMP33]], ptr [[ARRAYIDX]], align 4
...
; CHECK-NEXT:    [[DOTPHI27:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP36:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI28:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP39:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI29:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP42:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI30:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP45:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI31:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP48:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI32:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP51:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI33:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP54:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI34:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP57:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI35:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP60:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI36:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP63:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI37:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP66:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI38:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP69:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI39:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP72:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI40:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP75:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI41:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP78:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[DOTPHI42:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY30_PREHEADER]] ], [ [[TMP81:%.*]], [[FOR_BODY30_15]] ]
; CHECK-NEXT:    [[ARRAYIDX31:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0124]]
; CHECK-NEXT:    [[TMP34:%.*]] = load float, ptr [[ARRAYIDX31]], align 4
; CHECK-NEXT:    [[SUB32:%.*]] = sub i32 [[N20_0126]], [[K25_0124]]
; CHECK-NEXT:    [[ARRAYIDX33:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32]]
; CHECK-NEXT:    [[TMP35:%.*]] = load float, ptr [[ARRAYIDX33]], align 4
; CHECK-NEXT:    [[TMP36]] = tail call float @llvm.fmuladd.f32(float [[TMP34]], float [[TMP35]], float [[DOTPHI27]])
; CHECK-NEXT:    [[K25_0:%.*]] = add i32 [[K25_0124]], 1
; CHECK-NEXT:    [[ARRAYIDX31_1:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0]]
; CHECK-NEXT:    [[TMP37:%.*]] = load float, ptr [[ARRAYIDX31_1]], align 4
; CHECK-NEXT:    [[SUB32_1:%.*]] = sub i32 [[N20_0126]], [[K25_0]]
; CHECK-NEXT:    [[ARRAYIDX33_1:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_1]]
; CHECK-NEXT:    [[TMP38:%.*]] = load float, ptr [[ARRAYIDX33_1]], align 4
; CHECK-NEXT:    [[TMP39]] = tail call float @llvm.fmuladd.f32(float [[TMP37]], float [[TMP38]], float [[DOTPHI28]])
; CHECK-NEXT:    [[K25_0_1:%.*]] = add i32 [[K25_0124]], 2
; CHECK-NEXT:    [[ARRAYIDX31_2:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_1]]
; CHECK-NEXT:    [[TMP40:%.*]] = load float, ptr [[ARRAYIDX31_2]], align 4
; CHECK-NEXT:    [[SUB32_2:%.*]] = sub i32 [[N20_0126]], [[K25_0_1]]
; CHECK-NEXT:    [[ARRAYIDX33_2:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_2]]
; CHECK-NEXT:    [[TMP41:%.*]] = load float, ptr [[ARRAYIDX33_2]], align 4
; CHECK-NEXT:    [[TMP42]] = tail call float @llvm.fmuladd.f32(float [[TMP40]], float [[TMP41]], float [[DOTPHI29]])
; CHECK-NEXT:    [[K25_0_2:%.*]] = add i32 [[K25_0124]], 3
; CHECK-NEXT:    [[ARRAYIDX31_3:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_2]]
; CHECK-NEXT:    [[TMP43:%.*]] = load float, ptr [[ARRAYIDX31_3]], align 4
; CHECK-NEXT:    [[SUB32_3:%.*]] = sub i32 [[N20_0126]], [[K25_0_2]]
; CHECK-NEXT:    [[ARRAYIDX33_3:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_3]]
; CHECK-NEXT:    [[TMP44:%.*]] = load float, ptr [[ARRAYIDX33_3]], align 4
; CHECK-NEXT:    [[TMP45]] = tail call float @llvm.fmuladd.f32(float [[TMP43]], float [[TMP44]], float [[DOTPHI30]])
; CHECK-NEXT:    [[K25_0_3:%.*]] = add i32 [[K25_0124]], 4
; CHECK-NEXT:    [[ARRAYIDX31_4:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_3]]
; CHECK-NEXT:    [[TMP46:%.*]] = load float, ptr [[ARRAYIDX31_4]], align 4
; CHECK-NEXT:    [[SUB32_4:%.*]] = sub i32 [[N20_0126]], [[K25_0_3]]
; CHECK-NEXT:    [[ARRAYIDX33_4:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_4]]
; CHECK-NEXT:    [[TMP47:%.*]] = load float, ptr [[ARRAYIDX33_4]], align 4
; CHECK-NEXT:    [[TMP48]] = tail call float @llvm.fmuladd.f32(float [[TMP46]], float [[TMP47]], float [[DOTPHI31]])
; CHECK-NEXT:    [[K25_0_4:%.*]] = add i32 [[K25_0124]], 5
; CHECK-NEXT:    [[ARRAYIDX31_5:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_4]]
; CHECK-NEXT:    [[TMP49:%.*]] = load float, ptr [[ARRAYIDX31_5]], align 4
; CHECK-NEXT:    [[SUB32_5:%.*]] = sub i32 [[N20_0126]], [[K25_0_4]]
; CHECK-NEXT:    [[ARRAYIDX33_5:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_5]]
; CHECK-NEXT:    [[TMP50:%.*]] = load float, ptr [[ARRAYIDX33_5]], align 4
; CHECK-NEXT:    [[TMP51]] = tail call float @llvm.fmuladd.f32(float [[TMP49]], float [[TMP50]], float [[DOTPHI32]])
; CHECK-NEXT:    [[K25_0_5:%.*]] = add i32 [[K25_0124]], 6
; CHECK-NEXT:    [[ARRAYIDX31_6:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_5]]
; CHECK-NEXT:    [[TMP52:%.*]] = load float, ptr [[ARRAYIDX31_6]], align 4
; CHECK-NEXT:    [[SUB32_6:%.*]] = sub i32 [[N20_0126]], [[K25_0_5]]
; CHECK-NEXT:    [[ARRAYIDX33_6:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_6]]
; CHECK-NEXT:    [[TMP53:%.*]] = load float, ptr [[ARRAYIDX33_6]], align 4
; CHECK-NEXT:    [[TMP54]] = tail call float @llvm.fmuladd.f32(float [[TMP52]], float [[TMP53]], float [[DOTPHI33]])
; CHECK-NEXT:    [[K25_0_6:%.*]] = add i32 [[K25_0124]], 7
; CHECK-NEXT:    [[ARRAYIDX31_7:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_6]]
; CHECK-NEXT:    [[TMP55:%.*]] = load float, ptr [[ARRAYIDX31_7]], align 4
; CHECK-NEXT:    [[SUB32_7:%.*]] = sub i32 [[N20_0126]], [[K25_0_6]]
; CHECK-NEXT:    [[ARRAYIDX33_7:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_7]]
; CHECK-NEXT:    [[TMP56:%.*]] = load float, ptr [[ARRAYIDX33_7]], align 4
; CHECK-NEXT:    [[TMP57]] = tail call float @llvm.fmuladd.f32(float [[TMP55]], float [[TMP56]], float [[DOTPHI34]])
; CHECK-NEXT:    [[K25_0_7:%.*]] = add i32 [[K25_0124]], 8
; CHECK-NEXT:    [[ARRAYIDX31_8:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_7]]
; CHECK-NEXT:    [[TMP58:%.*]] = load float, ptr [[ARRAYIDX31_8]], align 4
; CHECK-NEXT:    [[SUB32_8:%.*]] = sub i32 [[N20_0126]], [[K25_0_7]]
; CHECK-NEXT:    [[ARRAYIDX33_8:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_8]]
; CHECK-NEXT:    [[TMP59:%.*]] = load float, ptr [[ARRAYIDX33_8]], align 4
; CHECK-NEXT:    [[TMP60]] = tail call float @llvm.fmuladd.f32(float [[TMP58]], float [[TMP59]], float [[DOTPHI35]])
; CHECK-NEXT:    [[K25_0_8:%.*]] = add i32 [[K25_0124]], 9
; CHECK-NEXT:    [[ARRAYIDX31_9:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_8]]
; CHECK-NEXT:    [[TMP61:%.*]] = load float, ptr [[ARRAYIDX31_9]], align 4
; CHECK-NEXT:    [[SUB32_9:%.*]] = sub i32 [[N20_0126]], [[K25_0_8]]
; CHECK-NEXT:    [[ARRAYIDX33_9:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB32_9]]
; CHECK-NEXT:    [[TMP62:%.*]] = load float, ptr [[ARRAYIDX33_9]], align 4
; CHECK-NEXT:    [[TMP63]] = tail call float @llvm.fmuladd.f32(float [[TMP61]], float [[TMP62]], float [[DOTPHI36]])
; CHECK-NEXT:    [[K25_0_9:%.*]] = add i32 [[K25_0124]], 10
; CHECK-NEXT:    [[ARRAYIDX31_10:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_9]]
; CHECK-NEXT:    [[TMP64:%.*]] = load float, ptr [[ARRAYIDX31_10]], align 4
...
; CHECK-NEXT:    [[TMP65:%.*]] = load float, ptr [[ARRAYIDX33_10]], align 4
; CHECK-NEXT:    [[TMP66]] = tail call float @llvm.fmuladd.f32(float [[TMP64]], float [[TMP65]], float [[DOTPHI37]])
; CHECK-NEXT:    [[K25_0_10:%.*]] = add i32 [[K25_0124]], 11
; CHECK-NEXT:    [[ARRAYIDX31_11:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_10]]
; CHECK-NEXT:    [[TMP67:%.*]] = load float, ptr [[ARRAYIDX31_11]], align 4
...
; CHECK-NEXT:    [[TMP68:%.*]] = load float, ptr [[ARRAYIDX33_11]], align 4
; CHECK-NEXT:    [[TMP69]] = tail call float @llvm.fmuladd.f32(float [[TMP67]], float [[TMP68]], float [[DOTPHI38]])
; CHECK-NEXT:    [[K25_0_11:%.*]] = add i32 [[K25_0124]], 12
; CHECK-NEXT:    [[ARRAYIDX31_12:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_11]]
; CHECK-NEXT:    [[TMP70:%.*]] = load float, ptr [[ARRAYIDX31_12]], align 4
...
; CHECK-NEXT:    [[TMP71:%.*]] = load float, ptr [[ARRAYIDX33_12]], align 4
; CHECK-NEXT:    [[TMP72]] = tail call float @llvm.fmuladd.f32(float [[TMP70]], float [[TMP71]], float [[DOTPHI39]])
; CHECK-NEXT:    [[K25_0_12:%.*]] = add i32 [[K25_0124]], 13
; CHECK-NEXT:    [[ARRAYIDX31_13:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_12]]
; CHECK-NEXT:    [[TMP73:%.*]] = load float, ptr [[ARRAYIDX31_13]], align 4
...
; CHECK-NEXT:    [[TMP74:%.*]] = load float, ptr [[ARRAYIDX33_13]], align 4
; CHECK-NEXT:    [[TMP75]] = tail call float @llvm.fmuladd.f32(float [[TMP73]], float [[TMP74]], float [[DOTPHI40]])
; CHECK-NEXT:    [[K25_0_13:%.*]] = add i32 [[K25_0124]], 14
; CHECK-NEXT:    [[ARRAYIDX31_14:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_13]]
; CHECK-NEXT:    [[TMP76:%.*]] = load float, ptr [[ARRAYIDX31_14]], align 4
...
; CHECK-NEXT:    [[TMP77:%.*]] = load float, ptr [[ARRAYIDX33_14]], align 4
; CHECK-NEXT:    [[TMP78]] = tail call float @llvm.fmuladd.f32(float [[TMP76]], float [[TMP77]], float [[DOTPHI41]])
; CHECK-NEXT:    [[K25_0_14:%.*]] = add i32 [[K25_0124]], 15
; CHECK-NEXT:    [[ARRAYIDX31_15:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K25_0_14]]
; CHECK-NEXT:    [[TMP79:%.*]] = load float, ptr [[ARRAYIDX31_15]], align 4
...
; CHECK-NEXT:    [[TMP80:%.*]] = load float, ptr [[ARRAYIDX33_15]], align 4
; CHECK-NEXT:    [[TMP81]] = tail call float @llvm.fmuladd.f32(float [[TMP79]], float [[TMP80]], float [[DOTPHI42]])
...
; CHECK-NEXT:    [[SUM43:%.*]] = fadd float [[TMP36]], [[TMP39]]
; CHECK-NEXT:    [[SUM44:%.*]] = fadd float [[SUM43]], [[TMP42]]
; CHECK-NEXT:    [[SUM45:%.*]] = fadd float [[SUM44]], [[TMP45]]
; CHECK-NEXT:    [[SUM46:%.*]] = fadd float [[SUM45]], [[TMP48]]
; CHECK-NEXT:    [[SUM47:%.*]] = fadd float [[SUM46]], [[TMP51]]
; CHECK-NEXT:    [[SUM48:%.*]] = fadd float [[SUM47]], [[TMP54]]
; CHECK-NEXT:    [[SUM49:%.*]] = fadd float [[SUM48]], [[TMP57]]
; CHECK-NEXT:    [[SUM50:%.*]] = fadd float [[SUM49]], [[TMP60]]
; CHECK-NEXT:    [[SUM51:%.*]] = fadd float [[SUM50]], [[TMP63]]
; CHECK-NEXT:    [[SUM52:%.*]] = fadd float [[SUM51]], [[TMP66]]
; CHECK-NEXT:    [[SUM53:%.*]] = fadd float [[SUM52]], [[TMP69]]
; CHECK-NEXT:    [[SUM54:%.*]] = fadd float [[SUM53]], [[TMP72]]
; CHECK-NEXT:    [[SUM55:%.*]] = fadd float [[SUM54]], [[TMP75]]
; CHECK-NEXT:    [[SUM56:%.*]] = fadd float [[SUM55]], [[TMP78]]
; CHECK-NEXT:    [[SUM57:%.*]] = fadd float [[SUM56]], [[TMP81]]
; CHECK-NEXT:    br label [[FOR_END164]]
; CHECK:       for.end164:
; CHECK-NEXT:    [[PHI_SUM:%.*]] = phi i32 [ [[K25_0122]], [[FOR_BODY24]] ], [ [[K25_0_15]], [[FOR_END37_LOOPEXIT]] ]
; CHECK-NEXT:    [[PHI_FLOAT:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY24]] ], [ [[SUM57]], [[FOR_END37_LOOPEXIT]] ]
...
; CHECK-NEXT:    [[TMP82:%.*]] = phi float [ [[TMP85:%.*]], [[FOR_BODY30_CLONE]] ], [ [[PHI_FLOAT]], [[FOR_END164]] ]
...
; CHECK-NEXT:    [[TMP83:%.*]] = load float, ptr [[ARRAYIDX31_CLONE]], align 4
...
; CHECK-NEXT:    [[TMP84:%.*]] = load float, ptr [[ARRAYIDX33_CLONE]], align 4
; CHECK-NEXT:    [[TMP85]] = tail call float @llvm.fmuladd.f32(float [[TMP83]], float [[TMP84]], float [[TMP82]])
; CHECK-NEXT:    [[K25_0_CLONE]] = add i32 [[K25_0124_CLONE]], 1
; CHECK-NEXT:    [[CMP29_NOT_CLONE:%.*]] = icmp ugt i32 [[K25_0_CLONE]], [[N20_0126]]
; CHECK-NEXT:    br i1 [[CMP29_NOT_CLONE]], label [[FOR_COND_FOR_END_CRIT_EDGE58:%.*]], label [[FOR_BODY30_CLONE]]
; CHECK:       for.cond.for.end_crit_edge58:
; CHECK-NEXT:    store float [[TMP85]], ptr [[ARRAYIDX26]], align 4
...
; CHECK-NEXT:    br i1 [[CMP56_NOT128]], label [[FOR_BODY57_PREHEADER:%.*]], label [[FOR_END16474:%.*]]
...
; CHECK-NEXT:    [[DOTPHI59:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP88:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI60:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP91:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI61:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP94:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI62:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP97:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI63:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP100:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI64:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP103:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI65:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP106:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[DOTPHI66:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY57_PREHEADER]] ], [ [[TMP109:%.*]], [[FOR_BODY57_7]] ]
; CHECK-NEXT:    [[ARRAYIDX58:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0129]]
; CHECK-NEXT:    [[TMP86:%.*]] = load float, ptr [[ARRAYIDX58]], align 4
; CHECK-NEXT:    [[SUB59:%.*]] = sub i32 [[N41_0131]], [[K50_0129]]
; CHECK-NEXT:    [[ARRAYIDX60:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59]]
; CHECK-NEXT:    [[TMP87:%.*]] = load float, ptr [[ARRAYIDX60]], align 4
; CHECK-NEXT:    [[TMP88]] = tail call float @llvm.fmuladd.f32(float [[TMP86]], float [[TMP87]], float [[DOTPHI59]])
; CHECK-NEXT:    [[K50_0:%.*]] = add i32 [[K50_0129]], 1
; CHECK-NEXT:    [[ARRAYIDX58_1:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0]]
; CHECK-NEXT:    [[TMP89:%.*]] = load float, ptr [[ARRAYIDX58_1]], align 4
; CHECK-NEXT:    [[SUB59_1:%.*]] = sub i32 [[N41_0131]], [[K50_0]]
; CHECK-NEXT:    [[ARRAYIDX60_1:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_1]]
; CHECK-NEXT:    [[TMP90:%.*]] = load float, ptr [[ARRAYIDX60_1]], align 4
; CHECK-NEXT:    [[TMP91]] = tail call float @llvm.fmuladd.f32(float [[TMP89]], float [[TMP90]], float [[DOTPHI60]])
; CHECK-NEXT:    [[K50_0_1:%.*]] = add i32 [[K50_0129]], 2
; CHECK-NEXT:    [[ARRAYIDX58_2:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0_1]]
; CHECK-NEXT:    [[TMP92:%.*]] = load float, ptr [[ARRAYIDX58_2]], align 4
; CHECK-NEXT:    [[SUB59_2:%.*]] = sub i32 [[N41_0131]], [[K50_0_1]]
; CHECK-NEXT:    [[ARRAYIDX60_2:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_2]]
; CHECK-NEXT:    [[TMP93:%.*]] = load float, ptr [[ARRAYIDX60_2]], align 4
; CHECK-NEXT:    [[TMP94]] = tail call float @llvm.fmuladd.f32(float [[TMP92]], float [[TMP93]], float [[DOTPHI61]])
; CHECK-NEXT:    [[K50_0_2:%.*]] = add i32 [[K50_0129]], 3
; CHECK-NEXT:    [[ARRAYIDX58_3:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0_2]]
; CHECK-NEXT:    [[TMP95:%.*]] = load float, ptr [[ARRAYIDX58_3]], align 4
; CHECK-NEXT:    [[SUB59_3:%.*]] = sub i32 [[N41_0131]], [[K50_0_2]]
; CHECK-NEXT:    [[ARRAYIDX60_3:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_3]]
; CHECK-NEXT:    [[TMP96:%.*]] = load float, ptr [[ARRAYIDX60_3]], align 4
; CHECK-NEXT:    [[TMP97]] = tail call float @llvm.fmuladd.f32(float [[TMP95]], float [[TMP96]], float [[DOTPHI62]])
; CHECK-NEXT:    [[K50_0_3:%.*]] = add i32 [[K50_0129]], 4
; CHECK-NEXT:    [[ARRAYIDX58_4:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0_3]]
; CHECK-NEXT:    [[TMP98:%.*]] = load float, ptr [[ARRAYIDX58_4]], align 4
; CHECK-NEXT:    [[SUB59_4:%.*]] = sub i32 [[N41_0131]], [[K50_0_3]]
; CHECK-NEXT:    [[ARRAYIDX60_4:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_4]]
; CHECK-NEXT:    [[TMP99:%.*]] = load float, ptr [[ARRAYIDX60_4]], align 4
; CHECK-NEXT:    [[TMP100]] = tail call float @llvm.fmuladd.f32(float [[TMP98]], float [[TMP99]], float [[DOTPHI63]])
; CHECK-NEXT:    [[K50_0_4:%.*]] = add i32 [[K50_0129]], 5
; CHECK-NEXT:    [[ARRAYIDX58_5:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0_4]]
; CHECK-NEXT:    [[TMP101:%.*]] = load float, ptr [[ARRAYIDX58_5]], align 4
; CHECK-NEXT:    [[SUB59_5:%.*]] = sub i32 [[N41_0131]], [[K50_0_4]]
; CHECK-NEXT:    [[ARRAYIDX60_5:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_5]]
; CHECK-NEXT:    [[TMP102:%.*]] = load float, ptr [[ARRAYIDX60_5]], align 4
; CHECK-NEXT:    [[TMP103]] = tail call float @llvm.fmuladd.f32(float [[TMP101]], float [[TMP102]], float [[DOTPHI64]])
; CHECK-NEXT:    [[K50_0_5:%.*]] = add i32 [[K50_0129]], 6
; CHECK-NEXT:    [[ARRAYIDX58_6:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0_5]]
; CHECK-NEXT:    [[TMP104:%.*]] = load float, ptr [[ARRAYIDX58_6]], align 4
; CHECK-NEXT:    [[SUB59_6:%.*]] = sub i32 [[N41_0131]], [[K50_0_5]]
; CHECK-NEXT:    [[ARRAYIDX60_6:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_6]]
; CHECK-NEXT:    [[TMP105:%.*]] = load float, ptr [[ARRAYIDX60_6]], align 4
; CHECK-NEXT:    [[TMP106]] = tail call float @llvm.fmuladd.f32(float [[TMP104]], float [[TMP105]], float [[DOTPHI65]])
; CHECK-NEXT:    [[K50_0_6:%.*]] = add i32 [[K50_0129]], 7
; CHECK-NEXT:    [[ARRAYIDX58_7:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0_6]]
; CHECK-NEXT:    [[TMP107:%.*]] = load float, ptr [[ARRAYIDX58_7]], align 4
; CHECK-NEXT:    [[SUB59_7:%.*]] = sub i32 [[N41_0131]], [[K50_0_6]]
; CHECK-NEXT:    [[ARRAYIDX60_7:%.*]] = getelementptr inbounds float, ptr [[KERN_0]], i32 [[SUB59_7]]
; CHECK-NEXT:    [[TMP108:%.*]] = load float, ptr [[ARRAYIDX60_7]], align 4
; CHECK-NEXT:    [[TMP109]] = tail call float @llvm.fmuladd.f32(float [[TMP107]], float [[TMP108]], float [[DOTPHI66]])
...
; CHECK-NEXT:    [[SUM67:%.*]] = fadd float [[TMP88]], [[TMP91]]
; CHECK-NEXT:    [[SUM68:%.*]] = fadd float [[SUM67]], [[TMP94]]
; CHECK-NEXT:    [[SUM69:%.*]] = fadd float [[SUM68]], [[TMP97]]
; CHECK-NEXT:    [[SUM70:%.*]] = fadd float [[SUM69]], [[TMP100]]
; CHECK-NEXT:    [[SUM71:%.*]] = fadd float [[SUM70]], [[TMP103]]
; CHECK-NEXT:    [[SUM72:%.*]] = fadd float [[SUM71]], [[TMP106]]
; CHECK-NEXT:    [[SUM73:%.*]] = fadd float [[SUM72]], [[TMP109]]
; CHECK-NEXT:    br label [[FOR_END16474]]
; CHECK:       for.end16474:
; CHECK-NEXT:    [[PHI_SUM75:%.*]] = phi i32 [ [[K50_0127]], [[FOR_BODY47]] ], [ [[K50_0_7]], [[FOR_END64_LOOPEXIT]] ]
; CHECK-NEXT:    [[PHI_FLOAT76:%.*]] = phi float [ 0.000000e+00, [[FOR_BODY47]] ], [ [[SUM73]], [[FOR_END64_LOOPEXIT]] ]
; CHECK-NEXT:    store float [[PHI_FLOAT76]], ptr [[ARRAYIDX51]], align 4
; CHECK-NEXT:    [[CMP182_NOT58777:%.*]] = icmp ugt i32 [[PHI_SUM75]], [[SUB54]]
; CHECK-NEXT:    br i1 [[CMP182_NOT58777]], label [[FOR_END64]], label [[FOR_BODY57_CLONE:%.*]]
; CHECK:       for.body57.clone:
; CHECK-NEXT:    [[TMP110:%.*]] = phi float [ [[TMP113:%.*]], [[FOR_BODY57_CLONE]] ], [ [[PHI_FLOAT76]], [[FOR_END16474]] ]
; CHECK-NEXT:    [[K50_0129_CLONE:%.*]] = phi i32 [ [[K50_0_CLONE:%.*]], [[FOR_BODY57_CLONE]] ], [ [[PHI_SUM75]], [[FOR_END16474]] ]
; CHECK-NEXT:    [[ARRAYIDX58_CLONE:%.*]] = getelementptr inbounds float, ptr [[SIG_0]], i32 [[K50_0129_CLONE]]
; CHECK-NEXT:    [[TMP111:%.*]] = load float, ptr [[ARRAYIDX58_CLONE]], align 4
...
; CHECK-NEXT:    [[TMP112:%.*]] = load float, ptr [[ARRAYIDX60_CLONE]], align 4
...
; CHECK-NEXT:    br i1 [[CMP56_NOT_CLONE]], label [[FOR_COND_FOR_END_CRIT_EDGE78:%.*]], label [[FOR_BODY57_CLONE]]
; CHECK:       for.cond.for.end_crit_edge78:
; CHECK-NEXT:    store float [[TMP113]], ptr [[ARRAYIDX51]], align 4
