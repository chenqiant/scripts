...
define dso_local noundef i32 @dsps_corr_f32_ansi(ptr noalias noundef readonly %Signal, i32 noundef %siglen, ptr noalias noundef readonly %Pattern, i32 noundef %patlen, ptr noalias noundef writeonly %dest) local_unnamed_addr {
entry:
...
for.cond11.preheader.preheader:                   ; preds = %for.cond95.preheader.lr.ph
  ...
  %4 = sub i32 %2, %3
  %5 = shl i32 %4, 2
  tail call void @llvm.memset.p0.i32(ptr nonnull align 4 %scevgep, i8 0, i32 %5, i1 false)
  br label %return
...
for.cond11.for.cond.cleanup13_crit_edge.us:       ; preds = %for.body14.us
  ...
  store float %11, ptr %arrayidx16.us, align 4
  %inc18.us = add nuw i32 %n.038.us, 1
  %cmp10.not.us.not = icmp eq i32 %n.038.us, %7
  br i1 %cmp10.not.us.not, label %return, label %for.cond11.preheader.us
...
for.body14.us.unroll:                             ; preds = %for.body10.lr.ph, %for.body14.us.unroll
  ...
  %43 = load float, ptr %arrayidx15.us.unroll, align 4
  %44 = load float, ptr %arrayidx.us.unroll, align 4
  %45 = load float, ptr %arrayidx1, align 4
  %46 = load float, ptr %arrayidx2, align 4
  %47 = load float, ptr %arrayidx3, align 4
  %48 = load float, ptr %arrayidx4, align 4
  %49 = load float, ptr %arrayidx5, align 4
  %50 = load float, ptr %arrayidx6, align 4
  %51 = load float, ptr %arrayidx7, align 4
  %52 = load float, ptr %arrayidx8, align 4
  %53 = load float, ptr %arrayidx9, align 4
  %54 = load float, ptr %arrayidx10, align 4
  %55 = load float, ptr %arrayidx11, align 4
  %56 = load float, ptr %arrayidx12, align 4
  %57 = load float, ptr %arrayidx13, align 4
  %58 = load float, ptr %arrayidx14, align 4
  %59 = load float, ptr %arrayidx15, align 4
  ...
  br i1 %exitcond.not.unroll, label %for.cond.cleanup, label %for.body14.us.unroll
