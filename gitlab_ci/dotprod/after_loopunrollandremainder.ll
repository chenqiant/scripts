...
define dso_local noundef i32 @dsps_dotprod_f32_ansi(ptr noalias nocapture noundef readonly %src1, ptr noalias nocapture noundef readonly %src2, ptr noalias nocapture noundef writeonly %dest, i32 noundef %len) local_unnamed_addr {
entry:
...
for.body33:                                       ; preds = %for.body33, %for.cond31.preheader
  ...
  %27 = load float, ptr %arrayidx133, align 4
...
for.body.clone:                                   ; preds = %for.body.clone, %for.cond.preheader
  ...
  %30 = load float, ptr %arrayidx1.clone, align 4
