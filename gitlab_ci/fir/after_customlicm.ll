...
; CHECK-NEXT:    [[ADD139:%.*]] = fadd float [[ACC23_CLONE]], [[TMP67]]
; CHECK-NEXT:    [[ADD140:%.*]] = fadd float [[ACC27_CLONE]], [[ADD139]]
; CHECK-NEXT:    [[ADD141:%.*]] = fadd float [[ACC30_CLONE]], [[ADD140]]
; CHECK-NEXT:    [[ADD142:%.*]] = fadd float [[ACC34_CLONE]], [[ADD141]]
; CHECK-NEXT:    [[ADD143:%.*]] = fadd float [[ACC37_CLONE]], [[ADD142]]
; CHECK-NEXT:    [[ADD144:%.*]] = fadd float [[ACC40_CLONE]], [[ADD143]]
; CHECK-NEXT:    [[ADD145:%.*]] = fadd float [[ACC44_CLONE]], [[ADD144]]
