...
define dso_local noundef i32 @dsps_fird_f32_ansi(ptr noalias nocapture noundef %fir, ptr noalias nocapture noundef readonly %input, ptr noalias nocapture noundef writeonly %output, i32 noundef %len) local_unnamed_addr {
entry:
...
for.body4:                                        ; preds = %for.body4, %for.body4.lr.ph
  ...
  %8 = load float, ptr %input.addr.164, align 4
  %inc = add nsw i32 %7, 1
...
for.cond63.preheader:                             ; preds = %for.body14.7, %for.cond.cleanup3
  ...
  %acc.1.lcssa2 = phi float [ 0.000000e+00, %for.cond.cleanup3 ], [ %17, %for.body14.7 ]
  %acc.2.lcssa = phi float [ 0.000000e+00, %for.cond.cleanup3 ], [ %20, %for.body14.7 ]
  %acc.3.lcssa = phi float [ 0.000000e+00, %for.cond.cleanup3 ], [ %23, %for.body14.7 ]
  %acc.4.lcssa = phi float [ 0.000000e+00, %for.cond.cleanup3 ], [ %26, %for.body14.7 ]
  %acc.5.lcssa = phi float [ 0.000000e+00, %for.cond.cleanup3 ], [ %29, %for.body14.7 ]
  %acc.6.lcssa = phi float [ 0.000000e+00, %for.cond.cleanup3 ], [ %32, %for.body14.7 ]
...
for.body14.7:                                     ; preds = %for.body14.lr.ph, %for.body14.7
  ...
  %acc3 = phi float [ 0.000000e+00, %for.body14.lr.ph ], [ %17, %for.body14.7 ]
  %acc4 = phi float [ 0.000000e+00, %for.body14.lr.ph ], [ %20, %for.body14.7 ]
  %acc5 = phi float [ 0.000000e+00, %for.body14.lr.ph ], [ %23, %for.body14.7 ]
  %acc6 = phi float [ 0.000000e+00, %for.body14.lr.ph ], [ %26, %for.body14.7 ]
  %acc7 = phi float [ 0.000000e+00, %for.body14.lr.ph ], [ %29, %for.body14.7 ]
  %acc8 = phi float [ 0.000000e+00, %for.body14.lr.ph ], [ %32, %for.body14.7 ]
  ...
  %add11 = or disjoint i32 %coeff_pos.068, 2
  %arrayidx16.1 = getelementptr inbounds float, ptr %5, i32 %add
  %15 = load float, ptr %arrayidx16.1, align 4
  %arrayidx18.1 = getelementptr inbounds float, ptr %arrayidx18, i32 1
  %16 = load float, ptr %arrayidx18.1, align 4
  %17 = tail call float @llvm.fmuladd.f32(float %15, float %16, float %acc3)
  %add13 = or disjoint i32 %coeff_pos.068, 3
  %arrayidx16.2 = getelementptr inbounds float, ptr %5, i32 %add11
  %18 = load float, ptr %arrayidx16.2, align 4
  %arrayidx18.2 = getelementptr inbounds float, ptr %arrayidx18, i32 2
  %19 = load float, ptr %arrayidx18.2, align 4
  %20 = tail call float @llvm.fmuladd.f32(float %18, float %19, float %acc4)
  %add15 = or disjoint i32 %coeff_pos.068, 4
  %arrayidx16.3 = getelementptr inbounds float, ptr %5, i32 %add13
  %21 = load float, ptr %arrayidx16.3, align 4
  %arrayidx18.3 = getelementptr inbounds float, ptr %arrayidx18, i32 3
  %22 = load float, ptr %arrayidx18.3, align 4
  %23 = tail call float @llvm.fmuladd.f32(float %21, float %22, float %acc5)
  %add17 = or disjoint i32 %coeff_pos.068, 5
  %arrayidx16.4 = getelementptr inbounds float, ptr %5, i32 %add15
  %24 = load float, ptr %arrayidx16.4, align 4
  %arrayidx18.4 = getelementptr inbounds float, ptr %arrayidx18, i32 4
  %25 = load float, ptr %arrayidx18.4, align 4
  %26 = tail call float @llvm.fmuladd.f32(float %24, float %25, float %acc6)
  %add19 = or disjoint i32 %coeff_pos.068, 6
  %arrayidx16.5 = getelementptr inbounds float, ptr %5, i32 %add17
  %27 = load float, ptr %arrayidx16.5, align 4
  %arrayidx18.5 = getelementptr inbounds float, ptr %arrayidx18, i32 5
  %28 = load float, ptr %arrayidx18.5, align 4
  %29 = tail call float @llvm.fmuladd.f32(float %27, float %28, float %acc7)
  %inc15.6 = add nuw nsw i32 %coeff_pos.068, 7
  %arrayidx16.6 = getelementptr inbounds float, ptr %5, i32 %add19
  %30 = load float, ptr %arrayidx16.6, align 4
  %arrayidx18.6 = getelementptr inbounds float, ptr %arrayidx18, i32 6
  %31 = load float, ptr %arrayidx18.6, align 4
  %32 = tail call float @llvm.fmuladd.f32(float %30, float %31, float %acc8)
  %inc15.7 = add nuw i32 %coeff_pos.068, 8
  %arrayidx16.7 = getelementptr inbounds float, ptr %5, i32 %inc15.6
  %33 = load float, ptr %arrayidx16.7, align 4
  %arrayidx18.7 = getelementptr inbounds float, ptr %arrayidx18, i32 7
  %34 = load float, ptr %arrayidx18.7, align 4
  %35 = tail call float @llvm.fmuladd.f32(float %33, float %34, float %acc9)
  %inc20.7 = add nsw i32 %add281, 8
  %exitcond83.not.7 = icmp sgt i32 %inc20.7, %1
  br i1 %exitcond83.not.7, label %for.cond63.preheader, label %for.body14.7

for.body79.lr.ph:                                 ; preds = %for.cond.cleanup26
  %36 = load ptr, ptr %fir, align 4
  %37 = load ptr, ptr %delay, align 4
...
for.body14.clone:                                 ; preds = %for.body14.clone, %for.body27.lr.ph
  ...
  %39 = load float, ptr %arrayidx16.clone, align 4
  %arrayidx18.clone = getelementptr inbounds float, ptr %10, i32 %n.069.clone
  %40 = load float, ptr %arrayidx18.clone, align 4
  ...
  br i1 %exitcond83.not.clone, label %for.cond.cleanup26.loopexit, label %for.body14.clone
...
for.cond130.preheader:                            ; preds = %for.body27.7, %for.cond.cleanup26
  ...
  %acc.1.lcssa2.clone = phi float [ %acc.1.lcssa2, %for.cond.cleanup26 ], [ %48, %for.body27.7 ]
  %acc.2.lcssa.clone = phi float [ %acc.2.lcssa, %for.cond.cleanup26 ], [ %51, %for.body27.7 ]
  %acc.3.lcssa.clone = phi float [ %acc.3.lcssa, %for.cond.cleanup26 ], [ %54, %for.body27.7 ]
  %acc.4.lcssa.clone = phi float [ %acc.4.lcssa, %for.cond.cleanup26 ], [ %57, %for.body27.7 ]
  %acc.5.lcssa.clone = phi float [ %acc.5.lcssa, %for.cond.cleanup26 ], [ %60, %for.body27.7 ]
  %acc.6.lcssa.clone = phi float [ %acc.6.lcssa, %for.cond.cleanup26 ], [ %63, %for.body27.7 ]
  %acc.7.lcssa.clone = phi float [ %acc.7.lcssa, %for.cond.cleanup26 ], [ %66, %for.body27.7 ]
  %coeff_pos.0.lcssa.clone = phi i32 [ %coeff_pos.1.lcssa, %for.cond.cleanup26 ], [ %add57, %for.body27.7 ]
...
for.body27.7:                                     ; preds = %for.body79.lr.ph, %for.body27.7
  ...
  %coeff_pos.174 = phi i32 [ %coeff_pos.1.lcssa, %for.body79.lr.ph ], [ %add57, %for.body27.7 ]
  %acc20 = phi float [ %acc.1.lcssa, %for.body79.lr.ph ], [ %45, %for.body27.7 ]
  %acc21 = phi float [ %acc.1.lcssa2, %for.body79.lr.ph ], [ %48, %for.body27.7 ]
  %acc22 = phi float [ %acc.2.lcssa, %for.body79.lr.ph ], [ %51, %for.body27.7 ]
  %acc23 = phi float [ %acc.3.lcssa, %for.body79.lr.ph ], [ %54, %for.body27.7 ]
  %acc24 = phi float [ %acc.4.lcssa, %for.body79.lr.ph ], [ %57, %for.body27.7 ]
  %acc25 = phi float [ %acc.5.lcssa, %for.body79.lr.ph ], [ %60, %for.body27.7 ]
  %acc26 = phi float [ %acc.6.lcssa, %for.body79.lr.ph ], [ %63, %for.body27.7 ]
  %acc27 = phi float [ %acc.7.lcssa, %for.body79.lr.ph ], [ %66, %for.body27.7 ]
  ...
  %44 = load float, ptr %arrayidx32, align 4
  %45 = tail call float @llvm.fmuladd.f32(float %43, float %44, float %acc20)
  %add31 = or disjoint i32 %n22.075, 1
  %arrayidx30.1 = getelementptr inbounds float, ptr %arrayidx30, i32 1
  %46 = load float, ptr %arrayidx30.1, align 4
  %arrayidx32.1 = getelementptr inbounds float, ptr %37, i32 %add31
  %47 = load float, ptr %arrayidx32.1, align 4
  %48 = tail call float @llvm.fmuladd.f32(float %46, float %47, float %acc21)
  %add35 = or disjoint i32 %n22.075, 2
  %arrayidx30.2 = getelementptr inbounds float, ptr %arrayidx30, i32 2
  %49 = load float, ptr %arrayidx30.2, align 4
  %arrayidx32.2 = getelementptr inbounds float, ptr %37, i32 %add35
  %50 = load float, ptr %arrayidx32.2, align 4
  %51 = tail call float @llvm.fmuladd.f32(float %49, float %50, float %acc22)
  %add39 = or disjoint i32 %n22.075, 3
  %arrayidx30.3 = getelementptr inbounds float, ptr %arrayidx30, i32 3
  %52 = load float, ptr %arrayidx30.3, align 4
  %arrayidx32.3 = getelementptr inbounds float, ptr %37, i32 %add39
  %53 = load float, ptr %arrayidx32.3, align 4
  %54 = tail call float @llvm.fmuladd.f32(float %52, float %53, float %acc23)
  %add43 = or disjoint i32 %n22.075, 4
  %arrayidx30.4 = getelementptr inbounds float, ptr %arrayidx30, i32 4
  %55 = load float, ptr %arrayidx30.4, align 4
  %arrayidx32.4 = getelementptr inbounds float, ptr %37, i32 %add43
  %56 = load float, ptr %arrayidx32.4, align 4
  %57 = tail call float @llvm.fmuladd.f32(float %55, float %56, float %acc24)
  %add47 = or disjoint i32 %n22.075, 5
  %arrayidx30.5 = getelementptr inbounds float, ptr %arrayidx30, i32 5
  %58 = load float, ptr %arrayidx30.5, align 4
  %arrayidx32.5 = getelementptr inbounds float, ptr %37, i32 %add47
  %59 = load float, ptr %arrayidx32.5, align 4
  %60 = tail call float @llvm.fmuladd.f32(float %58, float %59, float %acc25)
  %add51 = or disjoint i32 %n22.075, 6
  %arrayidx30.6 = getelementptr inbounds float, ptr %arrayidx30, i32 6
  %61 = load float, ptr %arrayidx30.6, align 4
  %arrayidx32.6 = getelementptr inbounds float, ptr %37, i32 %add51
  %62 = load float, ptr %arrayidx32.6, align 4
  %63 = tail call float @llvm.fmuladd.f32(float %61, float %62, float %acc26)
  %add55 = or disjoint i32 %n22.075, 7
  %add57 = or disjoint i32 %coeff_pos.174, 8
  %arrayidx30.7 = getelementptr inbounds float, ptr %arrayidx30, i32 7
  %64 = load float, ptr %arrayidx30.7, align 4
  %arrayidx32.7 = getelementptr inbounds float, ptr %37, i32 %add55
  %65 = load float, ptr %arrayidx32.7, align 4
  %66 = tail call float @llvm.fmuladd.f32(float %64, float %65, float %acc27)
  %add76 = add nuw nsw i32 %add76310, 8
  %exitcond84.not.7 = icmp sgt i32 %add76, %4
  br i1 %exitcond84.not.7, label %for.cond130.preheader, label %for.body27.7

for.body133.lr.ph:                                ; preds = %for.cond130.preheader
  %67 = load ptr, ptr %fir, align 4
  %68 = load ptr, ptr %delay, align 4
...
for.body27.clone:                                 ; preds = %for.body27.clone, %for.body133.lr.ph
  ...
  %69 = load float, ptr %arrayidx30.clone, align 4
  %arrayidx32.clone = getelementptr inbounds float, ptr %68, i32 %n22.075.clone
  %70 = load float, ptr %arrayidx32.clone, align 4
  ...
  br i1 %exitcond84.not.clone, label %for.end141, label %for.body27.clone
...
for.end141:                                       ; preds = %for.body27.clone, %for.cond130.preheader
  ...
  %add61 = fadd float %acc.2.lcssa.clone, %add60
  %add62 = fadd float %acc.3.lcssa.clone, %add61
  %add63 = fadd float %acc.4.lcssa.clone, %add62
  %add64 = fadd float %acc.5.lcssa.clone, %add63
  %add65 = fadd float %acc.6.lcssa.clone, %add64
  %add66 = fadd float %acc.7.lcssa.clone, %add65
  %arrayidx37 = getelementptr inbounds float, ptr %output, i32 %i.080
  store float %add66, ptr %arrayidx37, align 4
