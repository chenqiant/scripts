...
; CHECK-NEXT:    [[I_022_MODIFY:%.*]] = phi i32 [ [[TMP48]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
...
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX11]], align 4
...
; CHECK-NEXT:    [[MUL10_MODIFY:%.*]] = fmul float [[TMP1]], [[TMP2]]
; CHECK-NEXT:    [[TMP33:%.*]] = fmul float [[TMP3]], [[TMP4]]
; CHECK-NEXT:    [[TMP34:%.*]] = fmul float [[TMP5]], [[TMP6]]
; CHECK-NEXT:    [[TMP35:%.*]] = fmul float [[TMP7]], [[TMP8]]
; CHECK-NEXT:    [[TMP36:%.*]] = fmul float [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[TMP37:%.*]] = fmul float [[TMP11]], [[TMP12]]
; CHECK-NEXT:    [[TMP38:%.*]] = fmul float [[TMP13]], [[TMP14]]
; CHECK-NEXT:    [[TMP39:%.*]] = fmul float [[TMP15]], [[TMP16]]
; CHECK-NEXT:    [[TMP40:%.*]] = fmul float [[TMP17]], [[TMP18]]
; CHECK-NEXT:    [[TMP41:%.*]] = fmul float [[TMP19]], [[TMP20]]
; CHECK-NEXT:    [[TMP42:%.*]] = fmul float [[TMP21]], [[TMP22]]
; CHECK-NEXT:    [[TMP43:%.*]] = fmul float [[TMP23]], [[TMP24]]
; CHECK-NEXT:    [[TMP44:%.*]] = fmul float [[TMP25]], [[TMP26]]
; CHECK-NEXT:    [[TMP45:%.*]] = fmul float [[TMP27]], [[TMP28]]
; CHECK-NEXT:    [[TMP46:%.*]] = fmul float [[TMP29]], [[TMP30]]
; CHECK-NEXT:    [[TMP47:%.*]] = fmul float [[TMP31]], [[TMP32]]
...
; CHECK-NEXT:    [[TMP48]] = add nuw i32 [[I_022_MODIFY]], 16
; CHECK-NEXT:    [[EXITCOND_NOT_MODIFY:%.*]] = icmp sgt i32 [[TMP48]], [[SUB]]
