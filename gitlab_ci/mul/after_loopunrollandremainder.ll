...
define dso_local noundef i32 @dsps_mul_f32_ansi(ptr noalias noundef readonly %input1, ptr noalias noundef readonly %input2, ptr noalias noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out) local_unnamed_addr {
entry:
...
for.body.modify:                                  ; preds = %for.cond.preheader.new, %for.body.modify
  ...
  store float %mul10.modify, ptr %arrayidx12.modify, align 4
