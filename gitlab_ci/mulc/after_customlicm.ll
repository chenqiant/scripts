...
; CHECK-NEXT:    [[I_014_MODIFY:%.*]] = phi i32 [ [[TMP32]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
...
; CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[ARRAYIDX17]], align 4
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX20]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX23]], align 4
; CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX26]], align 4
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX29]], align 4
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX32]], align 4
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX35]], align 4
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX38]], align 4
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX41]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX44]], align 4
; CHECK-NEXT:    [[MUL5_MODIFY:%.*]] = fmul float [[TMP1]], [[C]]
; CHECK-NEXT:    [[TMP17:%.*]] = fmul float [[TMP2]], [[C]]
; CHECK-NEXT:    [[TMP18:%.*]] = fmul float [[TMP3]], [[C]]
; CHECK-NEXT:    [[TMP19:%.*]] = fmul float [[TMP4]], [[C]]
; CHECK-NEXT:    [[TMP20:%.*]] = fmul float [[TMP5]], [[C]]
; CHECK-NEXT:    [[TMP21:%.*]] = fmul float [[TMP6]], [[C]]
; CHECK-NEXT:    [[TMP22:%.*]] = fmul float [[TMP7]], [[C]]
; CHECK-NEXT:    [[TMP23:%.*]] = fmul float [[TMP8]], [[C]]
; CHECK-NEXT:    [[TMP24:%.*]] = fmul float [[TMP9]], [[C]]
; CHECK-NEXT:    [[TMP25:%.*]] = fmul float [[TMP10]], [[C]]
; CHECK-NEXT:    [[TMP26:%.*]] = fmul float [[TMP11]], [[C]]
; CHECK-NEXT:    [[TMP27:%.*]] = fmul float [[TMP12]], [[C]]
; CHECK-NEXT:    [[TMP28:%.*]] = fmul float [[TMP13]], [[C]]
; CHECK-NEXT:    [[TMP29:%.*]] = fmul float [[TMP14]], [[C]]
; CHECK-NEXT:    [[TMP30:%.*]] = fmul float [[TMP15]], [[C]]
; CHECK-NEXT:    [[TMP31:%.*]] = fmul float [[TMP16]], [[C]]
; CHECK-NEXT:    store float [[TMP31]], ptr [[ARRAYIDX45]], align 4
; CHECK-NEXT:    store float [[TMP30]], ptr [[ARRAYIDX42]], align 4
; CHECK-NEXT:    store float [[TMP29]], ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    store float [[TMP28]], ptr [[ARRAYIDX36]], align 4
; CHECK-NEXT:    store float [[TMP27]], ptr [[ARRAYIDX33]], align 4
; CHECK-NEXT:    store float [[TMP26]], ptr [[ARRAYIDX30]], align 4
; CHECK-NEXT:    store float [[TMP25]], ptr [[ARRAYIDX27]], align 4
; CHECK-NEXT:    store float [[TMP24]], ptr [[ARRAYIDX24]], align 4
; CHECK-NEXT:    store float [[TMP23]], ptr [[ARRAYIDX21]], align 4
; CHECK-NEXT:    store float [[TMP22]], ptr [[ARRAYIDX18]], align 4
; CHECK-NEXT:    store float [[TMP21]], ptr [[ARRAYIDX15]], align 4
; CHECK-NEXT:    store float [[TMP20]], ptr [[ARRAYIDX12]], align 4
; CHECK-NEXT:    store float [[TMP19]], ptr [[ARRAYIDX9]], align 4
; CHECK-NEXT:    store float [[TMP18]], ptr [[ARRAYIDX5]], align 4
; CHECK-NEXT:    store float [[TMP17]], ptr [[ARRAYIDX2]], align 4
; CHECK-NEXT:    store float [[MUL5_MODIFY]], ptr [[ARRAYIDX7_MODIFY]], align 4
; CHECK-NEXT:    [[TMP32]] = add nuw i32 [[I_014_MODIFY]], 16
...
; CHECK-NEXT:    [[MUL5:%.*]] = fmul float [[TMP33]], [[C]]
...
; CHECK-NEXT:    [[MUL5_CLONE:%.*]] = fmul float [[TMP34]], [[C]]
