...
; CHECK:       for.end:
; CHECK-NEXT:    [[ADD37:%.*]] = fadd float [[TMP17:%.*]], [[TMP16:%.*]]
; CHECK-NEXT:    [[ADD38:%.*]] = fadd float [[TMP18:%.*]], [[ADD37]]
; CHECK-NEXT:    [[ADD39:%.*]] = fadd float [[TMP19:%.*]], [[ADD38]]
; CHECK-NEXT:    [[ADD40:%.*]] = fadd float [[TMP20:%.*]], [[ADD39]]
; CHECK-NEXT:    [[ADD41:%.*]] = fadd float [[TMP21:%.*]], [[ADD40]]
; CHECK-NEXT:    [[ADD42:%.*]] = fadd float [[TMP22:%.*]], [[ADD41]]
; CHECK-NEXT:    [[ADD43:%.*]] = fadd float [[TMP23:%.*]], [[ADD42]]
