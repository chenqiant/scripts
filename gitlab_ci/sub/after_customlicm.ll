...
; CHECK-NEXT:    [[TMP0:%.*]] = phi i32 [ [[TMP48:%.*]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
; CHECK-NEXT:    [[CMP85209:%.*]] = icmp slt i32 [[TMP0]], [[LEN]]
; CHECK-NEXT:    br i1 [[CMP85209]], label [[FOR_BODY:%.*]], label [[RETURN]]
; CHECK:       for.body.modify:
; CHECK-NEXT:    [[I_021_MODIFY:%.*]] = phi i32 [ [[TMP48]], [[FOR_BODY_MODIFY]] ], [ 0, [[FOR_COND_PREHEADER_NEW]] ]
...
; CHECK-NEXT:    [[TMP1:%.*]] = load float, ptr [[ARRAYIDX_MODIFY]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[ARRAYIDX9_MODIFY]], align 4
; CHECK-NEXT:    [[TMP3:%.*]] = load float, ptr [[ARRAYIDX1]], align 4
; CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[ARRAYIDX2]], align 4
; CHECK-NEXT:    [[TMP5:%.*]] = load float, ptr [[ARRAYIDX5]], align 4
; CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr [[ARRAYIDX6]], align 4
; CHECK-NEXT:    [[TMP7:%.*]] = load float, ptr [[ARRAYIDX10]], align 4
; CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr [[ARRAYIDX12]], align 4
; CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr [[ARRAYIDX15]], align 4
; CHECK-NEXT:    [[TMP10:%.*]] = load float, ptr [[ARRAYIDX16]], align 4
; CHECK-NEXT:    [[TMP11:%.*]] = load float, ptr [[ARRAYIDX19]], align 4
; CHECK-NEXT:    [[TMP12:%.*]] = load float, ptr [[ARRAYIDX20]], align 4
; CHECK-NEXT:    [[TMP13:%.*]] = load float, ptr [[ARRAYIDX23]], align 4
; CHECK-NEXT:    [[TMP14:%.*]] = load float, ptr [[ARRAYIDX24]], align 4
; CHECK-NEXT:    [[TMP15:%.*]] = load float, ptr [[ARRAYIDX27]], align 4
; CHECK-NEXT:    [[TMP16:%.*]] = load float, ptr [[ARRAYIDX28]], align 4
; CHECK-NEXT:    [[TMP17:%.*]] = load float, ptr [[ARRAYIDX31]], align 4
; CHECK-NEXT:    [[TMP18:%.*]] = load float, ptr [[ARRAYIDX32]], align 4
; CHECK-NEXT:    [[TMP19:%.*]] = load float, ptr [[ARRAYIDX35]], align 4
; CHECK-NEXT:    [[TMP20:%.*]] = load float, ptr [[ARRAYIDX36]], align 4
; CHECK-NEXT:    [[TMP21:%.*]] = load float, ptr [[ARRAYIDX39]], align 4
; CHECK-NEXT:    [[TMP22:%.*]] = load float, ptr [[ARRAYIDX40]], align 4
; CHECK-NEXT:    [[TMP23:%.*]] = load float, ptr [[ARRAYIDX43]], align 4
; CHECK-NEXT:    [[TMP24:%.*]] = load float, ptr [[ARRAYIDX44]], align 4
; CHECK-NEXT:    [[TMP25:%.*]] = load float, ptr [[ARRAYIDX47]], align 4
; CHECK-NEXT:    [[TMP26:%.*]] = load float, ptr [[ARRAYIDX48]], align 4
; CHECK-NEXT:    [[TMP27:%.*]] = load float, ptr [[ARRAYIDX51]], align 4
; CHECK-NEXT:    [[TMP28:%.*]] = load float, ptr [[ARRAYIDX52]], align 4
; CHECK-NEXT:    [[TMP29:%.*]] = load float, ptr [[ARRAYIDX55]], align 4
; CHECK-NEXT:    [[TMP30:%.*]] = load float, ptr [[ARRAYIDX56]], align 4
; CHECK-NEXT:    [[TMP31:%.*]] = load float, ptr [[ARRAYIDX59]], align 4
; CHECK-NEXT:    [[TMP32:%.*]] = load float, ptr [[ARRAYIDX60]], align 4
; CHECK-NEXT:    [[SUB_MODIFY:%.*]] = fsub float [[TMP1]], [[TMP2]]
; CHECK-NEXT:    [[TMP33:%.*]] = fsub float [[TMP3]], [[TMP4]]
; CHECK-NEXT:    [[TMP34:%.*]] = fsub float [[TMP5]], [[TMP6]]
; CHECK-NEXT:    [[TMP35:%.*]] = fsub float [[TMP7]], [[TMP8]]
; CHECK-NEXT:    [[TMP36:%.*]] = fsub float [[TMP9]], [[TMP10]]
; CHECK-NEXT:    [[TMP37:%.*]] = fsub float [[TMP11]], [[TMP12]]
; CHECK-NEXT:    [[TMP38:%.*]] = fsub float [[TMP13]], [[TMP14]]
; CHECK-NEXT:    [[TMP39:%.*]] = fsub float [[TMP15]], [[TMP16]]
; CHECK-NEXT:    [[TMP40:%.*]] = fsub float [[TMP17]], [[TMP18]]
; CHECK-NEXT:    [[TMP41:%.*]] = fsub float [[TMP19]], [[TMP20]]
; CHECK-NEXT:    [[TMP42:%.*]] = fsub float [[TMP21]], [[TMP22]]
; CHECK-NEXT:    [[TMP43:%.*]] = fsub float [[TMP23]], [[TMP24]]
; CHECK-NEXT:    [[TMP44:%.*]] = fsub float [[TMP25]], [[TMP26]]
; CHECK-NEXT:    [[TMP45:%.*]] = fsub float [[TMP27]], [[TMP28]]
; CHECK-NEXT:    [[TMP46:%.*]] = fsub float [[TMP29]], [[TMP30]]
; CHECK-NEXT:    [[TMP47:%.*]] = fsub float [[TMP31]], [[TMP32]]
; CHECK-NEXT:    store float [[TMP47]], ptr [[ARRAYIDX61]], align 4
; CHECK-NEXT:    store float [[TMP46]], ptr [[ARRAYIDX57]], align 4
; CHECK-NEXT:    store float [[TMP45]], ptr [[ARRAYIDX53]], align 4
; CHECK-NEXT:    store float [[TMP44]], ptr [[ARRAYIDX49]], align 4
; CHECK-NEXT:    store float [[TMP43]], ptr [[ARRAYIDX45]], align 4
; CHECK-NEXT:    store float [[TMP42]], ptr [[ARRAYIDX41]], align 4
; CHECK-NEXT:    store float [[TMP41]], ptr [[ARRAYIDX37]], align 4
; CHECK-NEXT:    store float [[TMP40]], ptr [[ARRAYIDX33]], align 4
; CHECK-NEXT:    store float [[TMP39]], ptr [[ARRAYIDX29]], align 4
; CHECK-NEXT:    store float [[TMP38]], ptr [[ARRAYIDX25]], align 4
; CHECK-NEXT:    store float [[TMP37]], ptr [[ARRAYIDX21]], align 4
; CHECK-NEXT:    store float [[TMP36]], ptr [[ARRAYIDX17]], align 4
; CHECK-NEXT:    store float [[TMP35]], ptr [[ARRAYIDX13]], align 4
; CHECK-NEXT:    store float [[TMP34]], ptr [[ARRAYIDX7]], align 4
; CHECK-NEXT:    store float [[TMP33]], ptr [[ARRAYIDX3]], align 4
; CHECK-NEXT:    store float [[SUB_MODIFY]], ptr [[ARRAYIDX11_MODIFY]], align 4
; CHECK-NEXT:    [[TMP48]] = add nuw i32 [[I_021_MODIFY]], 16
; CHECK-NEXT:    [[EXITCOND_NOT_MODIFY:%.*]] = icmp sgt i32 [[TMP48]], [[SUB63]]
